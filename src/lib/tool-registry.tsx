...
export const TOOL_COMPONENTS: Record<string, ComponentType<any>> = {
    ...
    "css-gradient-generator": dynamic(() => import("@/components/tools/developer/CSSGradientTool.jsx"), { ssr: false }),
    "css-shadow-generator": dynamic(() => import("@/components/tools/developer/CSSShadowTool.jsx"), { ssr: false }),

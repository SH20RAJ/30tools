...
import { generateYouTubeTagsAI } from "./ai-services/youtube-ai-actions";

export async function generateYouTubeTags(query: string) {
	return await generateYouTubeTagsAI(query);
}

export async function generateTikTokTags(query: string) {
	try {

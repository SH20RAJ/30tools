	...
	"video-to-gif": [
		{
			...
			answer: "Yes, you can choose the exact start and end time for your GIF.",
		},
		{
	...
	"video-to-audio": [
		{
			...
			answer: "You can extract audio as MP3, WAV, or AAC files.",
		},
		{
			question: "Can I extract audio from a specific part?",
			answer: "Yes, you can trim the video before extracting the audio.",
		},
	],
};

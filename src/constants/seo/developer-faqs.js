...
export const DEVELOPER_TOOLS_FAQS = {
  ...
  "base64-tool": [
    ...
    },
    {
      ...
      answer:
        "Yes! Base64 encoded images can be used as data URIs in HTML/CSS. For example: `<Image src='data:image/png;base64,YOUR_ENCODED_DATA' alt='Description' width={100} height={100} />`",
    },
  ],

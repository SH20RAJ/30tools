...
export const GENERATOR_TOOLS_SEO = {
  category: {
    ...
    longTailKeywords: [
      ...
      "social media bio generator aesthetic",
      "fake chat generator realistic",
      "startup name generator ai powered",
  ...
  tools: {
    "aesthetic-bio-generator": {
      ...
      longTailKeywords: [
        ...
        "cute bio generator with emojis",
        "aesthetic twitter bio ideas generator",
        "tiktok bio generator aesthetic themes",
    ...
    "startup-name-generator": {
      ...
      longTailKeywords: [
        ...
        "tech startup name ideas generator",
    ...
    "fake-chat-generator": {
      ...
      longTailKeywords: [
        ...
        "fake instagram dm creator",
        "imessage fake conversation maker",
        "discord fake chat screenshot",
    ...
    "excuse-generator": {
      ...
      longTailKeywords: [
        ...
        "funny excuse generator creative",
        "creative excuse maker online",
...
export const generateGeneratorToolMeta = (toolId) => {
  const tool = GENERATOR_TOOLS_SEO.tools[toolId];
  if (!tool) return null;
...
export default GENERATOR_TOOLS_SEO;

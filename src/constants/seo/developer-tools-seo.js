...
export const DEVELOPER_TOOLS_SEO = {
  category: {
    ...
    longTailKeywords: [
      ...
      "base64 encode decode tool free",
      "regex pattern tester online free",
  ...
  tools: {
    "json-formatter": {
      ...
      longTailKeywords: [
        ...
        "json minifier and beautifier tool",
        "json syntax checker with error detection",
        "format json online no signup required",
    ...
    "hash-generator": {
      ...
      longTailKeywords: [
        ...
        "sha256 hash calculator online",
        "cryptographic hash generator tool",
        "password hash generator secure",
    ...
    "regex-tester": {
      ...
      longTailKeywords: [
        ...
        "regular expression validator python",
        "regex pattern tester with examples",
        "regex matcher online tool",
    ...
    "api-tester": {
      ...
      longTailKeywords: [
        ...
        "rest api testing tool online",
        "http client for api testing",
        "postman alternative online free",
    ...
    "jwt-decoder": {
      ...
      longTailKeywords: [
        ...
        "json web token parser online",
        "jwt token validator debugger",
    ...
    "url-encoder": {
      ...
      longTailKeywords: [
        ...
        "percent encoding tool online",
        "query string encoder decoder",
        "url parameter encoding tool",
...
export const generateDeveloperToolMeta = (toolId) => {
  const tool = DEVELOPER_TOOLS_SEO.tools[toolId];
  if (!tool) return null;
...
export default DEVELOPER_TOOLS_SEO;

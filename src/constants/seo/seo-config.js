...
export const TOOL_SEO_CONFIG = {
  "image-compressor": {
    ...
    description: "Compress JPEG, PNG, WebP images online free. Reduce file size by 80% without quality loss. Batch processing, no watermarks, secure browser-based compression.",
    keywords: [
      "image compressor",
  ...
  "pdf-merger": {
    ...
    description: "Merge PDF files online for free. Combine multiple PDFs into one document. Preserves bookmarks, no watermarks, unlimited file size support.",
    keywords: [
      "pdf merger",
      "merge pdf files",
      "combine pdf online",
  ...
  "password-generator": {
    title: "Secure Password Generator - Create Strong Passwords Online | 30tools",
    description: "Generate secure, random passwords online. Customizable length, character sets, and complexity. Cryptographically secure with no server storage.",
    keywords: [
      "password generator",
      "secure password",
      "random password",
  ...
  "qr-code-generator": {
    ...
    description: "Generate QR codes for URLs, text, WiFi, vCards & more. Custom colors, high resolution download, bulk generation. Free QR code maker tool.",
    keywords: [
      "qr code generator",
      "qr code maker",
      "create qr code",
...
export const CATEGORY_SEO_CONFIG = {
  "image-tools": {
    ...
    description: "Professional image tools collection. Compress, convert, resize, edit images online. JPEG, PNG, WebP support. Batch processing, no watermarks.",
    keywords: [
      "image tools",
      "image editor online",
      "image converter",
  ...
  "pdf-tools": {
    ...
    description: "Complete PDF toolkit online. Merge, split, compress, convert PDFs. Password protection, bookmark preservation, unlimited file size.",
    keywords: [
      "pdf tools",
      "pdf editor online",
      "pdf converter",
  ...
  "video-tools": {
    ...
    description: "Professional video tools suite. Compress, convert, trim videos online. Multiple format support, social media optimization presets.",
    keywords: [
      "video tools",
      "video converter",
      "video compressor", 

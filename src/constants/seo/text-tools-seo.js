  ...
  tools: {
    ...
    "character-counter": {
      ...
      features: [
        ...
        "Count with/without spaces",
        "Letter and number counting",
    ...
    "password-generator": {
      ...
      longTailKeywords: [
        ...
        "random password generator no history",
    ...
    "lorem-ipsum-generator": {
      ...
      longTailKeywords: [
        ...
        "dummy text generator for design",
    ...
    "text-formatter": {
      ...
      longTailKeywords: [
        ...
        "text cleaner remove extra spaces",
        "format text remove line breaks",
    ...
    "duplicate-line-remover": {
      ...
      longTailKeywords: [
        ...
        "text duplicate line remover online",
        "unique lines extractor tool",
...
export const generateTextToolMeta = (toolId) => {
  const tool = TEXT_TOOLS_SEO.tools[toolId];
  if (!tool) return null;

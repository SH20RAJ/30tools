...
export default function GeneratorToolsHub({ tools = [], faqs = [], tutorials = [] }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-purple-50/20 to-background dark:via-purple-950/10">
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
            Create viral content with AI-powered generators. Aesthetic bios, fake chats, startup names, 
            AI images & more. Perfect for social media, content creation, and creative projects.
          </p>
      ...
      <section className="py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground">The content creation tools everyone loves</p>
          </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Why Choose Our Generators</h2>
            <p className="text-muted-foreground max-w-3xl mx-auto">
              AI-powered content creation tools designed for creators, marketers, and anyone who wants to make amazing content quickly.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                title: 'AI-Powered',
                description: 'Advanced machine learning creates high-quality, creative content tailored to your needs.',
                icon: '🤖'
              },
              {
                title: 'Social Ready',
                description: 'Content optimized for Instagram, TikTok, Twitter, and other social media platforms.',
                icon: '📱'
              },
              {
                title: 'Instant Results',
                description: 'Generate content in seconds, not hours. Perfect for when you need quick creative solutions.',
                icon: '⚡'
              },
              {
                title: 'Viral Potential',
                description: 'Create content designed to engage audiences and increase your social media presence.',
                icon: '🚀'
              }
            ].map((feature, index) => (
              <div key={index} className="text-center">
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-600/5 to-pink-600/5">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl font-bold mb-8">Loved by Content Creators Worldwide</h2>

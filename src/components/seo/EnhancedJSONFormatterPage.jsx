	...
	const features = [
		{
			...
			description:
				"Instantly format messy JSON and detect syntax errors with detailed error messages",
		},
		{
			title: "Minify for Production",
			description:
				"Remove whitespace and reduce file size for faster data transmission",
		},
		{
			title: "Tree View Display",
			description:
				"Visualize complex nested JSON structures with expandable tree view",
		},
		{
			title: "Error Detection",
			description:
				"Real-time syntax validation with line numbers and error descriptions",
		},
		{
			title: "Copy to Clipboard",
			description:
				"One-click copying of formatted JSON ready for your code editor",
		},
		{
		...
		},
		{
			...
			description:
				"Color-coded JSON elements for better readability and debugging",
		},
	];
    ...
    },
    {
      ...
      "email": "jane@example.com"
		...
		},
		{
			...
			input:
				'{"database":{"host":"localhost","port":5432,"credentials":{"username":"admin","password":"secret"}},"logging":{"level":"info","file":"/var/log/app.log"}}',
			output: `{
  "database": {
    "host": "localhost",
    "port": 5432,
  ...
  "logging": {
    ...
    "file": "/var/log/app.log"
		...
		},
		{
			title: "Minify for Production",
			description:
				"Remove whitespace to reduce file size for production deployment",
			input: `{
  "config": {
    ...
    "retries": 3
			...
			output:
				'{"config":{"api_url":"https://api.example.com","timeout":5000,"retries":3}}',
		},
	];
						...
						review: [
							{
								...
								reviewBody:
									"Perfect JSON formatter for development work. The error detection is incredibly helpful and the tree view makes complex JSON easy to understand.",
							},
						],
					}),
				}}

...
export function HomepageSchemas() {
  ...
  const organizationSchema = {
    ...
    description:
      "Professional online toolkit with 135+ free tools for image processing, PDF manipulation, video conversion, SEO analysis, and developer utilities.",
    foundingDate: "2024",
    sameAs: [
  ...
  const websiteSchema = {
    ...
    url: "https://30tools.com",
    description:
      "Professional online toolkit with 135+ free tools for image processing, PDF manipulation, video conversion, SEO analysis, and more.",
    publisher: {
      "@type": "Organization",
      name: "30tools",
    },
  ...
  const softwareSchema = {
    ...
    description:
      "Professional online toolkit with 135+ free tools including image compressor, PDF editor, video converter, SEO analyzer, and developer utilities.",
    featureList: [
    ...
    softwareVersion: "2.0",
    releaseNotes:
      "Major update with 135+ tools, improved performance, and enhanced user experience",
  };
    ...
    itemListElement: [
      {
        ...
        name: "Image Tools",
        description:
          "Professional image processing tools for compression, conversion, and editing",
      ...
      },
      {
        ...
        name: "PDF Tools",
        description:
          "Complete PDF toolkit for editing, merging, splitting, and conversion",
  ...
  const mcpToolsSchema = {
    ...
    description:
      "Generate Model Context Protocol servers for Claude AI integration. Perfect for #21stdev developers building AI-first applications.",
    ...
    about: [
      {
        ...
        alternateName: "MCP",
        description:
          "Anthropic's open standard for connecting AI assistants to external data and tools",
      },
      {
        "@type": "Thing",
        name: "#21stdev",
        description:
          "Modern development practices for AI-first applications and tools",
      },
    ],
    featureList: [
    ...
    <>
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(toolCategoriesSchema),
        }}
      />
      <Script
        id="faq-schema"
...
export function HomepageSEOContent() {
  return (
    <div className="sr-only">
      ...
      <p>
        30tools provides a comprehensive suite of 135+ professional-grade online
        tools that work entirely in your browser. Our toolkit includes
        industry-leading image compression technology that can reduce file sizes
        by up to 90% while maintaining visual quality, advanced PDF manipulation
        tools for merging, splitting, and editing documents, high-quality video
        conversion and compression utilities, comprehensive SEO analysis tools
        for website optimization, and developer utilities for JSON, XML, Base64,
        and API testing.
      </p>

      <h3>Image Processing Tools</h3>
      <p>
        Compress images online free with our advanced algorithms. Convert
        between JPEG, PNG, WebP, GIF, and AVIF formats. Resize images while
        maintaining aspect ratios. Remove backgrounds using AI technology. Batch
        process multiple images simultaneously. All processing happens locally
        for maximum security and speed.
      </p>

      <h3>PDF Tools Suite</h3>
      <p>
        Merge multiple PDF files into one document. Split large PDFs into
        smaller files. Add password protection to PDFs. Remove password
        protection from PDFs you own. Compress PDF files to reduce size. Convert
        PDFs to Word, Excel, and other formats. Add page numbers and watermarks.
        Rotate PDF pages. All tools work without uploading files to servers.
      </p>

      <h3>Video Conversion and Processing</h3>
      <p>
        Convert videos between MP4, AVI, MOV, WebM, and other formats. Compress
        videos to reduce file size while maintaining quality. Convert videos to
        GIF animations. Trim and edit video clips. Extract audio from video
        files. Optimize videos for web use. Support for 4K and HD video
        processing.
      </p>

      <h3>SEO and Website Analysis</h3>
      <p>
        Analyze website SEO performance with our comprehensive tools. Generate
        meta tags for better search engine visibility. Check keyword density and
        content optimization. Analyze page load speed and Core Web Vitals.
        Generate XML sitemaps. Validate structured data markup. Monitor website
        uptime and performance.
      </p>

      <h3>Developer Utilities</h3>
      <p>
        Format and validate JSON, XML, HTML, CSS, and JavaScript code. Test
        regular expressions with real-time matching. Encode and decode Base64,
        URL, and HTML entities. Generate secure passwords and API keys. Create
        QR codes with custom designs. Hash text using MD5, SHA-1, SHA-256
        algorithms. Test APIs and web services. Generate Model Context Protocol
        (MCP) servers for Claude AI integration. Perfect for #21stdev developers
        building AI-first applications.
      </p>

      <h3>AI Development Tools for #21stdev</h3>
      <p>
        Build the future with our AI development toolkit. Generate MCP (Model
        Context Protocol) servers for Claude AI integration. Create custom tools
        for Anthropic's AI assistants. Perfect for #21stdev developers embracing
        AI-first development practices. Our MCP server generator supports
        TypeScript, JavaScript, and Python, helping you create production-ready
        AI integrations with authentication, CORS support, and comprehensive
        tool definitions.
      </p>

      <h3>Model Context Protocol (MCP) Tools</h3>
      <p>
        Generate ready-to-deploy MCP servers for Claude AI and other AI
        assistants. Build custom AI tools with our comprehensive MCP server
        generator. Support for multiple programming languages and frameworks.
        Essential for developers working with Anthropic's Model Context Protocol
        ecosystem. Join the #21stdev movement and create powerful AI
        integrations that bridge artificial intelligence with real-world data
        and services.
      </p>

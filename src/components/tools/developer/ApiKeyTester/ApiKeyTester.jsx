					...
					{tool.type === "browser" ? (
						...
						<div className="space-y-4">
							<Alert>
								...
								<AlertDescription>
									This API cannot be tested directly in the browser due to CORS
									or security restrictions. Use the generated command below in
									your terminal.
								</AlertDescription>
							</Alert>
							...
							>
								...
								<div>
									<p className="font-semibold">
										{result.success ? "Valid API Key" : "Test Failed"}
									</p>
									{result.message && (

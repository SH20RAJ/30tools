          ...
          <Card className="mb-6">
            ...
            <CardContent className="space-y-4">
              <div className="text-center py-12">
                <Crop className="w-16 h-16 mx-auto mb-4 text-muted-foreground" />
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Crop images to specific dimensions or aspect ratios. This tool will provide a user-friendly interface 

        ...
        <Card className="mt-6">
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div>
              ...
              <p className="text-muted-foreground">
                Hexadecimal color codes use base-16 numbering. Format: #RRGGBB
                where each pair represents red, green, and blue values.
              </p>
            </div>
            <div>
              <h4 className="font-medium mb-2">RGB</h4>
              <p className="text-muted-foreground">
                Red, Green, Blue color model. Each value ranges from 0-255,
                representing the intensity of each color channel.
              </p>
            </div>
            <div>
              ...
              <p className="text-muted-foreground">
                ...
                intuitive for color manipulation and design.
              </p>
            </div>
          </CardContent>
        </Card>

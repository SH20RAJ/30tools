      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold mb-4">Logo Maker</h1>
            <p className="text-lg text-muted-foreground">
              Create simple logos and brand graphics
            </p>
          </div>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Create simple logos and brand graphics. This tool will provide a user-friendly interface 

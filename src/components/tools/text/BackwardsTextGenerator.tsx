...
const UPSIDE_DOWN_MAP: Record<string, string> = {
  ...
  A: "∀", B: "ᗺ", C: "Ɔ", D: "", E: "Ǝ", F: "Ⅎ", G: "⅁", H: "H", I: "I", J: "ᒋ", K: "lambda", L: "˥", M: "W", N: "N", O: "O", P: "Ԁ", Q: "Ό", R: "ᴚ", S: "S", T: "⊥", U: "∩", V: "Λ", W: "M", X: "X", Y: "⅄", Z: "Z",
  "1": "Ɩ", "2": "ᄅ", "3": "Ɛ", "4": "ㄣ", "5": "ϛ", "6": "9", "7": "ㄥ", "8": "8", "9": "6", "0": "0",
  ".": "˙", ",": "'", "'": ",", "\"": "„", "?": "¿", "!": "¡", "(": ")", ")": "(", "[": "]", "]": "[", "{": "}", "}": "{", "<": ">", ">": "<", "&": "⅋", "_": "‾"
};

const MIRROR_MAP: Record<string, string> = {
  a: "ɒ", b: "d", c: "ɔ", d: "b", e: "ɘ", f: "Ꮈ", g: "ǫ", h: "ʜ", i: "i", j: "ꞁ", k: "ʞ", l: "l", m: "m", n: "ᴎ", o: "o", p: "q", q: "p", r: "ᴙ", s: "ꙅ", t: "ᴛ", u: "ᴜ", v: "v", w: "w", x: "x", y: "ʏ", z: "ᴢ",
  A: "A", B: "ᙀ", C: "Ɔ", D: "ᗡ", E: "Ǝ", F: "ꟻ", G: "Ꭾ", H: "H", I: "I", J: "ᒐ", K: "⋊", L: "⅃", M: "M", N: "И", O: "O", P: "Գ", Q: "Ϙ", R: "ᴙ", S: "Ꙅ", T: "T", U: "U", V: "V", W: "W", X: "X", Y: "Y", Z: "Ƹ",
  "1": "I", "2": "S", "3": "Ɛ", "4": "߀", "5": "ट", "6": "д", "7": "߃", "8": "8", "9": "୧", "0": "0"
};
...
export default function BackwardsTextGenerator() {
  ...
  const transformText = useCallback((text: string, currentMode: Mode) => {
    ...
    switch (currentMode) {
      ...
      case "mirror":
        return text.split("").map(char => MIRROR_MAP[char] || char).reverse().join("");
      case "upside-down":
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 p-4 md:p-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between px-1">
            <label className="text-sm font-medium text-muted-foreground">Preview Result</label>
          ...
          <div className="relative group">
            <div className="min-h-[350px] w-full p-6 bg-muted/30 border border-border/60 rounded-2xl text-lg break-words overflow-auto">
              {outputText || <span className="text-muted-foreground italic">Your result will appear here...</span>}
            </div>
            {outputText && (
      ...
      <div className="flex flex-wrap items-center justify-center gap-8 py-6 px-10 bg-card border border-border/50 rounded-3xl shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <span className="text-2xl font-bold leading-none">{inputText.length}</span>
            <span className="text-xs text-muted-foreground font-medium uppercase tracking-tight">Characters</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs text-muted-foreground font-medium uppercase tracking-tight">Words</span>
          </div>
        </div>
        <div className="w-px h-8 bg-border hidden sm:block" />
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <span className="text-2xl font-bold leading-none capitalize">{mode.split("-")[0]}</span>
            <span className="text-xs text-muted-foreground font-medium uppercase tracking-tight">Active Mode</span>
          </div>
        </div>
      </div>
    </div>

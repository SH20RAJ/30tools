...
export default function LoremIpsumGeneratorTool() {
  ...
  const generateWords = (wordCount) => {
    const words = [];
    const startWords = startWithLorem
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>
                      {count} {type} • {generatedText.split(" ").length} words •{" "}
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                  ...
                  <li>
                    • Provides realistic text length and word distribution
                  </li>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Create mockups for brochures, posters, and marketing
                    materials
                  </p>
                </div>

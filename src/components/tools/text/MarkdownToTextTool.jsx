          ...
          <Card>
            ...
            <CardContent>
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  ✅ <strong>Lists</strong> (ordered and unordered, nested)
                </li>
                <li>
                  ✅ <strong>Code blocks</strong> and inline code
                </li>
                <li>
                  ✅ <strong>Blockquotes</strong> (&gt; quoted text)
                </li>
                <li>
                  ✅ <strong>Links</strong> (keeps text, removes URLs)
                </li>
                <li>
                  ✅ <strong>Images</strong> (removes completely)
                </li>
                <li>
                  ✅ <strong>Tables</strong> (converts to plain text format)
                </li>
                <li>
                  ✅ <strong>Horizontal rules</strong> (removes)
                </li>
                <li>
                  ✅ <strong>HTML tags</strong> (strips all tags)
                </li>
              </ul>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Convert README files and documentation to plain text for
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Clean up markdown content for email newsletters and plain text
                  emails.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Move content from markdown-based systems to plain text
                  formats.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Prepare markdown content for text analysis tools that require
                  plain text.
                </p>
              </div>
            </CardContent>
        ...
        <Card className="mt-8">
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                All markdown formatting is removed, but the text structure is
                preserved. Lists become bullet points or numbered items, and
                headers become plain text with proper spacing.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Yes, markdown tables are converted to a plain text format with
                pipe separators for readability.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Code blocks are preserved as plain text with the code content
                intact, but the markdown formatting (backticks) is removed.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Yes! This tool is more comprehensive and handles all markdown
                elements including tables, nested lists, and complex formatting.
                The ChatGPT converter is optimized for typical AI responses.
              </p>
            </div>
          </CardContent>
        </Card>

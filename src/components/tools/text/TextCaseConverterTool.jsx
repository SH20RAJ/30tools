...
export default function TextCaseConverterTool() {
    const [inputText, setInputText] = useState('Convert this text to different cases using our free online text case converter tool. Perfect for developers, writers, and content creators.');
    ...
    const restoreExample = () => {
        setInputText('Convert this text to different cases using our free online text case converter tool. Perfect for developers, writers, and content creators.');
    };
            ...
            <div className="container mx-auto px-4 py-8 max-w-6xl">
                ...
                <div className="mb-8">
                    ...
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">Convert text to UPPERCASE, lowercase, Title Case, camelCase, and more</p>
                        </div>
                    </div>
                                        ...
                                        >
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    ...
                                                    <p className="text-xs text-muted-foreground">{caseType.description}</p>
                                                </div>
                                                <div className="flex gap-1">
                                                    <Button
                                                        onClick={() => copyToClipboard(caseType.text, caseType.id)}
                                                        variant="ghost"
                                                        size="sm"
                                                    >
                                                    ...
                                                    <Button
                                                        onClick={() => downloadAsText(caseType.text, caseType.id)}
                                                        variant="ghost"
                                                        size="sm"
                                                    >
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div>
                                ...
                                <ul className="text-xs text-muted-foreground space-y-1">
                                    ...
                                    <li>• <strong>Sentence case:</strong> Normal text, descriptions</li>
                                    <li>• <strong>UPPERCASE:</strong> Headings, emphasis</li>
                                    <li>• <strong>lowercase:</strong> Casual text, tags</li>
                                </ul>
                            </div>
                            ...
                            <div>
                                ...
                                <ul className="text-xs text-muted-foreground space-y-1">
                                    <li>• <strong>aLtErNaTiNg:</strong> Creative text, memes</li>
                                    <li>• <strong>dot.case:</strong> File extensions, domains</li>
                                    <li>• <strong>path/case:</strong> File paths, URLs</li>
                                </ul>
                            </div>
                        </CardContent>
                    </Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div>
                                ...
                                <ul className="text-sm text-muted-foreground space-y-1">
                                    ...
                                    <li>• <strong>Ctrl/Cmd + C:</strong> Copy text</li>
                                    <li>• <strong>Ctrl/Cmd + V:</strong> Paste text</li>
                                    <li>• <strong>Ctrl/Cmd + Z:</strong> Undo changes</li>
                                </ul>
                            </div>
                        </CardContent>
                    </Card>
                ...
                <Card className="mt-8">
                    ...
                    <CardContent className="space-y-6">
                        <div>
                            <h4 className="font-medium mb-2">What is a text case converter?</h4>
                        ...
                        <div>
                            <h4 className="font-medium mb-2">What case formats are supported?</h4>
                            <p className="text-sm text-muted-foreground">
                        ...
                        <div>
                            <h4 className="font-medium mb-2">When should I use camelCase vs snake_case?</h4>
                            <p className="text-sm text-muted-foreground">
                        ...
                        <div>
                            <h4 className="font-medium mb-2">Is this text case converter free to use?</h4>
                            <p className="text-sm text-muted-foreground">
                        ...
                        <div>
                            <h4 className="font-medium mb-2">Can I convert large amounts of text?</h4>
                            <p className="text-sm text-muted-foreground">
                        ...
                        <div>
                            <h4 className="font-medium mb-2">How do I convert text to Title Case?</h4>
                            <p className="text-sm text-muted-foreground">

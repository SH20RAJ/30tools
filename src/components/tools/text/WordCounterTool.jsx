...
export default function WordCounterTool() {
  ...
  const stats = useMemo(() => {
    ...
    const avgCharsPerWord =
      wordCount > 0 ? Math.round(charactersWithoutSpaces / wordCount) : 0;
          ...
          <div className="lg:col-span-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Paste or type your text below to get instant word count and
                  text analysis
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    ...
                    {stats.readingTimeSeconds % 60} sec
                  </span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="text-xs text-muted-foreground mt-2">
                  * Based on average reading speed of 200 words/min and speaking
                  speed of 125 words/min
                </div>
              </CardContent>
            </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Our word counter uses the same algorithm as Microsoft Word,
                  counting words separated by spaces and line breaks.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  No, all text processing happens in your browser. Your text is
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  There's no limit! You can analyze texts of any length, from
                  tweets to full documents.
                </p>
              </div>
            </CardContent>
          </Card>
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Type or paste your text directly into the input area. The
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Check the statistics panel for word count, character count,
                    reading time, and other metrics.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    View the most frequently used words in your text to
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Export your text or download a detailed statistics report
                    for your records.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      All analysis happens locally in your browser. No data is
                      sent to servers.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Statistics update instantly as you type, providing
                      immediate feedback.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Calculate reading and speaking times based on standard
                      rates.
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Download detailed analysis reports in text format for
                      documentation.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Identify most common words to improve writing style and
                      SEO.
                    </p>
                  </div>
                </div>
        ...
        <Card className="mt-6">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                We use the same word counting method as Microsoft Word,
                splitting text by spaces, tabs, and line breaks while filtering
                out empty strings.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                Characters with spaces includes all whitespace. Characters
                without spaces counts only the actual text characters, useful
                for length limits.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                Reading time is based on 200 words per minute (average adult
                reading speed). Speaking time uses 125 words per minute
                (conversational pace).
              </p>
            </div>
            ...
            <div className="space-y-3">
              <h4 className="font-semibold">
                Why are some common words excluded from frequency analysis?
              </h4>
              <p className="text-sm text-muted-foreground">
                We filter out common stop words (the, a, and, etc.) to focus on
                meaningful content words that reveal your writing's true topics.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                Absolutely! The word frequency analysis helps identify keyword
                opportunities, while statistics help optimize content length for
                SEO.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                No limits! You can analyze anything from short tweets to full
                novels. All processing happens in your browser for maximum
                privacy.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <h4 className="font-semibold">
                How do you count sentences and paragraphs?
              </h4>
              <p className="text-sm text-muted-foreground">
                Sentences are counted by splitting on periods, question marks,
                and exclamation points. Paragraphs are counted by double line
                breaks.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                Yes! Use the "Download Report" button to save a complete text
                analysis report as a .txt file with all statistics and metrics.
              </p>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
              <div className="space-y-4">
                <div className="border rounded-lg p-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    "This word counter is essential for my freelance writing.
                    The real-time updates and reading time estimates help me
                    meet client requirements perfectly. The word frequency
                    analysis is great for SEO optimization."
                  </p>
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    "Perfect for academic writing! I use it for essays and
                    research papers. The character count and reading time help
                    me stay within assignment limits. Much better than Word's
                    built-in counter."
                  </p>
                  <p className="text-xs text-muted-foreground mt-2">
                    November 18, 2024
              ...
              <div className="space-y-4">
                <div className="border rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-sm font-medium">
                      Maria Rodriguez, Social Media Manager
                    </span>
                  </div>
                  <p className="text-sm text-muted-foreground">
                    "The most accurate word counter I've found. Perfect for
                    Twitter threads and LinkedIn posts. Love that it works
                    offline and doesn't store my content. The export feature is
                    a nice touch."
                  </p>
                  <p className="text-xs text-muted-foreground mt-2">
                    November 15, 2024
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    "As a professional editor, precision matters. This tool
                    gives me detailed statistics that help me analyze writing
                    quality and readability. The sentence analysis is
                    particularly useful for improving prose."
                  </p>
                  <p className="text-xs text-muted-foreground mt-2">
                    November 12, 2024
                  </p>
          ...
          <CardContent>
            <div className="grid md:grid-cols-3 gap-4 sm:gap-6">
              ...
              <div className="text-center p-4 border rounded-lg hover:bg-muted/50 transition-colors">
                ...
                <p className="text-sm text-muted-foreground">
                  Remove duplicate lines and text
                </p>
              </div>
              ...
              <div className="text-center p-4 border rounded-lg hover:bg-muted/50 transition-colors">
                ...
                <p className="text-sm text-muted-foreground">
                  Format and beautify text content
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <div className="space-y-6 mt-8">
          <Card>
            ...
            <CardContent className="prose prose-sm max-w-none">
              ...
              <p>
                Word counting and text analysis are essential skills for
                writers, students, content creators, and professionals.
                Understanding your text statistics helps improve writing
                quality, meet requirements, and optimize content for different
                platforms. Our advanced word counter provides comprehensive
                analysis with real-time updates and detailed insights.
              </p>
              ...
              <ul>
                <li>
                  <strong>Word Count:</strong> Basic measure of content length
                </li>
                <li>
                  <strong>Character Count:</strong> Important for social media
                  limits and SEO
                </li>
                <li>
                  <strong>Sentence Length:</strong> Affects readability and
                  engagement
                </li>
                <li>
                  <strong>Reading Time:</strong> Helps plan content consumption
                </li>
                <li>
                  <strong>Word Frequency:</strong> Reveals writing patterns and
                  keyword usage
                </li>
              </ul>
              ...
              <p>Use text statistics to enhance your writing:</p>
              <ul>
                <li>
                  <strong>Readability:</strong> Aim for 15-20 words per sentence
                  for optimal readability
                </li>
                <li>
                  <strong>Engagement:</strong> Shorter sentences often perform
                  better online
                </li>
                <li>
                  <strong>SEO:</strong> Include target keywords naturally in
                  your content
                </li>
                <li>
                  <strong>Variety:</strong> Mix sentence lengths to maintain
                  reader interest
                </li>
                <li>
                  <strong>Conciseness:</strong> Remove unnecessary words to
                  improve clarity
                </li>
              </ul>
              ...
              <ul>
                <li>
                  <strong>Keyword Research:</strong> Identify important terms in
                  your content
                </li>
                <li>
                  <strong>Content Gaps:</strong> Find topics you haven't covered
                </li>
                <li>
                  <strong>Competitor Analysis:</strong> Compare your content
                  with others
                </li>
                <li>
                  <strong>Content Strategy:</strong> Plan topics based on search
                  demand
                </li>
                <li>
                  <strong>Performance Tracking:</strong> Monitor which keywords
                  drive traffic
                </li>
              </ul>

              <h3>Advanced Text Analysis Techniques</h3>
              <p>Professional writers use advanced metrics:</p>
              <ul>
                <li>
                  <strong>Flesch Reading Ease:</strong> Measures text complexity
                </li>
                <li>
                  <strong>Gunning Fog Index:</strong> Estimates years of
                  education needed
                </li>
                <li>
                  <strong>SMOG Index:</strong> Predicts comprehension difficulty
                </li>
                <li>
                  <strong>Coleman-Liau Index:</strong> Based on characters and
                  sentences
                </li>
                <li>
                  <strong>Automated Readability Index:</strong> Uses characters
                  per word
                </li>
              </ul>
              ...
              <div className="bg-blue-50 border border-blue-200 p-4 rounded-lg">
                ...
                <ul className="text-sm text-blue-700 mt-2 space-y-1">
                  ...
                  <li>
                    • Use statistics to meet specific platform requirements
                  </li>
                  <li>
                    • Compare your metrics with successful content in your niche
                  </li>
                  <li>
                    • Focus on readability scores for better user engagement
                  </li>
                  <li>
                    • Use word frequency to identify keyword opportunities
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-50 border border-red-200 p-4 rounded-lg">
                ...
                <ul className="text-sm text-red-700 mt-2 space-y-1">
                  <li>
                    • Focusing only on word count without considering quality
                  </li>
                  <li>• Ignoring readability in favor of keyword stuffing</li>
                  <li>
                    • Not accounting for different audience reading levels
                  </li>
                  <li>
                    • Using statistics as the only measure of content quality
                  </li>
              ...
              <ul>
                <li>
                  <strong>Writers:</strong> Improve prose quality and meet word
                  count requirements
                </li>
                <li>
                  <strong>Students:</strong> Ensure assignments meet length
                  requirements
                </li>
                <li>
                  <strong>Marketers:</strong> Optimize content for search
                  engines and social media
                </li>
                <li>
                  <strong>Editors:</strong> Assess readability and content
                  quality
                </li>
                <li>
                  <strong>Translators:</strong> Compare source and target text
                  lengths
                </li>
                <li>
                  <strong>Researchers:</strong> Analyze large volumes of text
                  data
                </li>
              </ul>
            </CardContent>

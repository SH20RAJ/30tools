...
import { ArrowLeftIcon, CopyIcon, RefreshCwIcon, MessageSquareIcon, ArrowRightIcon } from 'lucide-react';
        ...
        <div className="min-h-screen bg-background">
            <div className="container mx-auto px-4 py-8 max-w-6xl">
                ...
                <div className="mb-8">
                    ...
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">Convert ChatGPT markdown to clean, normal text</p>
                        </div>
                    </div>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <ul className="space-y-2 text-sm">
                                <li>✅ <strong>Headers</strong> (# ## ###) → Plain text</li>
                                <li>✅ <strong>Bold text</strong> (**text**) → Normal text</li>
                                <li>✅ <strong>Italic text</strong> (*text*) → Normal text</li>
                                <li>✅ <strong>Lists</strong> (- item) → Bullet points (•)</li>
                                <li>✅ <strong>Numbered lists</strong> (1. item) → Proper numbering</li>
                                <li>✅ <strong>Code blocks</strong> (```code```) → Clean code</li>
                                <li>✅ <strong>Inline code</strong> (`code`) → Normal text</li>
                                <li>✅ <strong>Links</strong> ([text](url)) → Just the text</li>
                                <li>✅ <strong>Blockquotes</strong> (&gt; text) → Quoted text</li>
                                <li>✅ <strong>Strikethrough</strong> (~~text~~) → Normal text</li>
                            </ul>
                        </CardContent>
                    </Card>
                        ...
                        <CardContent className="space-y-4">
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Clean up AI-generated content for blogs, articles, and social media posts.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Convert ChatGPT responses to clean text for emails and messaging apps.
                                </p>
                            </div>
                ...
                <Card className="mt-8">
                    ...
                    <CardContent className="space-y-4">
                        <div>
                            <h4 className="font-medium mb-1">Why do I need to convert ChatGPT text?</h4>
                            <p className="text-sm text-muted-foreground">
                                ChatGPT outputs text in markdown format with special characters for formatting. This tool removes those characters to give you clean, readable text.
                            </p>
                        </div>

                        <div>
                            <h4 className="font-medium mb-1">Does this work with other AI tools?</h4>
                            <p className="text-sm text-muted-foreground">
                                Yes! This works with any markdown-formatted text from Claude, Gemini, or other AI assistants.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                                No, all conversion happens in your browser. Your text is never uploaded to our servers.
                            </p>
                        </div>

                        <div>
                            <h4 className="font-medium mb-1">Can I convert large amounts of text?</h4>
                            <p className="text-sm text-muted-foreground">
                                Yes, there's no limit on text length. You can convert entire documents or conversations.
                            </p>
                        </div>
                    </CardContent>
                </Card>

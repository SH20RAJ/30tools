          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Convert videos to animated GIFs with advanced controls
              </p>
            </div>
          </div>
                        ...
                        <div className="flex-1">
                          <div className="relative">
                            ...
                            <div
                              ...
                              style={{
                                left: `${(settings.endTime / duration) * 100}%`,
                              }}
                            />
                          </div>
                        </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      setSettings((prev) => ({ ...prev, optimize: checked }))
                    }
                  />
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card>
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Choose your video file. Supports MP4, AVI, MOV, and other
                    formats.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Set start and end times, adjust quality, frame rate, and
                    size.
                  </p>
                </CardContent>
              </Card>

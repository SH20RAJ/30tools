...
export default function MP4ToMP3Converter() {
    ...
    const handleFileUpload = (event) => {
        ...
        if (uploadedFile) {
            ...
            if (!uploadedFile.type.includes('mp4') && !uploadedFile.name.toLowerCase().endsWith('.mp4')) {
                                ...
                                <CardContent className="p-4">
                                    <div className="flex items-center gap-4 mb-4">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-xs text-muted-foreground">From: {conversionData.originalFile}</p>

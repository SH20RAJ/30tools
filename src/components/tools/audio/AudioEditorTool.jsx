...
export default function AudioEditor() {
  ...
  const resetAll = () => {
    ...
    setEffects({
      ...
      compressorAttack: 3, compressorRelease: 250,
      limiterThreshold: -3, gateThreshold: -40,
      reverbAmount: 0, reverbDecay: 2,
      delayTime: 0.3, delayFeedback: 0.3, delayAmount: 0,
      chorusRate: 1.5, chorusDepth: 0.35, chorusAmount: 0,
      flangerRate: 0.5, flangerDepth: 1, flangerAmount: 0,
      phaserRate: 0.5, phaserDepth: 1, phaserAmount: 0,
      distortionAmount: 0, overdrive: 0, bitcrusher: 0,
      lowPassFreq: 20000, highPassFreq: 20,
      bandPassFreq: 1000, bandPassQ: 1,
      notchFreq: 1000, notchQ: 1,
      pitch: 0, formant: 0, timeStretch: 1,
          ...
          <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
            ...
            <div className="xl:col-span-3">
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button onClick={togglePlayPause} size="lg" className="px-6">
              ...
              <Card className="mb-6">
                ...
                <CardContent>
                  <div id="waveform" className="w-full h-32 bg-slate-50 rounded-lg"></div>
                  {tracks.length === 0 && (
                    <div className="flex items-center justify-center h-32 bg-slate-50 rounded-lg">
                      <div className="text-center">
                        ...
                        <p className="text-sm text-muted-foreground">Load an audio file to see waveform</p>
                      </div>
                    </div>
                  )}
                </CardContent>
              ...
              <Card>
                ...
                <CardContent>
                      ...
                      <div className="grid grid-cols-3 gap-4">
                        <div className="space-y-2">
                          ...
                          <Slider
                            ...
                            className="w-full"
                          />
                          <span className="text-xs text-muted-foreground text-center block">{effects.lowGain}dB</span>
                        </div>
                        <div className="space-y-2">
                          ...
                          <Slider
                            ...
                            className="w-full"
                          />
                          <span className="text-xs text-muted-foreground text-center block">{effects.midGain}dB</span>
                        </div>
                        <div className="space-y-2">
                          ...
                          <Slider
                            ...
                            className="w-full"
                          />
                          <span className="text-xs text-muted-foreground text-center block">{effects.highGain}dB</span>
                        </div>
                      </div>
                    </TabsContent>
                          ...
                          <div className="space-y-3">
                            <div>
                              ...
                              <Slider
                                ...
                                step={1}
                              />
                              <span className="text-xs text-muted-foreground">{effects.compressorThreshold}dB</span>
                            </div>
                            <div>
                              ...
                              <Slider
                                ...
                                step={0.1}
                              />
                              <span className="text-xs text-muted-foreground">{effects.compressorRatio}:1</span>
                            </div>
                          </div>
                        </div>
                        <div className="space-y-4">
                          ...
                          <div className="space-y-3">
                            <div>
                              ...
                              <Slider
                                ...
                                step={0.1}
                              />
                              <span className="text-xs text-muted-foreground">{effects.limiterThreshold}dB</span>
                            </div>
                          </div>
                        </div>
                      </div>
                          ...
                          <div className="space-y-3">
                            <div>
                              ...
                              <Slider
                                ...
                                step={1}
                              />
                              <span className="text-xs text-muted-foreground">{effects.reverbAmount}%</span>
                            </div>
                          </div>
                        </div>
                        <div className="space-y-4">
                          ...
                          <div className="space-y-3">
                            <div>
                              ...
                              <Slider
                                ...
                                step={1}
                              />
                              <span className="text-xs text-muted-foreground">{effects.delayAmount}%</span>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-6">
                        ...
                        <div className="space-y-4">
                          <div>
                            ...
                            <Select value={exportSampleRate.toString()} onValueChange={(value) => setExportSampleRate(parseInt(value))}>
                              <SelectTrigger>
                                <SelectValue />
                              </SelectTrigger>
                              <SelectContent>
                          ...
                          <div>
                            ...
                            <Select value={exportBitDepth.toString()} onValueChange={(value) => setExportBitDepth(parseInt(value))}>
                              <SelectTrigger>
                                <SelectValue />
                              </SelectTrigger>
                              <SelectContent>
                  ...
                  <div className="flex gap-2">
                    <Button onClick={applyEffects} disabled={isProcessing || tracks.length === 0}>

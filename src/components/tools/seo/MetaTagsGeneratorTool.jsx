...
export default function MetaTagsGeneratorTool() {
  ...
  const getCharacterStatus = (text, limit) => {
    ...
    if (length === 0)
      return { status: "empty", color: "text-muted-foreground" };
    if (length < limit.min) return { status: "short", color: "text-primary" };
    if (limit.ideal && length >= limit.ideal[0] && length <= limit.ideal[1])
      return { status: "ideal", color: "text-primary" };
  ...
  const generateMetaTags = useMemo(() => {
    ...
    const ogDescription =
      metaData.ogDescription || (useOgFallback ? metaData.description : "");
    ...
    const twitterTitle =
      ...
      (useTwitterFallback ? metaData.ogTitle || metaData.title : "");
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Create SEO-optimized meta tags for your website
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Fill in your website information to generate optimized meta
                  tags
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Tabs value={activeTab} onValueChange={setActiveTab}>
                  ...
                  <TabsContent value="basic" className="space-y-4">
                    <div>
                      ...
                      <Input
                        ...
                        className={
                          getCharacterStatus(metaData.title, limits.title).color
                        }
                      />
                      <div className="flex justify-between text-xs mt-1">
                        <span
                          className={
                            getCharacterStatus(metaData.title, limits.title)
                              .color
                          }
                        >
                        ...
                        <span className="text-muted-foreground">
                          Ideal: {limits.title.ideal[0]}-{limits.title.ideal[1]}{" "}
                          chars
                        </span>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex justify-between text-xs mt-1">
                        ...
                        >
                          {metaData.description.length}/{limits.description.max}{" "}
                          characters
                        </span>
                        <span className="text-muted-foreground">
                          Ideal: {limits.description.ideal[0]}-
                          {limits.description.ideal[1]} chars
                        </span>
                      </div>
                    </div>
                  ...
                  <TabsContent value="opengraph" className="space-y-4">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="flex items-center space-x-2">
                        <Label htmlFor="og-fallback" className="text-sm">
                    ...
                    <div>
                      ...
                      <Textarea
                        id="og-description"
                        placeholder={
                          useOgFallback && metaData.description
                            ? metaData.description
                      ...
                      <div className="text-xs text-muted-foreground mt-1">
                        ...
                        /{limits.ogDescription.max} characters
                      </div>
                    </div>
                  ...
                  <TabsContent value="twitter" className="space-y-4">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="flex items-center space-x-2">
                        <Label htmlFor="twitter-fallback" className="text-sm">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground mt-1">
                        ...
                        /{limits.twitterTitle.max} characters
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground mt-1">
                        ...
                        /{limits.twitterDescription.max} characters
                      </div>
                    </div>

                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="twitter-site">
                  ...
                  <TabsContent value="advanced" className="space-y-4">
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          setMetaData((prev) => ({ ...prev, robots: value }))
                        }
                      >
                        <SelectTrigger>
                          <SelectValue />
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(value) =>
                            setMetaData((prev) => ({ ...prev, charset: value }))
                          }
                        >
                          <SelectTrigger>
                            <SelectValue />
                    ...
                    <div>
                      <Label htmlFor="apple-touch-icon">
            ...
            <Card>
              ...
              <CardContent>
                <div className="border rounded-lg p-4 bg-muted/20">
                  ...
                  <div className="text-primary text-sm">{previewData.url}</div>
                ...
                <div className="space-y-4">
                  <div className="bg-muted/50 p-4 rounded-lg">
                    <pre className="text-xs overflow-x-auto whitespace-pre-wrap">
                      {generateMetaTags ||
                        "<!-- Fill out the form to generate meta tags -->"}
                    </pre>
                  </div>
        ...
        <div className="mt-16 space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-muted-foreground">
                    The most important meta tag for SEO. Appears as the
                    clickable headline in search results. Keep it under 60
                    characters and include your target keyword.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-muted-foreground">
                    The snippet text that appears under your title in search
                    results. Write compelling copy that encourages clicks while
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    platforms like Facebook, LinkedIn, and WhatsApp. Include
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Optimize your content for Twitter sharing. Choose from
                    summary, large image, app, or player card types based on
                    your content.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Essential for mobile responsiveness. Tell browsers how to
                    display your page on different screen sizes and devices.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Control how search engines crawl and index your pages. Use
                    index/noindex and follow/nofollow directives strategically.
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Meta tags are HTML elements that provide information about
                    your webpage to search engines and social media platforms.
                    They're crucial for SEO, click-through rates, and social
                    sharing.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Include target keywords naturally, write compelling
                    descriptions, stay within character limits, and ensure each
                    page has unique meta tags. Test how they appear in search
                    results.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Open Graph tags work for Facebook, LinkedIn, and most
                    platforms. Twitter Cards are specific to Twitter but can
                    fall back to Open Graph if not specified.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Update meta tags when you refresh content, target new
                    keywords, or notice poor performance in search results.
                    Regular audits help maintain SEO effectiveness.
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <section className="bg-muted/30 p-8 rounded-lg">
            <h2 className="text-2xl font-bold mb-4">
              Professional Meta Tags Generator - Free SEO Tool
            </h2>
            <div className="prose prose-sm max-w-none text-muted-foreground">
              <p className="mb-4">
                Create SEO-optimized meta tags instantly with our free meta tags
                generator. Generate perfect title tags, meta descriptions, Open
                Graph tags, and Twitter Cards with real-time character counting
                and search result previews. Essential for improving search
                rankings and social media engagement.
              </p>
              <p className="mb-4">
                <strong>Features include:</strong> automatic character counting
                with color-coded warnings, real-time search result preview,
                social media sharing preview, Open Graph and Twitter Card
                optimization, fallback options for efficiency, and downloadable
                HTML code. Perfect for SEO professionals, web developers, and
                digital marketers.
              </p>
              <p>
                <strong>SEO benefits:</strong> Improve click-through rates from
                search results, enhance social media sharing appearance,
                optimize for featured snippets, ensure mobile-friendly display,
                and maintain consistent branding across platforms. Generate
                professional meta tags that boost your website's visibility and
                engagement.
              </p>
            </div>
          </section>

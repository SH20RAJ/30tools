...
export default function KeywordResearchTool({ searchEngine = "bing" }) {
  ...
  const getTagBadge = (tag) => {
    ...
    return (
      <Badge className={tagStyles[tag] || "bg-gray-100 text-gray-800"}>
        {tag}
      </Badge>
    );
  };
    ...
    <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Enter a keyword to research related terms and phrases for{" "}
            {searchType === "bing" ? "Bing" : "Google"}.
          </CardDescription>
        </CardHeader>
      ...
      {results.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Keyword research results for "{keyword}" on{" "}
              {searchType === "bing" ? "Bing" : "Google"}
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <CardContent>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div>
              ...
              <ul className="text-sm text-muted-foreground space-y-1">
                <li>
                  • <span className="font-medium">Tools:</span> Keywords related
                  to utility websites
                </li>
                <li>
                  • <span className="font-medium">Questions:</span> Keywords
                  starting with who, what, when, where, why
                </li>
                <li>
                  • <span className="font-medium">Comparison:</span> Keywords
                  comparing products or services
                </li>
                <li>
                  • <span className="font-medium">Lists:</span> Keywords for
                  listicles and roundups
                </li>
                <li>
                  • <span className="font-medium">Tutorials:</span> How-to and
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div>
              ...
              <ul className="text-sm space-y-1">
                <li>
                  <strong>Informational:</strong> How-to, what is, why
                </li>
                <li>
                  <strong>Navigational:</strong> Brand or website specific
                </li>
                <li>
                  <strong>Transactional:</strong> Buy, download, sign up
                </li>
                <li>
                  <strong>Commercial:</strong> Best, top, review
                </li>
              </ul>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="bg-muted p-3 rounded-lg">
              ...
              <ul className="text-sm space-y-1">
                <li>
                  • "best free keyword research tools 2024" (vs "keyword
                  research")
                </li>
                <li>
                  • "how to do keyword research for beginners" (vs "keyword
                  research")
                </li>
                <li>
                  • "free keyword research tool with search volume" (vs "keyword
                  research")
                </li>
              </ul>
            </div>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              search terms that people enter into search engines. It helps you
              understand what your target audience is searching for and how to
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              Keyword research helps you create content that matches what people
              are actually searching for. It guides your content strategy, helps
              you identify content gaps, and ensures you're targeting terms with
              the right balance of search volume and competition.
            </p>
          </div>

          <div className="space-y-3">
            <h4 className="font-semibold">
              What's the difference between Bing and Google keyword research?
            </h4>
            <p className="text-sm text-muted-foreground">
              While there are similarities, Bing and Google have different user
              bases and algorithms. Bing tends to favor more traditional SEO
              factors, while Google emphasizes user experience and quality
              content. Researching both can help you optimize for multiple
              search engines.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              Keyword research should be done regularly. Search trends change,
              new keywords emerge, and competition evolves. We recommend doing
              comprehensive research quarterly and spot checks monthly for your
              main keywords.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              A good keyword has high search volume, low to medium competition,
              and matches your content's topic. It should also align with user
              intent - what people actually want when they search for that term.
            </p>
          </div>

          <div className="space-y-3">
            <h4 className="font-semibold">
              How do I use keyword research results?
            </h4>
            <p className="text-sm text-muted-foreground">
              Use the results to create content that targets high-value
              keywords, optimize existing pages, identify content gaps, and
              develop a comprehensive SEO strategy that drives organic traffic.
            </p>
          </div>
        </CardContent>
      </Card>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            <div className="space-y-4">
              <div className="border rounded-lg p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-medium">
                    Jennifer Martinez, SEO Consultant
                  </span>
                </div>
                <p className="text-sm text-muted-foreground">
                  "This keyword research tool has transformed my workflow. The
                  Bing integration is a game-changer for clients targeting that
                  search engine. The data quality is excellent and the interface
                  is intuitive."
                </p>
              ...
              <div className="border rounded-lg p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-medium">
                    Alex Thompson, Content Marketer
                  </span>
                </div>
                <p className="text-sm text-muted-foreground">
                  "Finally, a keyword tool that gives me both Google and Bing
                  data! The keyword suggestions are spot-on and have helped me
            ...
            <div className="space-y-4">
              <div className="border rounded-lg p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  "Great tool for comprehensive keyword research. The
                  categorization feature helps me quickly identify
                  question-based keywords for featured snippets. Would love to
                  see more export options."
                </p>
                <p className="text-xs text-muted-foreground mt-2">
                  November 9, 2024
                </p>
              ...
              <div className="border rounded-lg p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-medium">
                    Marcus Rodriguez, SEO Agency Owner
                  </span>
                </div>
                <p className="text-sm text-muted-foreground">
                  "This tool has become essential for my agency's workflow. The
                  ability to research keywords for both search engines gives us
                  a competitive edge. Highly recommended for serious SEO
                  professionals."
                </p>
                <p className="text-xs text-muted-foreground mt-2">
                  November 7, 2024
        ...
        <CardContent>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="text-center p-4 border rounded-lg hover:bg-muted/50 transition-colors">
              ...
              <p className="text-sm text-muted-foreground">
                Create optimized meta tags for better SERP appearance
              </p>
            </div>
      ...
      <div className="space-y-6">
        <Card>
          ...
          <CardContent className="prose prose-sm max-w-none">
            ...
            <p>
              Keyword research is the foundation of successful SEO strategy. By
              understanding what your target audience searches for, you can
              create content that answers their questions and solves their
              problems. Our advanced keyword research tool provides
              comprehensive data from both Google and Bing, giving you a
              complete picture of search behavior across multiple platforms.
            </p>

            <h3>Why Keyword Research Matters</h3>
            <p>Effective keyword research helps you:</p>
            <ul>
            ...
            <p>
              Beyond basic keyword research, successful SEO professionals use
              advanced techniques like:
            </p>
            <ul>
              <li>
                <strong>Search Intent Analysis:</strong> Understanding why
                people search for specific terms
              </li>
              <li>
                <strong>Competitor Keyword Analysis:</strong> Discovering what
                keywords competitors rank for
              </li>
              <li>
                <strong>Seasonal Keyword Research:</strong> Identifying trending
                topics and seasonal opportunities
              </li>
              <li>
                <strong>Long-tail Keyword Optimization:</strong> Targeting
                specific, conversational search queries
              </li>
              <li>
                <strong>Voice Search Optimization:</strong> Preparing for
            ...
            <p>Track the success of your keyword research by monitoring:</p>
            <ul>
              <li>
                <strong>Ranking Improvements:</strong> Track keyword positions
                in search results
              </li>
              <li>
                <strong>Traffic Growth:</strong> Monitor organic search traffic
                increases
              </li>
              <li>
                <strong>Conversion Rates:</strong> Measure if targeted keywords
                drive conversions
              </li>
              <li>
                <strong>Content Performance:</strong> Analyze which
                keyword-targeted content performs best
              </li>
              <li>
                <strong>ROI Metrics:</strong> Calculate return on investment for
                SEO efforts
              </li>
            </ul>
          </CardContent>

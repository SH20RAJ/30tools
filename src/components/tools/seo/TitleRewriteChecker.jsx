...
export default function TitleRewriteChecker() {
  ...
  const getTitleLengthStatus = (length) => {
    if (length > 60) {
      ...
      return <Badge className="bg-yellow-500">{length} chars</Badge>;
    }
    return <Badge className="bg-green-500">{length} chars</Badge>;
  };
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <h1 className="text-4xl font-bold text-gray-900">Title Rewrite Checker</h1>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <Card>
          <CardHeader className="text-center pb-3">
            <Edit3 className="h-8 w-8 text-green-500 mx-auto mb-2" />
      ...
      {results.length > 0 && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <Card>
            <CardContent className="p-4 text-center">
              <div className="text-2xl font-bold text-red-600">{stats.rewritten}</div>
              <div className="text-sm text-gray-600">Rewritten</div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-4 text-center">
              <div className="text-2xl font-bold text-green-600">{stats.original}</div>
              <div className="text-sm text-gray-600">Original</div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-4 text-center">
              <div className="text-2xl font-bold text-orange-600">{stats.tooLong}</div>
                    ...
                    <tr key={index} className="border-b hover:bg-gray-50">
                      ...
                      <td className="p-3">
                        <div className="space-y-1">
                          ...
                          <div className="text-xs text-gray-500">SERP:</div>

...
export default function SSLChecker() {
  ...
  const getExpiryStatus = (days) => {
    if (days < 0)
      return { color: "text-destructive", text: "Expired", icon: XCircle };
    if (days < 7)
      return {
    ...
    <div className="w-full max-w-4xl mx-auto">
      ...
      {sslData && (
        <div className="space-y-6">
          {/* SSL Status Overview */}
          <Card
            className={`border-2 ${sslData.isValid ? "border-border/20" : "border-border/20"} shadow-lg`}
          >
            <CardHeader
              className={`bg-gradient-to-r ${sslData.isValid ? "from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-900/20" : "from-red-50 to-orange-50 dark:from-red-950/20 dark:to-orange-900/20"}`}
            >
            ...
            <CardContent className="p-6">
              <div className="grid md:grid-cols-3 gap-4">
                <div className="text-center">
                  <div
                    className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3 text-3xl font-bold border-2 ${getGradeColor(sslData.grade)}`}
                  >
                    {sslData.grade}
                  </div>
                ...
                <div className="text-center">
                  {(() => {
                    ...
                    return (
                      <>
                        <div
                          className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3 ${status.color} bg-current/10`}
                        >
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge
                        variant={
                          sslData.features.hsts ? "default" : "secondary"
                        }
                      >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Badge
                        variant={sslData.features.sni ? "default" : "secondary"}
                      >
                ...
                {sslData.certificateChain.map((cert, index) => (
                  ...
                  >
                    ...
                    <Badge variant="outline">
                      {index === 0
                        ? "End Entity"
                        : index === sslData.certificateChain.length - 1
                          ? "Root CA"
                          : "Intermediate"}
                    </Badge>
                  </div>
              ...
              <div className="space-y-3">
                {sslData.daysUntilExpiry < 30 && (
                  <div className="p-4 bg-muted/50 border border-border rounded-lg">
                    ...
                    <p className="text-sm text-primary mt-1">
                      Your SSL certificate expires in {sslData.daysUntilExpiry}{" "}
                      days. Consider renewing it soon to avoid service
                      interruption.
                    </p>
                  </div>
                )}
                ...
                {!sslData.features.hsts && (
                  <div className="p-4 bg-muted/50 border border-border rounded-lg">
                    ...
                    <p className="text-sm text-primary mt-1">
                      ...
                      Consider enabling it to improve security.
                    </p>
                  </div>
                )}
                ...
                {sslData.grade !== "A" && (
                  <div className="p-4 bg-muted/50 border border-border rounded-lg">
                    ...
                    <p className="text-sm text-primary mt-1">
                      Your SSL configuration could be improved. Consider
                      updating cipher suites and enabling additional security
                      features.
                    </p>
                  </div>
                )}

...
export default function SerpSimulator() {
	...
	const [description, setDescription] = useState(
		"This is your meta description. It should be enticing and between 150-160 characters long to maximize click-through rates from search results.",
	);
					...
					<CardContent className="space-y-4">
						<div className="space-y-2">
							...
							<div className="flex justify-between text-xs text-muted-foreground">
								...
								<span
									className={
										title.length > 60 ? "text-red-500" : "text-green-500"
									}
								>
									Max ~60
								</span>
						...
						<div className="space-y-2">
							...
							<div className="flex justify-between text-xs text-muted-foreground">
								...
								<span
									className={
										description.length > 160 ? "text-red-500" : "text-green-500"
									}
								>
									Max ~160
								</span>
								...
								<div className="max-w-[360px] bg-white dark:bg-black p-2 rounded">
									<div className="flex items-center gap-2 mb-1">
										...
										<div className="text-sm text-[#202124] dark:text-[#dadce0]">
											...
											<div className="text-xs truncate text-[#5f6368] dark:text-[#bdc1c6]">
												{url}
											</div>
										</div>
									</div>
							...
							<div>
								...
								<div className="max-w-[600px] bg-white dark:bg-black p-2 rounded">
									<div className="flex items-center gap-1 text-sm text-[#202124] dark:text-[#dadce0] mb-1">
										...
										<span className="text-[#5f6368] dark:text-[#bdc1c6] -mt-2">
											.
										</span>
									</div>

...
export default function PercentageCalculatorTool() {
  ...
  const [increaseCalc, setIncreaseCalc] = useState({
    oldValue: "",
    newValue: "",
    result: "",
  });
  const [findPercentCalc, setFindPercentCalc] = useState({
    part: "",
    whole: "",
    result: "",
  });
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        {basicCalc.percentage}% of {basicCalc.value} ={" "}
                        {basicCalc.result}
                      </p>
                    </div>
                    <Button
                ...
                <div className="p-4 bg-muted/50 rounded-lg">
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        {findPercentCalc.part} is {findPercentCalc.result} of{" "}
                        {findPercentCalc.whole}
                      </p>
                    </div>
                    <Button
                      variant="outline"

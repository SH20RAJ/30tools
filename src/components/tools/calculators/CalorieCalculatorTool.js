...
export default function CalorieCalculatorTool() {
    ...
    const activityLevels = {
        sedentary: { name: 'Sedentary', multiplier: 1.2, description: 'Little or no exercise' },
    ...
    const calculateCalories = () => {
        ...
        if (ageNum > 0 && heightNum > 0 && weightNum > 0 && activity) {
            ...
            const protein = (targetCalories * 0.30) / 4; // 4 calories per gram
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <Select value={goal} onValueChange={setGoal}>
                                    ...
                                    <SelectContent>
                                        <SelectItem value="lose-fast">Lose Weight Fast (1.5 lbs/week)</SelectItem>
                                        <SelectItem value="lose">Lose Weight (1 lb/week)</SelectItem>
                                        <SelectItem value="maintain">Maintain Weight</SelectItem>
                                        <SelectItem value="gain">Gain Weight (0.5-1 lb/week)</SelectItem>
                                        <SelectItem value="gain-fast">Gain Weight Fast (1 lb/week)</SelectItem>
                                    </SelectContent>
                                </Select>
                            </div>
                        </div>
                    ...
                    {result && (
                        <div className="space-y-6">
                            ...
                            <div className="text-center">
                                <Button
                                    variant="outline"
                                    onClick={() => navigator.clipboard.writeText(`Daily Calories: ${result.targetCalories}, BMR: ${result.bmr}, TDEE: ${result.tdee}`)}
                                >
                                    Copy Results
                                </Button>
                            </div>

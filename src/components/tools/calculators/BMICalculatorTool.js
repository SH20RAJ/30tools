            ...
            <Card>
                ...
                <CardContent className="space-y-6">
                    ...
                    <div>
                        ...
                        <RadioGroup value={units} onValueChange={setUnits} className="flex gap-6 mt-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground mt-1">
                                {units === 'metric' ? 'Enter height in centimeters' : 'Enter feet and inches'}
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            />
                            <p className="text-xs text-muted-foreground mt-1">
                                {units === 'metric' ? 'Enter weight in kilograms' : 'Enter weight in pounds'}
                            </p>
                        </div>
                    </div>
                            ...
                            <div className="p-6 bg-background">
                                ...
                                <div className="flex justify-center mt-4">
                                    <Button
                                        variant="outline"
                                        size="sm"
                                        onClick={() => copyToClipboard(`BMI: ${result.bmi} (${result.category})`)}
                                    >
                                        Copy Result
                                    </Button>
                                </div>

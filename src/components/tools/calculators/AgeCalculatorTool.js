...
export default function AgeCalculatorTool() {
  ...
  const calculateAge = () => {
    ...
    setResult({
      ...
      daysToNextBirthday,
      nextBirthdayAge:
        years + (nextBirthday.getFullYear() > target.getFullYear() ? 1 : 0),
    });
  };
              ...
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {Math.floor(result.totalDays * 100000).toLocaleString()}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span>Breaths (approx):</span>
                    <span className="font-medium">
                      {Math.floor(result.totalDays * 20000).toLocaleString()}
                    </span>
                  </div>
                </div>
              </div>

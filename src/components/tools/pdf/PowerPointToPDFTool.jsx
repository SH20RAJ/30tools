...
export default function PowerPointToPDFTool() {
    ...
    const convertToPDF = async () => {
        ...
        try {
            ...
            setConvertedFile({
                name: file.name.replace(/\.(ppt|pptx)$/, ".pdf"),
                blob: pdfBlob,
        ...
        <div className="w-full max-w-4xl mx-auto space-y-6">
            {!file ? (
                    ...
                    <CardContent className="pt-6">
                        ...
                        >
                            ...
                            <p className="text-sm text-muted-foreground mb-4">
                                Drag & drop or click to select .ppt or .pptx files
                            </p>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            {(file.size / 1024).toFixed(2)} KB • PowerPoint Presentation
                        </CardDescription>
                    </CardHeader>
                        ...
                        {!convertedFile ? (
                            <div className="space-y-4">
                                <div className="flex items-center justify-center p-8 bg-muted/30 rounded-lg">
                                    <Presentation className="w-16 h-16 text-orange-500" />
            ...
            <Card className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-900">
                ...
                <CardContent className="text-sm text-muted-foreground">
                    <p>
                        This tool converts your PowerPoint presentations to PDF format
                        directly in your browser. We support both legacy (.ppt) and modern
                        (.pptx) formats. Your slides are processed locally and are never
                        uploaded to any server, ensuring 100% privacy for your
                        presentations.
                    </p>
                </CardContent>
            </Card>

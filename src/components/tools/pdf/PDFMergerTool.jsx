      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold">PDF Merger - Free Online PDF Combiner</h1>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Select PDF files to merge online free. Combine multiple PDF documents, join PDF files, and create a single merged PDF.
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  >
                    <div className="text-center">
                      ...
                      <div className="text-sm">
                        <span className="font-medium">Choose PDF files to merge</span>
                        <span className="text-muted-foreground"> - Free PDF merger, combine PDFs online</span>
                      </div>
                    </div>
                  </Button>
            ...
            {files.length > 0 && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Drag PDF files to reorder them. Combine PDF documents in your preferred order using our free PDF merger.
                  </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li>• Drag files to reorder before using <strong>merge PDF online free</strong></li>
                  <li>• Original file quality preserved when you <strong>combine PDF online</strong></li>
                  <li>• No file size limits for <strong>free PDF merger</strong> usage</li>
                  <li>• Bookmarks and links maintained in <strong>merged PDF file</strong></li>
                  <li>• All <strong>PDF merge</strong> processing happens in your browser</li>
                  <li>• <strong>Join PDF online</strong> securely - no files uploaded to servers</li>
                  <li>• Works better than <strong>SmallPDF merge PDF</strong> - no limitations</li>
                  <li>• <strong>Combine PDF files free</strong> - no watermarks added</li>
                </ul>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="mt-16 space-y-12">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-6">Free PDF Merger Online - Professional PDF Combiner Tool</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="flex flex-wrap gap-1">
                    <Badge variant="outline" className="text-xs">merge pdf files free</Badge>
                    <Badge variant="outline" className="text-xs">free pdf merger</Badge>
                    <Badge variant="outline" className="text-xs">merge pdfs free</Badge>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="flex flex-wrap gap-1">
                    <Badge variant="outline" className="text-xs">combine pdf online</Badge>
                    <Badge variant="outline" className="text-xs">pdf combiner</Badge>
                    <Badge variant="outline" className="text-xs">join pdf</Badge>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="flex flex-wrap gap-1">
                    <Badge variant="outline" className="text-xs">pdf merge online</Badge>
                    <Badge variant="outline" className="text-xs">online pdf merger</Badge>
                    <Badge variant="outline" className="text-xs">pdf joiner</Badge>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="flex flex-wrap gap-1">
                    <Badge variant="outline" className="text-xs">adobe pdf merger</Badge>
                    <Badge variant="outline" className="text-xs">adobe merge pdf</Badge>
                    <Badge variant="outline" className="text-xs">pdf merger free</Badge>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="flex flex-wrap gap-1">
                    <Badge variant="outline" className="text-xs">ilovepdf merge</Badge>
                    <Badge variant="outline" className="text-xs">i love pdf</Badge>
                    <Badge variant="outline" className="text-xs">love pdf merge</Badge>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="flex flex-wrap gap-1">
                    <Badge variant="outline" className="text-xs">fusionner pdf</Badge>
                    <Badge variant="outline" className="text-xs">combinar pdf</Badge>
                    <Badge variant="outline" className="text-xs">unir pdf</Badge>
                  </div>
                </CardContent>
              </Card>
            </div>
          ...
          {/* How to Use */}
          <section>
            <h2 className="text-2xl font-bold mb-6">How to Merge PDF Files Online Free</h2>
          ...
          {/* Use Cases */}
          <section>
            <h2 className="text-2xl font-bold mb-6">When to Use Our Free PDF Merger Tool</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-semibold mb-4">Business & Professional PDF Merging</h3>
                <ul className="space-y-2 text-muted-foreground">
                  <li>• <strong>Business Reports:</strong> Combine quarterly reports, financial statements, and presentations using our <strong>free PDF merger online</strong></li>
                  <li>• <strong>Legal Documents:</strong> Merge contracts, agreements, and supporting documents with professional quality <strong>PDF combiner</strong></li>
                  <li>• <strong>Project Proposals:</strong> Join cover letters, proposals, and appendices into one comprehensive document</li>
                  <li>• <strong>Invoice Collections:</strong> <strong>Combine PDF files free</strong> for accounting and billing purposes</li>
                  <li>• <strong>Marketing Materials:</strong> Merge brochures, catalogs, and product sheets using our <strong>online PDF merger</strong></li>
                  <li>• <strong>Training Manuals:</strong> <strong>Merge PDF documents</strong> to create comprehensive training resources</li>
                </ul>
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-4">Academic & Personal Document Merging</h3>
                <ul className="space-y-2 text-muted-foreground">
                  <li>• <strong>Research Papers:</strong> Combine literature reviews, methodology, and results using <strong>PDF merge online free</strong></li>
                  <li>• <strong>Study Materials:</strong> <strong>Join PDF online</strong> to merge lecture notes, assignments, and reference materials</li>
                  <li>• <strong>Application Documents:</strong> Combine resumes, cover letters, and certificates for job applications</li>
                  <li>• <strong>Travel Documents:</strong> <strong>Merge PDF files online</strong> for tickets, itineraries, and confirmations</li>
                  <li>• <strong>Personal Archives:</strong> Use our <strong>free PDF merger</strong> to combine family documents and records</li>
                  <li>• <strong>Academic Portfolios:</strong> <strong>Combine PDF online</strong> to create comprehensive student portfolios</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          {/* Comparison Section */}
          <section>
            <h2 className="text-2xl font-bold mb-6">Why Choose Our Free PDF Merger Over Alternatives?</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card>
                <CardContent className="p-6">
          ...
          {/* FAQ */}
          <section>
            <h2 className="text-2xl font-bold mb-6">Frequently Asked Questions - Free PDF Merger</h2>

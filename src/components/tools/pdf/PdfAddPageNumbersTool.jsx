...
export default function PdfAddPageNumbersTool() {
  ...
  const addPageNumbers = async () => {
    ...
    try {
      ...
      const numberedBlob = new Blob(["PDF with page numbers"], {
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>
            Upload your PDF file to add page numbers • Max size:{" "}
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="skip-first" className="text-sm">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="skip-last" className="text-sm">
                    Skip last page
                  </Label>
                </div>
              </div>
          ...
          <CardContent>
            <div className="border rounded-lg p-8 bg-gray-50 relative">
                ...
                <div
                  ...
                  style={{
                    ...
                    ...(position.includes("top")
                      ? { top: `${marginY * 0.5}px` }
                      : { bottom: `${marginY * 0.5}px` }),
                    ...(position.includes("left")
                      ? { left: `${marginX * 0.5}px` }
                      : position.includes("right")
                        ? { right: `${marginX * 0.5}px` }
              ...
              <div className="text-center mt-4 text-sm text-muted-foreground">
                Preview showing page numbering style • Actual size will match
                your settings
              </div>
            </div>
          </CardContent>
      ...
      {numberedFile && (
        <Card className="mb-6">
          <CardHeader>
            ...
            <CardDescription>
              Your PDF now has professional page numbering and is ready for
              download
            </CardDescription>
          </CardHeader>
          <CardContent>

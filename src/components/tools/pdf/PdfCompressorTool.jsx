              ...
              <TabsContent value="howto" className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="text-center p-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Select your PDF file by clicking the upload area or
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Choose from 4 compression levels
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Reduce image sizes within PDFs
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Files processed locally and securely
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Use "Medium" for most documents, "Low" for maximum
                        compression, "High" for important documents
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        PDFs with many images will see the most compression
                        benefit
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Text-heavy PDFs may see smaller compression ratios but
                        still benefit from optimization
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Encrypted PDFs cannot be compressed. Remove password
                        protection first
                      </p>
                    </div>
                  </div>
              ...
              <TabsContent value="faq" className="space-y-4">
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Yes, all processing happens in your browser. Files are not
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Compression results vary, but typically range from 20-70%
                      reduction depending on content and settings.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-medium mb-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Lower compression settings may reduce quality slightly.
                      Choose "High" or "Lossless" for minimal quality loss.
                    </p>
                  </div>
                </div>
              </TabsContent>

...
import { ArrowLeftIcon, RefreshCwIcon, CopyIcon, TrendingUpIcon, ZapIcon, RocketIcon } from 'lucide-react';
...
const BUZZWORDS = {
    action: [
        'disrupting', 'revolutionizing', 'transforming', 'optimizing', 'scaling', 'innovating',
        'streamlining', 'automating', 'digitizing', 'modernizing', 'accelerating', 'empowering'
    ],
    impact: [
        'disrupting', 'revolutionizing', 'transforming', 'reshaping', 'redefining', 'reimagining',
        'changing', 'evolving', 'upgrading', 'enhancing', 'optimizing', 'supercharging'
    ],
    industry: [
        'fintech', 'healthtech', 'edtech', 'proptech', 'foodtech', 'mobility', 'logistics',
        'e-commerce', 'SaaS', 'blockchain', 'AI/ML', 'cybersecurity', 'sustainability'
    ],
    product: [
        'platform', 'ecosystem', 'solution', 'framework', 'infrastructure', 'marketplace',
        'network', 'application', 'system', 'tool', 'service', 'experience'
    ],
    technology: [
        'AI', 'machine learning', 'blockchain', 'IoT', 'cloud computing', 'big data',
        'automation', 'APIs', 'microservices', 'edge computing', 'quantum computing', 'AR/VR'
    ],
    adjective: [
        'game-changing', 'revolutionary', 'cutting-edge', 'next-generation', 'innovative',
        'disruptive', 'scalable', 'seamless', 'intelligent', 'data-driven', 'user-centric'
    ],
    target_audience: [
        'millennials', 'Gen Z', 'enterprises', 'SMBs', 'creators', 'developers',
        'consumers', 'professionals', 'startups', 'investors', 'entrepreneurs', 'users'
    ],
    comparison: [
        'Uber', 'Airbnb', 'Netflix', 'Amazon', 'Google', 'Facebook', 'Tesla',
        'Spotify', 'Instagram', 'TikTok', 'Slack', 'Zoom'
    ],
    vision: [
    ...
    problem: [
        'inefficiency', 'fragmentation', 'complexity', 'scalability challenges',
        'user experience gaps', 'data silos', 'manual processes', 'legacy systems'
    ]
};
                            ...
                            <CardContent>
                                {generatedQuote ? (
                                    ...
                                    <div className="text-center py-12 text-muted-foreground">
                                        ...
                                        <p>Click "Generate Quote" to create your satirical tech bro quote!</p>
                                        <p className="text-sm mt-2">Perfect for LinkedIn memes and startup parody 🚀</p>
                                    </div>
                                )}
                            </CardContent>
                        </Card>

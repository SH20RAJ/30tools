    ...
    const createZip = async () => {
        ...
        try {
            ...
            setZipFile({
                ...
                compressionRatio: ((getTotalSize() - zipBlob.size) / getTotalSize() * 100).toFixed(1)
            });
        ...
        <div className="min-h-screen bg-background">
            <div className="container mx-auto px-4 py-8 max-w-7xl">
                ...
                <div className="mb-8">
                    ...
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">Compress multiple files into a single ZIP archive</p>
                        </div>
                    </div>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                ...
                                >
                                    ...
                                    <p className="text-muted-foreground mb-4">Supports all file types</p>
                                ...
                                {files.length > 0 && (
                                    <div className="mt-4 flex justify-between items-center">
                                        <span className="text-sm text-muted-foreground">
                                            {files.length} file(s) • {formatFileSize(getTotalSize())} total
                                        </span>
                                            ...
                                            <div key={fileData.id} className="flex items-center gap-3 p-3 border rounded-lg">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <div className="text-sm text-muted-foreground">
                                                        {formatFileSize(fileData.size)} • Modified {formatDate(fileData.lastModified)}
                                                    </div>
                                                </div>
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-3">
                                    ...
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span className="font-medium">Level {settings.compressionLevel}</span>
                                    </div>
                                    {settings.passwordProtected && (
                                        <div className="flex justify-between text-sm">
                ...
                <div className="mt-16 space-y-12">
                    <section>
                        <h2 className="text-2xl font-bold mb-6">How to Create ZIP Files Online</h2>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <Card>
                                <CardContent className="p-6 text-center">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Set compression level, archive name, and optional password protection.
                                    </p>
                                </CardContent>
                            </Card>

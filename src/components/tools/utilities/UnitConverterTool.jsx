  ...
  const unitCategories = {
    ...
    area: {
      ...
      units: {
        ...
        squareKilometer: { name: 'Square Kilometer', symbol: 'km²', factor: 1000000, category: 'Metric' },
        squareCentimeter: { name: 'Square Centimeter', symbol: 'cm²', factor: 0.0001, category: 'Metric' },
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Convert between metric and imperial units instantly</p>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Convert between different units of {categoryData.name.toLowerCase()}
                </CardDescription>
              </CardHeader>
        ...
        <div className="mt-16 space-y-12">
          <section>
            <h2 className="text-2xl font-bold mb-6">Popular Unit Conversions</h2>
          ...
          <section className="bg-muted/30 p-8 rounded-lg">
            <h2 className="text-2xl font-bold mb-4">Professional Unit Converter - Free & Accurate</h2>
            <div className="prose prose-sm max-w-none text-muted-foreground">
              <p className="mb-4">
                <strong>Convert units of measurement online for free</strong> with our comprehensive unit converter. Support for length, weight, temperature, volume, area, and speed conversions between metric and imperial systems. Essential tool for students, engineers, scientists, and professionals.
              </p>
              <p className="mb-4">
                <strong>Popular conversions include:</strong> feet to meters, celsius to fahrenheit, pounds to kilograms, miles to kilometers, gallons to liters, and many more. Our converter provides high-precision results with instant calculation and easy copy functionality.
              </p>
              <p>
                <strong>Features:</strong> 20+ unit categories, metric and imperial system support, bidirectional conversion, favorites system, mobile-optimized interface, and professional-grade accuracy. Perfect for engineering calculations, cooking measurements, travel planning, and academic work.
              </p>
            </div>
          </section>
        </div>

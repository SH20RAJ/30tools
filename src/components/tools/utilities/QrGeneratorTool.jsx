    ...
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Generate high-quality QR codes instantly for URLs, text, contact information, and more. 
          Perfect for marketing, business cards, and digital sharing.
        </p>
      </div>
        ...
        <Card>
          ...
          <CardContent className="prose max-w-none">
            <p>
              ...
              and can be quickly scanned using smartphones or QR code readers. Our free QR code generator creates 
              high-quality QR codes instantly without any watermarks or limitations.
            </p>
            
            <h3>Key Features:</h3>
            <ul>
              <li><strong>Instant Generation:</strong> Create QR codes immediately without waiting</li>
              <li><strong>Multiple Sizes:</strong> Choose from 128x128 to 1024x1024 pixels</li>
              <li><strong>Error Correction:</strong> Built-in error correction for damaged codes</li>
              <li><strong>High Quality:</strong> PNG format for crisp, clear images</li>
              <li><strong>Free & Unlimited:</strong> No limits on the number of QR codes you can generate</li>
            </ul>
            ...
            <ul>
              <li><strong>Low (7%):</strong> Best for clean environments</li>
              <li><strong>Medium (15%):</strong> Standard choice for most applications</li>
              <li><strong>Quartile (25%):</strong> Good for outdoor or printed materials</li>
              <li><strong>High (30%):</strong> Maximum reliability for harsh conditions</li>
            </ul>
          </CardContent>
        </Card>
      </div>

        ...
        {generatedLink && (
          <Card className="mb-8">
            ...
            <CardContent className="space-y-4">
              ...
              {/* Test Button */}
              <div className="flex flex-col sm:flex-row gap-2">
                <Button onClick={testEmailLink} className="flex items-center gap-2">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-3">
                ...
                <div className="bg-gray-50 p-3 rounded text-sm font-mono">
                  &lt;a href="mailto:contact@company.com?subject=Website%20Inquiry"&gt;<br/>
                  &nbsp;&nbsp;Contact Us<br/>
                  &lt;/a&gt;
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-gray-50 p-3 rounded text-sm font-mono">
                  &lt;a href="mailto:support@company.com?subject=Technical%20Support"&gt;<br/>
                  &nbsp;&nbsp;Get Support<br/>
                  &lt;/a&gt;
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-gray-50 p-3 rounded text-sm font-mono">
                  &lt;a href="mailto:feedback@company.com?subject=User%20Feedback"&gt;<br/>
                  &nbsp;&nbsp;Send Feedback<br/>
                  &lt;/a&gt;
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-gray-50 p-3 rounded text-sm font-mono">
                  &lt;a href="mailto:subscribe@company.com?subject=Newsletter%20Subscription"&gt;<br/>
                  &nbsp;&nbsp;Subscribe<br/>
                  &lt;/a&gt;
                </div>
              </div>

	...
	return (
		<div className="container mx-auto px-4 py-20 text-center">
			<div className="max-w-2xl mx-auto space-y-8">
				<div className="w-20 h-20 bg-primary/10 flex items-center justify-center mx-auto mb-6 animate-pulse">
				...
				<p className="text-xl text-muted-foreground leading-relaxed">
					We're working hard to build the best{" "}
					<span className="font-semibold text-foreground">{toolName}</span> for

      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-3 mb-8">
              {footerNav.map((item) => (
                <li key={item.name}>
                  <Link href={item.href} className="text-sm text-muted-foreground hover:text-primary transition-colors no-underline">
                    {item.name}
                  </Link>
                </li>
              ))}
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="https://github.com/sh20raj/30tools" className="text-muted-foreground hover:text-primary transition-colors"><Github className="w-5 h-5" /></a>
            </div>
          </div>

          {/* Categories Column */}
          <div className="lg:col-span-3 lg:pl-8">
            <h4 className="text-sm font-bold text-foreground mb-6 uppercase tracking-wider">Tools Categories</h4>
            ...
            <h4 className="text-sm font-bold text-foreground mt-8 mb-6 uppercase tracking-wider">Resources</h4>
            <ul className="space-y-3">
              <li><Link href="/blog" className="text-sm text-muted-foreground hover:text-primary transition-colors no-underline">Blog & Guides</Link></li>
              <li><Link href="/other-tools" className="text-sm text-muted-foreground hover:text-primary transition-colors no-underline">All Platforms</Link></li>
            </ul>
          </div>

          {/* YouTube Tools Column */}
          <div className="lg:col-span-3">
            <h4 className="text-sm font-bold text-foreground mb-6 uppercase tracking-wider">Our YouTube Tools</h4>
            <ul className="space-y-3">
          ...
          <div className="lg:col-span-3">
            <h4 className="text-sm font-bold text-foreground mb-6 uppercase tracking-wider">Other Trending Tools</h4>
            <ul className="space-y-3">
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6">
            ...
            <div className="flex items-center gap-4">
              <Link href="/privacy" className="text-xs text-muted-foreground hover:text-foreground no-underline font-medium">Privacy</Link>
              <Link href="/terms" className="text-xs text-muted-foreground hover:text-foreground no-underline font-medium">Terms</Link>
            </div>
          </div>
        </div>
      </div>

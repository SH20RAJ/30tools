...
export const metadata = {
  title: "Free Code Formatter Online - Prettier JavaScript, CSS, HTML, TypeScript | 30tools",
  ...
  openGraph: {
    title: "Free Code Formatter Online - Prettier for JavaScript, CSS, HTML, TypeScript",

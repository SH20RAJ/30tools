...
export const metadata = {
  ...
  description:
    "Professional code tools for formatting, minification, and conversion. Free online code processing utilities.",
  keywords:
    "code tools, code formatter, code minifier, csv to json, free code tools online",
  openGraph: {
    title: "Code Tools - Free Online Code Processing",
    description:
      "Professional code tools for formatting, minification, and conversion.",

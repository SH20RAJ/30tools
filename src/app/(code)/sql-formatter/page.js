...
export const metadata = {
  ...
  description:
    "Format and beautify SQL queries with proper indentation and syntax highlighting. Support for MySQL, PostgreSQL, and more.",
  keywords:
    "sql formatter, sql beautifier, format sql, sql query formatter, sql editor, database query",
  openGraph: {
    title: "SQL Formatter - Format and Beautify SQL Queries | 30tools",
  ...
  twitter: {
    ...
    description:
      "Professional sql formatter tool. Free online processing with high-quality results. No registration required, instant results.",

...
export const metadata = {
  ...
  description:
    "Professional xml formatter with instant results. Free online tool for students, professionals, and businesses worldwide.",
  keywords:
    "xml formatter, xml validator, format xml, xml beautifier, xml editor, xml syntax",
  openGraph: {
    title: "XML Formatter - Format and Validate XML | 30tools",
  ...
  twitter: {
    ...
    description:
      "Professional xml formatter tool. Free online processing with high-quality results. No registration required, instant results.",

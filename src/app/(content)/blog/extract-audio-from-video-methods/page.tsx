...
export const metadata = {
	...
	description:
		"Free Extract Audio From Video Methods online tool. Fast and secure. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"extract audio from video methods, free online tool, no signup, others, extract audio from video methods online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Extract Audio From Video Methods online tool. Fast and secure.",

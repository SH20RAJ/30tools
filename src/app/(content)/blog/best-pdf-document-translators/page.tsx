	...
	return (
		<div className="container mx-auto px-4 py-8 md:py-16 max-w-4xl">
			...
			<article className="prose prose-lg dark:prose-invert max-w-none">
				...
				<p className="lead">
					Translating PDFs while keeping the layout intact is notoriously
					difficult. These 4 tools handle the job perfectly.
				</p>

				<h2>1. Google Translate Documents</h2>
				<p>
					Free and fast, supports many languages, though layout retention
					varies.
				</p>
				...
				<p>
					A specialized tool that preserves the original layout of the document.
				</p>

...
export const metadata = {
	...
	description:
		"Free Y2mate Youtube To Mp3 Converter online tool. Fast and secure. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"y2mate youtube to mp3 converter, free online tool, no signup, others, y2mate youtube to mp3 converter online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Y2mate Youtube To Mp3 Converter online tool. Fast and secure.",

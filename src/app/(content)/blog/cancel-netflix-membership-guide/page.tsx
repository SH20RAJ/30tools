...
export const metadata = {
	...
	description:
		"Free Cancel Netflix Membership Guide online tool. Fast and secure. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"cancel netflix membership guide, free online tool, no signup, others, cancel netflix membership guide online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Cancel Netflix Membership Guide online tool. Fast and secure.",

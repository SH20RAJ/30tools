...
export const metadata = {
	...
	description:
		"Free How To Download Instagram Reels online tool. Fast and secure. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"how to download instagram reels, free online tool, no signup, others, how to download instagram reels online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free How To Download Instagram Reels online tool. Fast and secure.",

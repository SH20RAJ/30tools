...
export const metadata = {
  ...
  description: "Free Make Your Own Terabox Video Player online tool. Fast and secure. 100% free, no signup required, and privacy-focused processing in your browser.",
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Make Your Own Terabox Video Player","description":"Free Make Your Own Terabox Video Player online tool. Fast and secure.","url":"https://30tools.com/blog/make-your-own-terabox-video-player","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

...
export const metadata = {
  ...
  description: "Free AkilliTv Video Downloader. Download videos from multiple platforms. HD quality, no watermarks, instant downloads. All processing happens locally in your br",
  keywords: ["akillitv video downloader","akillitv video downloader free","akillitv video downloader online","akillitv video downloader tool"],
  robots: {
    index: true,
    follow: true,
    googleBot: {

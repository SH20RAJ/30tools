...
export const metadata = {
	...
	description:
		"Download Bandcamp tracks and albums to MP3 for free. Save independent artists' music from Bandcamp without buying. Works on any device, no login required.",
	keywords: [
		"bandcamp downloader",
		"bandcamp to mp3",
		"download bandcamp music free",
		"save bandcamp track",
		"bandcamp album download",
		"bandcamp music saver",
		"how to download bandcamp songs",
		"bandcamp free download",
		"bandcamp song downloader",
		"bandcamp mp3 download",
	].join(", "),
	openGraph: {
		title: "Bandcamp Downloader - Save Indie Music to MP3 Free",
		description:
			"⚡ Download Bandcamp tracks and albums as MP3. Support indie artists, save music offline.",
	...
	twitter: {
		...
		description:
			"⚡ Download Bandcamp music as MP3. Works for free & paid tracks offered by artists.",

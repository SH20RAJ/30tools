...
export const metadata = {
  ...
  description: "Free Bandcamp Video Downloader. Download videos from multiple platforms. HD quality, no watermarks, instant downloads. All processing happens locally in your br",
  keywords: ["bandcamp video downloader","bandcamp video downloader free","bandcamp video downloader online","bandcamp video downloader tool"],
  robots: {
    index: true,
    follow: true,
    googleBot: {

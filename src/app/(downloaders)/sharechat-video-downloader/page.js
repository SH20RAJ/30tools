...
export const metadata = {
	...
	description:
		"Free ShareChat Video Downloader. Download videos from multiple platforms. HD quality, no watermarks, instant downloads. All processing happens locally in your b",
	keywords: [
		"sharechat video downloader",
		"sharechat video downloader free",
		"sharechat video downloader online",
		"sharechat video downloader tool",
	],
	robots: {
		index: true,
		follow: true,

...
export const metadata = {
	...
	description:
		"Free Bitchute Video Downloader. Download videos from multiple platforms. HD quality, no watermarks, instant downloads. All processing happens locally in your br",
	keywords: [
		"bitchute video downloader",
		"bitchute video downloader free",
		"bitchute video downloader online",
		"bitchute video downloader tool",
	],
	robots: {
		index: true,
		follow: true,

...
export const metadata = {
  ...
  description: "Free Febspot Video Downloader. Download videos from multiple platforms. HD quality, no watermarks, instant downloads. All processing happens locally in your bro",
  keywords: ["febspot video downloader","febspot video downloader free","febspot video downloader online","febspot video downloader tool"],
  robots: {
    index: true,
    follow: true,
    googleBot: {

...
export const metadata = {
	...
	description:
		"Download FEBspot videos for free. Save any FEBspot content as MP4 offline. No login required. Fast, free, and works on all devices instantly.",
	keywords: [
		"febspot video downloader",
		"download febspot video",
		"febspot downloader",
		"save febspot video",
		"febspot to mp4",
		"febspot download free",
	].join(", "),
	openGraph: {
		title: "FEBspot Video Downloader - Save Videos Free",
		description:
			"⚡ Download FEBspot videos as MP4 for free. Instant, no login, no watermarks.",

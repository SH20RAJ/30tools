...
export const metadata = {
  ...
  description: "Free Vkontakte Video Downloader. Download videos from multiple platforms. HD quality, no watermarks, instant downloads. All processing happens locally in your b",
  keywords: ["vkontakte video downloader","vkontakte video downloader free","vkontakte video downloader online","vkontakte video downloader tool"],
  robots: {
    index: true,
    follow: true,
    googleBot: {

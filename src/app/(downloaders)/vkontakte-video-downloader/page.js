...
export const metadata = {
	...
	description:
		"Download VK (VKontakte) videos in HD for free. The best online VK video downloader. Save VK videos as MP4. Works on all devices without login.",
	keywords: [
		"vk video downloader",
		...
		"save vk video",
		"vk to mp4",
		"vk video download free",
		"vkontakte downloader",
		"vk video saver",
		"how to download vk videos",
		"vk download without login",
		"download vkontakte hd",
	].join(", "),
	openGraph: {
		title: "VK Video Downloader - Save VKontakte Videos HD Free",
		description:
			"⚡ Download VK (VKontakte) videos in HD MP4 for free. No login required.",
	...
	twitter: {
		...
		description:
			"⚡ Save VKontakte videos offline in HD. No login, no watermarks, completely free.",

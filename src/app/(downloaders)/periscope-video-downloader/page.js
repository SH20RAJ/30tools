...
export const metadata = {
  ...
  description: "Free Periscope Video Downloader. Download videos from multiple platforms. HD quality, no watermarks, instant downloads. All processing happens locally in your b",
  keywords: ["periscope video downloader","periscope video downloader free","periscope video downloader online","periscope video downloader tool"],
  robots: {
    index: true,
    follow: true,
    googleBot: {

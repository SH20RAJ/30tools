...
export const metadata = {
	title:
		"Periscope Video Downloader - Save Periscope Broadcasts Free | 30tools",
	description:
		"Download Periscope live broadcast recordings and videos for free. Save Periscope streams as MP4 before they expire forever. No login required. Works on all devices.",
	keywords: [
		"periscope video downloader",
		"download periscope video",
		"save periscope broadcast",
		"periscope to mp4",
		"periscope stream download",
		"periscope recording saver",
		"how to download periscope videos",
		"periscope live save before expiry",
	].join(", "),
	openGraph: {
		title: "Periscope Video Downloader - Save Broadcasts Before They Expire",
		description:
			"⚡ Download Periscope live broadcast recordings as MP4 before they expire. Free, instant.",
	...
	twitter: {
		...
		description:
			"⚡ Save Periscope broadcast recordings before they expire. Free, no login.",

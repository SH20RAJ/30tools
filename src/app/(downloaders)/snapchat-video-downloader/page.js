...
export const metadata = {
  ...
  description: "Free Snapchat Video Downloader. Download videos from multiple platforms. HD quality, no watermarks, instant downloads. All processing happens locally in your br",
  keywords: ["snapchat video downloader","snapchat video downloader free","snapchat video downloader online","snapchat video downloader tool"],
  robots: {
    index: true,
    follow: true,
    googleBot: {

                    ...
                    <div className="mt-12 space-y-8">
                        ...
                        <div className="bg-card rounded-lg p-6 border">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div>
                                    <h3 className="font-medium mb-2 text-yellow-600">📱 All Snapchat Content</h3>
                                    ...
                                    <h3 className="font-medium mb-2 text-yellow-600">⚡ Lightning Fast Processing</h3>
                                ...
                                <div>
                                    <h3 className="font-medium mb-2 text-yellow-600">🔐 Anonymous & Safe</h3>
                                    ...
                                    <h3 className="font-medium mb-2 text-yellow-600">📱 Mobile Optimized</h3>

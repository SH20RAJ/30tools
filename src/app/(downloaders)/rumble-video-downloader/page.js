...
export const metadata = {
  ...
  description: "Free Rumble Video Downloader. Download videos from multiple platforms. HD quality, no watermarks, instant downloads. All processing happens locally in your brow",
  keywords: ["rumble video downloader","rumble video downloader free","rumble video downloader online","rumble video downloader tool"],
  robots: {
    index: true,
    follow: true,
    googleBot: {

...
export const metadata = {
	...
	description:
		"Download Rumble videos in 4K, HD 1080p, and MP4 for free. The best online Rumble video downloader. Save Rumble clips offline. No login or software needed.",
	keywords: [
		"rumble video downloader",
		"download rumble videos",
		"rumble to mp4",
		"save rumble video",
		"rumble video download free",
		"rumble hd download",
		"rumble 4k downloader",
		"how to download rumble videos",
		"rumble clip downloader",
		"rumble video saver",
		"rumble downloader online",
		"save rumble clips offline",
		"rumble video grabber",
	].join(", "),
	openGraph: {
		title: "Rumble Video Downloader - Save Videos in 4K & HD Free",
		description:
			"⚡ Download Rumble videos in 4K, 1080p HD, or MP4 for free. No login, instant, no watermarks.",
	...
	twitter: {
		...
		description:
			"⚡ Save Rumble videos offline in HD MP4. Fast, free, no account needed.",

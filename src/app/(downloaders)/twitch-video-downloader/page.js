...
export const metadata = {
  ...
  description: "Free Twitch Video Downloader. Download videos from multiple platforms. HD quality, no watermarks, instant downloads. All processing happens locally in your brow",
  keywords: ["twitch video downloader","twitch video downloader free","twitch video downloader online","twitch video downloader tool"],
  robots: {
    index: true,
    follow: true,
    googleBot: {

...
export const metadata = {
  ...
  description: "Free Imgur Video Downloader. Download videos from multiple platforms. HD quality, no watermarks, instant downloads. All processing happens locally in your brows",
  keywords: ["imgur video downloader","imgur video downloader free","imgur video downloader online","imgur video downloader tool"],
  robots: {
    index: true,
    follow: true,
    googleBot: {

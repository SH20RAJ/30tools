...
export const metadata = {
  ...
  description: "Free Dailymotion Video Downloader. Download videos from multiple platforms. HD quality, no watermarks, instant downloads. All processing happens locally in your",
  keywords: ["dailymotion video downloader","dailymotion video downloader free","dailymotion video downloader online","dailymotion video downloader tool"],
  robots: {
    index: true,
    follow: true,
    googleBot: {

...
export const metadata = {
	...
	description:
		"Free Kickstarter Video Downloader. Download videos from multiple platforms. HD quality, no watermarks, instant downloads. All processing happens locally in your",
	keywords: [
		"kickstarter video downloader",
		"kickstarter video downloader free",
		"kickstarter video downloader online",
		"kickstarter video downloader tool",
	],
	robots: {
		index: true,
		follow: true,

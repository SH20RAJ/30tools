...
export const metadata = {
  ...
  description: "Free NineGag Video Downloader. Download videos from multiple platforms. HD quality, no watermarks, instant downloads. All processing happens locally in your bro",
  keywords: ["ninegag video downloader","ninegag video downloader free","ninegag video downloader online","ninegag video downloader tool"],
  robots: {
    index: true,
    follow: true,
    googleBot: {

...
export const metadata = {
  ...
  description: "Free MxTakatak Video Downloader. Download videos from multiple platforms. HD quality, no watermarks, instant downloads. All processing happens locally in your b",
  keywords: ["mxtakatak video downloader","mxtakatak video downloader free","mxtakatak video downloader online","mxtakatak video downloader tool"],
  robots: {
    index: true,
    follow: true,
    googleBot: {
...
export default async function MxtakatakVideoDownloaderPage({ searchParams }) {

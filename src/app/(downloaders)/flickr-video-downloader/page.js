...
export const metadata = {
	...
	description:
		"Free Flickr Video Downloader. Download videos from multiple platforms. HD quality, no watermarks, instant downloads. All processing happens locally in your brow",
	keywords: [
		"flickr video downloader",
		"flickr video downloader free",
		"flickr video downloader online",
		"flickr video downloader tool",
	],
	robots: {
		index: true,
		follow: true,

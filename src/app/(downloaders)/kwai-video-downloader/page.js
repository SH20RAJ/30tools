...
export const metadata = {
	...
	description:
		"Free Kwai Video Downloader. Download videos from multiple platforms. HD quality, no watermarks, instant downloads. All processing happens locally in your browse",
	keywords: [
		"kwai video downloader",
		"kwai video downloader free",
		"kwai video downloader online",
		"kwai video downloader tool",
	],
	robots: {
		index: true,
		follow: true,

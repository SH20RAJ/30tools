...
export const metadata = {
	...
	description:
		"Free Gaana Video Downloader. Download videos from multiple platforms. HD quality, no watermarks, instant downloads. All processing happens locally in your brows",
	keywords: [
		"gaana video downloader",
		"gaana video downloader free",
		"gaana video downloader online",
		"gaana video downloader tool",
	],
	robots: {
		index: true,
		follow: true,

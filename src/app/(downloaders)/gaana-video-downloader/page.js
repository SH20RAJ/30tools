...
export const metadata = {
	...
	description:
		"Download Gaana songs and music to MP3 for free. Save any Gaana track offline without a Gaana Plus subscription. Works on Android, iPhone, and PC.",
	keywords: [
		"gaana downloader",
		"gaana song download",
		"gaana to mp3",
		"download gaana music free",
		"gaana music downloader",
		"save gaana songs",
		"gaana offline download free",
		"how to download gaana songs",
		"gaana song saver",
		"gaana download without subscription",
	].join(", "),
	openGraph: {
		title: "Gaana Downloader - Save Songs to MP3 Free",
		description:
			"⚡ Download Gaana songs as MP3 for free. No Gaana Plus subscription required.",
	...
	twitter: {
		...
		description:
			"⚡ Save Gaana music offline as MP3. No login, no subscription needed.",

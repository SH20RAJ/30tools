...
export const metadata = {
  ...
  description: "Free Izlesene Video Downloader. Download videos from multiple platforms. HD quality, no watermarks, instant downloads. All processing happens locally in your br",
  keywords: ["izlesene video downloader","izlesene video downloader free","izlesene video downloader online","izlesene video downloader tool"],
  robots: {
    index: true,
    follow: true,
    googleBot: {

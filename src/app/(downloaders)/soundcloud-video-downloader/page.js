...
export const metadata = {
	...
	description:
		"Download SoundCloud tracks as MP3 for free. The fastest online SoundCloud to MP3 converter. Save any SoundCloud song offline with one click. No login required.",
	keywords: [
		"soundcloud downloader",
		"soundcloud to mp3",
		"download soundcloud music",
		"soundcloud mp3 downloader",
		"save soundcloud tracks",
		"soundcloud song downloader",
		"soundcloud music download free",
		"soundcloud offline download",
		"soundcloud to mp3 converter online",
		"download soundcloud playlist",
		"soundcloud track saver",
		"free soundcloud downloader",
	].join(", "),
	openGraph: {
		title: "SoundCloud Downloader - Save Songs to MP3 Free",
		description:
			"⚡ Convert and download any SoundCloud track to MP3 instantly. Free, no login, no app needed.",
	...
	twitter: {
		...
		description:
			"⚡ Download any SoundCloud track to MP3. Free online converter, no registration.",

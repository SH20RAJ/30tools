...
export const metadata = {
	...
	description:
		"Free Soundcloud Video Downloader. Download videos from multiple platforms. HD quality, no watermarks, instant downloads. All processing happens locally in your ",
	keywords: [
		"soundcloud video downloader",
		"soundcloud video downloader free",
		"soundcloud video downloader online",
		"soundcloud video downloader tool",
	],
	robots: {
		index: true,
		follow: true,

...
export const metadata = {
	...
	description:
		"Free Chingari Video Downloader. Download videos from multiple platforms. HD quality, no watermarks, instant downloads. All processing happens locally in your br",
	keywords: [
		"chingari video downloader",
		"chingari video downloader free",
		"chingari video downloader online",
		"chingari video downloader tool",
	],
	robots: {
		index: true,
		follow: true,

...
export const metadata = {
	...
	keywords:
		"linkedin video downloader, free online tool, no signup, downloaders, linkedin video downloader online, 30tools",
	alternates: {
	...
	openGraph: {
		...
		siteName: "30tools",
		images: [{ url: "/api/og?title=Free%20Linkedin%20Video%20Downloader%20Online%20-%20No%20Signup" }],
		type: "website",
	},
	twitter: {
		...
		description:
			"Download LinkedIn videos in high quality—free and easy. Our LinkedIn Video Downloader works with any public post link. Just copy the LinkedIn video URL, paste it, and download in seconds. No signup, no clutter, and no confusing steps—just fast processing and a clean, simple interface that helps you save videos quickly. 100% free, no signup required, and privacy-focused processing in your browser.",
		images: ["/api/og?title=Free%20Linkedin%20Video%20Downloader%20Online%20-%20No%20Signup"],
	},
...
export default async function ToolPage() {
	const tool = {
		...
		extraSlugs: ["save-linkedin-video-online-free", "linkedin-video-grabber"],
		popular: false,

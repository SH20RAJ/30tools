...
export const metadata = {
  title: "YouTube Video Downloader - Free Online Tool | 30tools",
  ...
  keywords: [
    ...
    "download youtube video video",
    "save youtube video media",
    "free online youtube video downloader",
    "download videos free"
  ].join(", "),
  openGraph: {
    title: "YouTube Video Downloader (2026) - Free Downloader",
    description: "⚡ Download YouTube videos quickly in multiple formats and resolutions—free, fast, secure, no signup, and fully browser-based.",
...
const jsonLdSchemas = {
  webApp: {
    ...
    "alternateName": ["30tools YouTube Video Downloader", "Free Downloader"],
    "description": "Download YouTube videos quickly in multiple formats and resolutions—free, fast, secure, no signup, and fully browser-based.",
    "url": "https://30tools.com/youtube-video-downloader",
      ...
      <div className="container mx-auto px-4 py-12 md:py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <section className="mb-16 prose prose-slate dark:prose-invert max-w-none">
            <h2 className="text-3xl font-bold mb-6">Why You Should Use Our YouTube Video Downloader</h2>
            <p className="text-muted-foreground mb-8">
              Why choose our YouTube Video Downloader? 30tools offers an ad-free, secure, and lightning-fast downloading experience. Download YouTube videos quickly in multiple formats and resolutions—free, fast, secure, no signup, and fully browser-based. Access your favorite YouTube media instantly on any device.
            </p>

...
export const metadata = {
	...
	description:
		"Download videos from any website for free with our online video downloader. Supports YouTube, TikTok, Instagram, Facebook, Twitter and 1000+ sites. HD quality, MP4/MP3 formats, no watermarks, no signup. Try now!",
	keywords: [
		...
		faqs: [
			{
				...
				answer:
					"An online video downloader is a web-based tool that extracts video files from various video-sharing platforms like YouTube, TikTok, Instagram, Facebook, and Twitter. It fetches the direct video URL and lets you download the file to your device in various formats and qualities.",
			},
			{
				question: "Is this online video downloader really free?",
				answer:
					"Yes! 30Tools provides a completely free video downloader with no hidden costs, subscriptions, or usage limits. Download unlimited videos from supported sites without creating an account. 100% free forever.",
			},
			{
				question: "How do I download a video from any website?",
				answer:
					"1. Copy the video URL from your browser's address bar or share button. 2. Paste the link into our downloader input field. 3. Our tool detects available formats and qualities. 4. Select your preferred format (MP4, MP3, etc.) and quality (HD, 4K). 5. Click download to save the file.",
			},
			{
				question: "Which websites are supported?",
				answer:
					"We support 1000+ video platforms including YouTube, TikTok, Instagram, Facebook, Twitter/X, Vimeo, Dailymotion, Twitch, Rumble, Pinterest, and many more. Our tool automatically detects if a site is supported when you paste the URL.",
			},
			{
				question: "What video quality and formats are available?",
				answer:
					"Available qualities depend on the source platform: up to 4K Ultra HD, 1080p Full HD, 720p, 480p, etc. Formats include MP4 (video), MP3 (audio-only), WEBM, MOV, and more. We offer the best available quality for that source video.",
			},
			{
				question: "Can I download YouTube videos as MP3?",
				answer:
					"Yes! When downloading from YouTube or similar platforms, you can choose MP3 audio-only format. This extracts the audio track and saves it as a high-quality MP3 file perfect for music or podcasts.",
			},
			{
				question: "Is it legal to download videos from these platforms?",
				answer:
					"Downloading videos for personal offline use is generally acceptable. However, redistributing, reuploading, or using downloaded content commercially without permission violates copyright laws and platform terms of service. Always respect creators' rights.",
			},
			{
				question: "Are there any usage limits or daily caps?",
				answer:
					"None whatsoever. Download as many videos as you want, whenever you want. We don't track your usage or impose artificial limits. Our service is truly unlimited and free.",
			},
			{
				question: "Is my data secure when using this downloader?",
				answer:
					"Absolutely. The entire process runs in your browser. We do not store the URLs you submit, the videos you download, or any personal data. Your download activities remain completely private and secure.",
			},
			{
				question: "Why can't I download a certain video?",
				answer:
					"Some videos cannot be downloaded due to: platform restrictions (e.g., age-restricted, private, or deleted videos), DRM protection (Netflix, Amazon Prime), geographic restrictions, or the platform simply not being supported yet. We constantly expand our supported sites.",
			},
			{
				question: "What if the video is age-restricted or private?",
				answer:
					"Age-restricted or private videos require authentication and cannot be accessed by our tool due to privacy and legal restrictions. Only publicly available videos can be downloaded.",
			},
			{
				question: "Can I download entire playlists or channels?",
				answer:
					"Our current version downloads individual videos. For bulk downloads of playlists or channels, you can paste each video URL sequentially. Batch download capabilities for full playlists may be available in the future.",
			},
			{
				question: "Do downloaded videos contain watermarks?",
				answer:
					"No. We fetch the direct source video file without any overlays or branding. Some platforms may already embed watermarks in their source files (e.g., TikTok), which we cannot remove, but we don't add our own.",
			},
			{
				question: "What devices and browsers are supported?",
				answer:
					"Our tool works on any modern browser (Chrome, Firefox, Safari, Edge) across Windows, macOS, Linux, Android, and iOS. The responsive design ensures a great experience on desktop, tablet, and mobile.",
			},
			{
				question: "How fast are the downloads?",
				answer:
					"Download speed depends on your internet connection and the source platform's server speed. Our extraction process is instant, but actual file download speed is determined by your network. We don't throttle or limit speeds.",
			},
		],
		howTo: {

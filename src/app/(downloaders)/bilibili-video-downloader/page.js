...
export const metadata = {
	...
	description:
		"Download Bilibili videos in 4K, 1080p, and 720p for free. Best online Bilibili downloader. Save anime, tutorials, and entertainment videos from Bilibili. No account needed.",
	keywords: [
		"bilibili video downloader",
		"download bilibili videos",
		"bilibili to mp4",
		"save bilibili video",
		"bilibili downloader online",
		"bilibili 4k downloader",
		"bilibili 1080p download",
		"how to download bilibili videos",
		"bilibili anime downloader",
		"bilibili video saver",
		"free bilibili downloader",
		"bilibili without watermark",
		"bilibili subtitle download",
	].join(", "),
	openGraph: {
		title: "Bilibili Video Downloader - Save Videos in 4K & 1080p Free",
		description:
			"⚡ Download Bilibili videos in 4K, 1080p HD as MP4. Free, no account needed, instant.",
	...
	twitter: {
		...
		description:
			"⚡ Save Bilibili anime and videos in 4K or HD. Free, no login needed.",

...
export const metadata = {
	...
	description:
		"Free Bilibili Video Downloader. Download videos from multiple platforms. HD quality, no watermarks, instant downloads. All processing happens locally in your br",
	keywords: [
		"bilibili video downloader",
		"bilibili video downloader free",
		"bilibili video downloader online",
		"bilibili video downloader tool",
	],
	robots: {
		index: true,
		follow: true,

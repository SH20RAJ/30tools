...
export const metadata = {
  ...
  description: "Download m3u8 playlists and convert them to high-quality MP4 videos. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "m3u8 downloader, free online tool, no signup, downloaders, m3u8 downloader online, 30tools",
  alternates: {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"M3U8 Downloader","description":"Download m3u8 playlists and convert them to high-quality MP4 videos.","url":"https://30tools.com/m3u8-downloader","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

...
export const metadata = {
	...
	description:
		"Free Blogger Video Downloader. Download videos from multiple platforms. HD quality, no watermarks, instant downloads. All processing happens locally in your bro",
	keywords: [
		"blogger video downloader",
		"blogger video downloader free",
		"blogger video downloader online",
		"blogger video downloader tool",
	],
	robots: {
		index: true,
		follow: true,

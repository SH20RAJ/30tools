...
export const metadata = {
	...
	description:
		"Free Imdb Video Downloader. Download videos from multiple platforms. HD quality, no watermarks, instant downloads. All processing happens locally in your browse",
	keywords: [
		"imdb video downloader",
		"imdb video downloader free",
		"imdb video downloader online",
		"imdb video downloader tool",
	],
	robots: {
		index: true,
		follow: true,

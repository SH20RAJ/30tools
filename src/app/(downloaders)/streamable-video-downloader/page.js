...
export const metadata = {
  ...
  description: "Free Streamable Video Downloader. Download videos from multiple platforms. HD quality, no watermarks, instant downloads. All processing happens locally in your ",
  keywords: ["streamable video downloader","streamable video downloader free","streamable video downloader online","streamable video downloader tool"],
  robots: {
    index: true,
    follow: true,
    googleBot: {

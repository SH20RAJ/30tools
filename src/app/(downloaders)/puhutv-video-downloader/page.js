...
export const metadata = {
  ...
  description: "Free PuhuTv Video Downloader. Download videos from multiple platforms. HD quality, no watermarks, instant downloads. All processing happens locally in your brow",
  keywords: ["puhutv video downloader","puhutv video downloader free","puhutv video downloader online","puhutv video downloader tool"],
  robots: {
    index: true,
    follow: true,
    googleBot: {

...
export const metadata = {
  ...
  description:
    "Free tip calculator to calculate tips for restaurants, delivery, and services. Split bills among multiple people and calculate individual amounts instantly.",
  keywords: [
  ...
  openGraph: {
    title: "Tip Calculator - Free Online Calculator | Instant Results",
    description:
      "Free tip calculator with instant accurate results. Process online calculator for students, professionals & everyone. Easy to use, mobile-friendly interface.",
    url: "https://30tools.com/tip-calculator",
    siteName: "30tools",
    images: [
      {
        url: "/og-images/tip-calculator.jpg",
        width: 1200,
        height: 630,
...
const jsonLd = {
  ...
  name: "Tip Calculator",
  description:
    "Free online tip calculator to calculate tips for restaurants and services, split bills among multiple people",
  url: "https://30tools.com/tip-calculator",
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1 mb-4">
                    <li>
                      • <strong>Excellent service:</strong> 20-25%
                    </li>
                    <li>
                      • <strong>Good service:</strong> 18-20%
                    </li>
                    <li>
                      • <strong>Average service:</strong> 15-18%
                    </li>
                    <li>
                      • <strong>Poor service:</strong> 10-15%
                    </li>
                    <li>
                      • <strong>Takeout:</strong> 10-15%
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1 mb-4">
                    <li>
                      • <strong>Taxi/Uber:</strong> 15-20%
                    </li>
                    <li>
                      • <strong>Hair salon:</strong> 15-20%
                    </li>
                    <li>
                      • <strong>Delivery:</strong> 15-20%
                    </li>
                    <li>
                      • <strong>Hotel housekeeping:</strong> $2-5 per day
                    </li>
                    <li>
                      • <strong>Bartender:</strong> $1-2 per drink
                    </li>
                  </ul>
                </div>
              </div>

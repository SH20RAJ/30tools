...
export const metadata = {
  ...
  description:
    "Free calculators with instant accurate results. Process online calculator for students, professionals & everyone. Easy to use, mobile-friendly interface.",
  keywords: [
...
const jsonLd = {
  ...
  description:
    "Collection of 25+ free online calculators for math, finance, health, and everyday calculations",
  url: "https://30tools.com/calculators",
  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        description:
          "Calculate loan payments for personal, auto, and business loans",
      },
      {
  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        description: "Calculate body fat percentage using measurements",
      },
      {
  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        description: "Convert meters, feet, inches, and other length units",
      },
      {
        name: "Weight Converter",
        href: "/weight-converter",
        description: "Convert kilograms, pounds, ounces, and other weights",
      },
    ],
  },
  {
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground mb-6">
              Access 25+ professional calculators for math, finance, health, and
            ...
            <div className="flex flex-wrap justify-center gap-4 text-sm text-muted-foreground">
              ...
              <span className="bg-muted text-primary px-3 py-1 rounded-full">
                ✓ Mobile Friendly
              </span>
            </div>
          </div>
          ...
          <div className="mt-16 bg-card rounded-lg p-8 border">
            <h2 className="text-2xl font-semibold mb-4">
              Why Use Our Online Calculators?
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Get instant, precise calculations with our professionally
                  designed calculators. No waiting, no errors, just reliable
                  results every time.
                </p>
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  All calculators work perfectly on desktop, tablet, and mobile
                  devices. Calculate anywhere, anytime with responsive design.
                </p>
              </div>
              <div>
                <h3 className="font-medium mb-2 text-primary">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  All calculations are performed locally in your browser. We
                  never store or transmit your data, ensuring complete privacy
                  and security.
                </p>
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  No hidden fees, no registration required, no limits. Use all
                  our calculators completely free forever.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="text-center p-4">
                ...
                <p className="text-xs text-muted-foreground">
                  Basic, scientific, percentage, fraction calculators
                </p>
              </div>
              <div className="text-center p-4">
                <div className="text-2xl mb-2">💰</div>
                ...
                <p className="text-xs text-muted-foreground">
                  Mortgage, loan, investment, retirement calculators
                </p>
              </div>
              <div className="text-center p-4">
                <div className="text-2xl mb-2">🏥</div>
                ...
                <p className="text-xs text-muted-foreground">
                  BMI, calorie, age, pregnancy calculators
                </p>
              </div>
              <div className="text-center p-4">
                <div className="text-2xl mb-2">🔄</div>
                ...
                <p className="text-xs text-muted-foreground">
                  Unit, currency, temperature converters
                </p>
              </div>
            </div>
          </div>

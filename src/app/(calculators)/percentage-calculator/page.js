...
export const metadata = {
  ...
  description:
    "Free percentage calculator to find percentages, increases, decreases, and changes. Calculate discounts and percentages instantly.",
  keywords: [
  ...
  openGraph: {
    title: "Percentage Calculator - Free Online Calculator | Instant Results",
    description:
      "Free percentage calculator tool with professional results. No registration required, instant processing, secure & unlimited use.",
...
const jsonLd = {
  ...
  description:
    "Free online percentage calculator to calculate percentages, percentage increase/decrease, and percentage change",
  url: "https://30tools.com/percentage-calculator",
            ...
            <div className="bg-card rounded-lg p-6 border">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-2">
                    Calculate percentage decrease from old to new value
                  </p>
                  <p className="text-xs text-muted-foreground mb-4">
                  ...
                  <p className="text-xs text-muted-foreground mb-4">
                    Example: What % is 25 of 100? Answer: 25%
                  </p>
                </div>
              </div>
            </div>

...
export const metadata = {
  ...
  description:
    "Free bmi calculator with instant accurate results. Process online calculator for students, professionals & everyone. Easy to use, mobile-friendly interface.",
  keywords: [
...
const jsonLd = {
  ...
  name: "BMI Calculator",
  description:
    "Free online BMI calculator to calculate Body Mass Index and assess health status",
  url: "https://30tools.com/bmi-calculator",
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <ul className="text-sm text-muted-foreground space-y-2">
                    <li>
                      • <strong>Underweight:</strong> May indicate malnutrition
                      or health issues
                    </li>
                    <li>
                      • <strong>Normal:</strong> Associated with lowest health
                      risks
                    </li>
                    <li>
                      • <strong>Overweight:</strong> Increased risk of health
                      problems
                    </li>
                    <li>
                      • <strong>Obese:</strong> High risk of serious health
                      conditions
                    </li>
                  </ul>
                </div>

...
export const metadata = {
  ...
  description:
    "Free basic calculator for simple arithmetic operations. Add, subtract, multiply, divide with instant results. Large buttons, easy to use on desktop and mobile.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Free basic calculator with instant accurate results. Process online calculator for students, professionals & everyone. Easy to use, mobile-friendly interface.",
...
const jsonLd = {
  ...
  description:
    "Free online basic calculator for simple arithmetic operations with large buttons and instant results",
  url: "https://30tools.com/basic-calculator",
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1 mb-4">
                    <li>
                      • <strong>Addition (+):</strong> Add two or more numbers
                    </li>
                    <li>
                      • <strong>Subtraction (-):</strong> Subtract one number
                      from another
                    </li>
                    <li>
                      • <strong>Multiplication (×):</strong> Multiply numbers
                      together
                    </li>
                    <li>
                      • <strong>Division (÷):</strong> Divide one number by
                      another
                    </li>
                    <li>
                      • <strong>Equals (=):</strong> Calculate and display
                      result
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1 mb-4">
                    <li>
                      • <strong>Percentage (%):</strong> Calculate percentages
                    </li>
                    <li>
                      • <strong>Square Root (√):</strong> Find square root of
                      numbers
                    </li>
                    <li>
                      • <strong>Clear (C):</strong> Clear current entry
                    </li>
                    <li>
                      • <strong>All Clear (AC):</strong> Clear all calculations
                    </li>
                    <li>
                      • <strong>Memory:</strong> Store and recall numbers
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="bg-card rounded-lg p-6 border">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Press equals (=) to calculate and display the result
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-card rounded-lg p-6 border">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1 mb-4">
                    <li>
                      • <strong>0-9:</strong> Enter numbers
                    </li>
                    <li>
                      • <strong>. (period):</strong> Decimal point
                    </li>
                    <li>
                      • <strong>Enter:</strong> Calculate result
                    </li>
                    <li>
                ...
                <div>
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1 mb-4">
                    <li>
                      • <strong>+ (plus):</strong> Addition
                    </li>
                    <li>
                      • <strong>- (minus):</strong> Subtraction
                    </li>
                    <li>
                      • <strong>* (asterisk):</strong> Multiplication
                    </li>
                    <li>
                      • <strong>/ (slash):</strong> Division
                    </li>
                  </ul>
                </div>
              </div>

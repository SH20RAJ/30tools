...
export const metadata = {
  ...
  description:
    "Collection of free online calculators for math, finance, health, and everyday calculations. No registration required, instant results.",
  keywords:
    "online calculators, free calculators, math calculator, finance calculator, health calculator, percentage calculator, mortgage calculator, bmi calculator",
  openGraph: {
    title: "Calculator Tools - Free Online Calculators",
    description:
      "Collection of free online calculators for math, finance, health, and everyday calculations.",

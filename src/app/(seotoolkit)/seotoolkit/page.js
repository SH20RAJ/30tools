...
export const metadata = {
	...
	description:
		"Professional SEO toolkit with 27+ analysis tools. Free online site audit, keyword tracking, backlink monitoring, and more.",
	keywords: [
		"seo toolkit",
		"all in one seo tool",
	...
	openGraph: {
		...
		description:
			"Professional seotoolkit tool. Free online processing with high-quality results. No registration required, instant results.",

...
export const metadata = {
  ...
  keywords:
    "css box shadow, box shadow generator, css shadow, shadow effects, css generator, web design",
  openGraph: {
    title: "CSS Box Shadow Generator - Create CSS Shadows | 30tools",
  ...
  twitter: {
    ...
    description:
      "Professional css box shadow tool. Free online processing with high-quality results. No registration required, instant results.",

...
export const metadata = {
  ...
  keywords:
    "color palette generator, color scheme generator, color harmony, extract colors from image, css color palette, design colors, color picker, website color palette",
  openGraph: {
    title: "Color Palette Generator - Create Beautiful Color Schemes",
    description:
      "Generate beautiful color palettes instantly. Create harmonious color schemes and extract colors from images.",
  ...
  twitter: {
    ...
    title: "Color Palette Generator - Create Beautiful Color Schemes",
    description:
      "Generate beautiful color palettes instantly. Perfect for designers and developers.",

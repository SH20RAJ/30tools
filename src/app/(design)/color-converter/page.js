...
export const metadata = {
  ...
  description:
    "Convert Process instantly with our free color converter. High-quality conversion with privacy protection. No registration required, unlimited use.",
  keywords:
    "color converter, hex to rgb, rgb to hsl, color format converter, hex color converter, css color converter",
  openGraph: {
    title: "Color Converter - HEX, RGB, HSL Converter | 30tools",
    description:

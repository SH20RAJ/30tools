...
export const metadata = {
	...
	description:
		"Free Title Tag Preview online. Title Tag Preview allows you to download YouTube content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"title tag preview, free online tool, no signup, youtube, title tag preview online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Title Tag Preview online. Title Tag Preview allows you to download YouTube content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/title-tag-preview",
		extraSlugs: ["title-tag-preview"],
		category: "youtube",
	};
	const breadcrumbs = [
		{

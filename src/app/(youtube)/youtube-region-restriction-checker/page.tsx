...
export const metadata = {
	...
	keywords:
		"youtube region restriction checker, free online tool, no signup, youtube, youtube region restriction checker online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free youtube region restriction checker tool to process your data instantly with privacy-friendly browser-based workflows.",

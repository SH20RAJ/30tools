...
export const metadata = {
  ...
  description: "Free youtube region restriction checker tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "youtube region restriction checker, free online tool, no signup, youtube, youtube region restriction checker online, 30tools",
  alternates: {
...
export default async function ToolPage() {
  ...
  "description": "Free youtube region restriction checker tool to process your data instantly with privacy-friendly browser-based workflows.",
  ...
  {
    "name": "YouTube Region Restriction Checker",
    "url": "/youtube-region-restriction-checker"
  }
];
  const relatedTools = [
  {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"YouTube Region Restriction Checker","description":"Free youtube region restriction checker tool to process your data instantly with privacy-friendly browser-based workflows.","url":"https://30tools.com/youtube-region-restriction-checker","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />
      ...
      >
        <ToolPlaceholderPage toolId="youtube-region-restriction-checker" />
      </ToolLayout>
    </>
  );
}

...
export const metadata = {
  ...
  description: "Free youtube video count checker tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "youtube video count checker, free online tool, no signup, youtube, youtube video count checker online, 30tools",
  alternates: {
...
export default async function ToolPage() {
  ...
  "description": "Free youtube video count checker tool to process your data instantly with privacy-friendly browser-based workflows.",
  ...
  {
    "name": "YouTube Video Count Checker",
    "url": "/youtube-video-count-checker"
  }
];
  const relatedTools = [
  {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"YouTube Video Count Checker","description":"Free youtube video count checker tool to process your data instantly with privacy-friendly browser-based workflows.","url":"https://30tools.com/youtube-video-count-checker","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />
      ...
      >
        <ToolPlaceholderPage toolId="youtube-video-count-checker" />
      </ToolLayout>
    </>
  );
}

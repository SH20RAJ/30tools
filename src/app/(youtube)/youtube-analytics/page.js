...
export const metadata = {
  ...
  description:
    "Analyze YouTube video performance, get detailed analytics, view counts, engagement rates, and optimization suggestions for your YouTube videos.",
  keywords: [
    "youtube analytics",
...
const _jsonLd = {
  ...
  description:
    "Professional youtube analytics tool. Free online processing with high-quality results. No registration required, instant results.",

...
export const metadata = {
  ...
  description:
    "Download and convert YouTube video subtitles to multiple formats (TXT, SRT, VTT, JSON, CSV). Extract captions from any YouTube video instantly.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Download YouTube subtitles in TXT, SRT, VTT, JSON, and CSV formats. Perfect for content creators, educators, and researchers.",
    type: "website",
  },
  twitter: {
...
const jsonLd = {
  ...
  description:
    "Professional youtube subtitles downloader tool. Free online processing with high-quality results. No registration required, instant results.",

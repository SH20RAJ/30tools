...
export const metadata = {
  ...
  description: "Free youtube video title capitalizer tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "youtube video title capitalizer, free online tool, no signup, youtube, youtube video title capitalizer online, 30tools",
  alternates: {
...
export default async function ToolPage() {
  ...
  "description": "Free youtube video title capitalizer tool to process your data instantly with privacy-friendly browser-based workflows.",
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Youtube Video Title Capitalizer","description":"Free youtube video title capitalizer tool to process your data instantly with privacy-friendly browser-based workflows.","url":"https://30tools.com/youtube-title-capitalizer","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />
      ...
      >
        <ToolPlaceholderPage toolId="youtube-title-capitalizer" />
      </ToolLayout>
    </>
  );
}

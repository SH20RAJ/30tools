...
export const metadata = {
	...
	description:
		"Free Yt Thumbnail Maker online. Yt Thumbnail Maker allows you to download YouTube content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"yt thumbnail maker, free online tool, no signup, youtube, yt thumbnail maker online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Yt Thumbnail Maker online. Yt Thumbnail Maker allows you to download YouTube content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/yt-thumbnail-maker",
		extraSlugs: ["yt-thumbnail-maker"],
		category: "youtube",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
  ...
  description: "Free youtube channel id extractor tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "youtube channel id extractor, free online tool, no signup, youtube, youtube channel id extractor online, 30tools",
  alternates: {
...
export default async function ToolPage() {
  ...
  "description": "Free youtube channel id extractor tool to process your data instantly with privacy-friendly browser-based workflows.",
  ...
  {
    "name": "YouTube Channel ID Extractor",
    "url": "/youtube-channel-id-extractor"
  }
];
  const relatedTools = [
  {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"YouTube Channel ID Extractor","description":"Free youtube channel id extractor tool to process your data instantly with privacy-friendly browser-based workflows.","url":"https://30tools.com/youtube-channel-id-extractor","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />
      ...
      >
        <ToolPlaceholderPage toolId="youtube-channel-id-extractor" />
      </ToolLayout>
    </>
  );
}

...
export const metadata = {
  ...
  description: "Download YouTube videos and audio in multiple formats and qualities 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "youtube video/audio downloader, free online tool, no signup, youtube, youtube video/audio downloader online, 30tools",
  alternates: {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"YouTube Video/Audio Downloader","description":"Download YouTube videos and audio in multiple formats and qualities","url":"https://30tools.com/youtube-downloader","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

...
export const metadata = {
	...
	description:
		"Free Online Thumbnail Creator online. Online Thumbnail Creator allows you to download YouTube content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"online thumbnail creator, free online tool, no signup, youtube, online thumbnail creator online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Online Thumbnail Creator online. Online Thumbnail Creator allows you to download YouTube content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/online-thumbnail-creator",
		extraSlugs: ["online-thumbnail-creator", "schema-creator-online"],
		category: "youtube",
	};
	const breadcrumbs = [
		{

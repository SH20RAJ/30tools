				...
				<div className="max-w-6xl mx-auto">
					...
					<div className="text-center mb-12">
						...
						<p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
							Get AI-powered summaries of any YouTube video. Extract key points
							and main takeaways in seconds without watching the entire video.
						</p>
							...
							{[
								{
									icon: "⏱️",
									title: "Save Time",
									desc: "Get video highlights in seconds",
								},
								{
									icon: "📚",
									title: "Study Aid",
									desc: "Perfect for educational content",
								},
								{
									icon: "🎯",
									title: "Key Points",
									desc: "Extract main takeaways quickly",
								},
								{
									icon: "📝",
									title: "Note Taking",
									desc: "Great for research and notes",
								},
								{
									icon: "🌐",
									title: "Any Video",
									desc: "Works with tutorials, lectures, reviews",
								},
								{
									icon: "💬",
									title: "Quick Preview",
									desc: "Know what videos are about first",
								},
								{
									icon: "🆓",
									title: "Free Tool",
									desc: "No limits on summaries",
								},
								{
									icon: "📱",
									title: "All Devices",
					...
					<section className="mb-16">
						...
						<div className="space-y-4 max-w-4xl mx-auto">
							{[
								{
									q: "How does the video summarizer work?",
									a: "Our AI analyzes the video's transcript, identifies key topics and main points, then generates a concise summary that captures the essential information.",
								},
								{
									q: "How accurate are the summaries?",
									a: "Our AI provides highly accurate summaries, though quality depends on the clarity of the video's audio and available captions.",
								},
								{
									q: "Is this free?",
									a: "Yes, our YouTube video summarizer is 100% free with unlimited use.",
								},
								{
									q: "What types of videos work best?",
									a: "Educational content, tutorials, lectures, podcasts, and any video with clear spoken content works great.",
								},
							].map((faq, i) => (
								<details
									key={i}

...
const researchedKeywords = [
	"thoughts on youtube shorts downloader",
	"ytshortsdl",
	"youtube shorts download short noob",
	"shortsmate",
	"shorts free",
	"shorts youtube download",
	"youtube shorts downloader free",
	"youtube shorts videos download",
	"yt shots",
	"скачать шортс с ютуба",
	"youtube shorts downloader online",
	"youtube shots download",
	"youtube shorts video download",
	"short video download free",
	"shorts download youtube",
	"baixar shorts",
	"baixar shorts youtube",
	"download youtube reels",
	"publer downloader",
	"youtube shorts download free",
	"youtube shorts indir",
	"youtube reel download",
	"short download",
	"how to download youtube shorts",
	"yt short download",
	"youtube short video downloader",
	"youtube reel downloader",
	"short down",
	"ytshorts",
	"download youtube shorts video",
	"descargar short de youtube",
	"shorts noob",
...
const jsonLdSchemas = {
	webApp: {
		...
		description:
			"Free tool to download YouTube Shorts videos in HD quality without watermark. Supported as shorts downloader and youtube reel downloader.",
		url: "https://30tools.com/youtube-shorts-downloader",
	...
	howTo: {
		...
		description:
			"Step-by-step guide to use our youtube short downloader and yt shorts download tool.",
		step: [
			{
				"@type": "HowToStep",
				position: 1,
				name: "Copy Shorts URL",
				text: "Copy the YouTube Shorts URL from the app or browser.",
			},
			{
				"@type": "HowToStep",
				position: 2,
				name: "Paste URL",
				text: "Paste the link into our shorts video downloader input field.",
			},
			{
				"@type": "HowToStep",
				position: 3,
				name: "Download",
				text: "Click download and save the shorts youtube download file instantly.",
			},
		],
	},
	faq: {
			...
			<div className="container mx-auto px-4 py-12 md:py-20 max-w-6xl">
				...
				<div className="text-center mb-12">
					<h1 className="text-4xl md:text-6xl font-extrabold mb-6 text-foreground leading-tight">
						YouTube <span className="text-primary">Shorts Downloader</span>{" "}
						Online
					</h1>
					<p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-4xl mx-auto leading-relaxed">
						Welcome to the fastest{" "}
						<strong>youtube shorts downloader online</strong>. Our{" "}
						<strong>yt short downloader</strong> allows you to{" "}
						<strong>download youtube shorts video</strong> instantly. Whether
						you need <strong>ytshorts</strong>,<strong>shortsnoob</strong>, or a{" "}
						<strong>short downloader</strong>, we provide{" "}
						<strong>shorts free</strong> downloads in HD and 4K quality. Save
						your favorite <strong>shorts youtube download</strong> content
						without watermark.
					</p>
					<div className="flex flex-wrap justify-center gap-4 text-sm font-medium">
						...
						<span className="bg-primary/10 text-primary px-3 py-1 rounded-full border border-primary/20">
							⚡ <strong>YT Shorts Download</strong>
						</span>
						<span className="bg-primary/10 text-primary px-3 py-1 rounded-full border border-primary/20">
							🆓 <strong>Short Video Download Free</strong>
						</span>
					</div>
				</div>
				...
				<div className="flex justify-center mb-8">
					...
					>
						<span className="text-muted-foreground">
							Looking for a Developer API?
						</span>
						<span className="font-semibold text-primary group-hover:underline decoration-primary/50 underline-offset-4">
							Check out Universal YouTube Downloader on Apify →
						</span>
					</a>
				</div>
				...
				<section className="mb-20 prose prose-slate dark:prose-invert max-w-none">
					...
					<div className="grid md:grid-cols-2 gap-12 items-start">
						<div className="space-y-4">
							<p>
								Using our <strong>youtube short video downloader</strong> is
								extremely simple. If you've been wondering
								<strong>how to download youtube shorts</strong>, just follow
								these three steps. First, find your video and get the link. Our{" "}
								<strong>yt short download</strong> engine supports all formats
								including
								<strong>youtube shorts videos download</strong> and{" "}
								<strong>yt shots</strong>. Paste the link into 30Tools, and
								experience the same speed as <strong>shortsmate</strong> or{" "}
								<strong>ytshortsdl</strong>.
							</p>
							<p>
								Our <strong>youtube reel downloader</strong> also works for{" "}
								<strong>youtube reels download</strong>, acting as a universal{" "}
								<strong>shots youtube</strong> tool. Forget about{" "}
								<strong>shorts downloader</strong>
								limitations – we provide unlimited{" "}
								<strong>short video download</strong> access for free.
							</p>
						</div>
						<div className="bg-card p-8 rounded-3xl border border-border/50 shadow-sm space-y-4">
							...
							<ul className="grid grid-cols-2 gap-y-2 gap-x-4 text-sm font-medium list-none p-0">
								<li className="flex items-center gap-2">
									🌐 <strong>YouTube Shorts Indir</strong>
								</li>
								<li className="flex items-center gap-2">
									🇪🇸 <strong>Descargar Short de YouTube</strong>
								</li>
								<li className="flex items-center gap-2">
									🇧🇷 <strong>Baixar Shorts Youtube</strong>
								</li>
								<li className="flex items-center gap-2">
									🇷🇺 <strong>Скачать шортс с ютуба</strong>
								</li>
								<li className="flex items-center gap-2">
									🌍 <strong>Shorts de YouTube</strong>
								</li>
								<li className="flex items-center gap-2">
									🛡️ <strong>Publer Downloader</strong> Alternative
								</li>
							</ul>
						</div>
					</div>
					...
					<div className="grid md:grid-cols-3 gap-8">
						<div className="text-center p-8 bg-card rounded-2xl border border-border hover:border-primary/50 transition-colors group">
							...
							<p className="text-muted-foreground leading-relaxed">
								Copy the URL of the{" "}
								<strong>youtube short video download</strong> you want to save
						...
						<div className="text-center p-8 bg-card rounded-2xl border border-border hover:border-primary/50 transition-colors group">
							...
							<p className="text-muted-foreground leading-relaxed">
								Paste the link into our <strong>yt shorts downloader</strong>{" "}
								above for instant processing.
							</p>
						</div>
						<div className="text-center p-8 bg-card rounded-2xl border border-border hover:border-primary/50 transition-colors group">
							<div className="w-20 h-20 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
							...
							<p className="text-muted-foreground leading-relaxed">
								...
								<strong>download youtube shorts</strong> to save your file
								forever.
							</p>
						</div>
					</div>
				...
				<section className="mb-20">
					<h2 className="text-3xl font-bold text-center mb-12">
						Professional YouTube Short Downloader Features
					</h2>
						...
						{[
							{
								icon: "🎞️",
								title: "HD & 4K Quality",
								desc: "Download in the highest possible resolution available.",
							},
							{
								icon: "🛡️",
								title: "No Watermark",
								desc: "Get clean <strong>short download</strong> files without branding.",
							},
							{
								icon: "🚀",
								title: "Instant Speed",
								desc: "Faster than <strong>shortsnoob</strong> and <strong>ytshortsdl</strong>.",
							},
							{
								icon: "💻",
								title: "Universal",
								desc: "Works for <strong>youtube reels download</strong> on PC and Mobile.",
							},
							{
								icon: "🆓",
								title: "100% Free",
								desc: "Unlimited <strong>short video download free</strong> sessions.",
							},
							{
								icon: "🔐",
								title: "Private",
								desc: "Secure <strong>yt shorts download</strong> without tracking your data.",
							},
							{
								icon: "🌎",
								title: "Global URLs",
								desc: "Supports <strong>baixar shorts do youtube</strong> and <strong>youtube indir</strong>.",
							},
							{
								icon: "🔥",
								title: "Unlimited",
								desc: "No daily limit for your <strong>short down</strong> sessions.",
							},
						].map((f, i) => (
							<div
								key={i}
								className="p-6 bg-card rounded-2xl border border-border hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
							>
				...
				<section className="mb-20 max-w-4xl mx-auto">
					<h2 className="text-3xl font-bold text-center mb-4">
						YouTube Shorts Video Downloader FAQ
					</h2>
					<p className="text-center text-muted-foreground mb-12">
						Everything you need to know about{" "}
						<strong>yt short downloader</strong> and <strong>jutu</strong>.
					</p>
					<div className="space-y-4">
						{[
							{
								q: "How do I download YouTube Shorts?",
								a: "To <strong>download youtube short</strong> videos, copy the URL and paste it into our <strong>shorts downloader</strong>. It's the same process for <strong>youtube reel download</strong>.",
							},
							{
								q: "What is jutu and shortsnoob?",
								a: "These are common search terms for <strong>youtube shorts downloader</strong> services. 30Tools provides a faster and ad-free alternative for <strong>shorts download youtube</strong>.",
							},
							{
								q: "Can I use this as a video downloader free tool?",
								a: "Yes, 30Tools is a comprehensive <strong>video downloader free</strong> platform for YouTube Shorts, regular videos, and thumbnails.",
							},
							{
								q: "Will I get HD quality for youtube short video download?",
								a: "Yes, we extract the highest resolution available on YouTube servers, including 1080p and 4K.",
							},
						].map((faq, i) => (
							<details
								key={i}
				...
				<section className="pt-12 border-t border-border mt-20">
					<h2 className="text-2xl font-extrabold mb-8 text-center uppercase tracking-tighter">
						Explore Pro YouTube Tools
					</h2>
					<div className="grid grid-cols-2 md:grid-cols-4 gap-4">
						{[
							...
							<Link
								key={i}
								href={t.href}
								className="p-5 bg-card rounded-2xl border border-border hover:border-primary hover:shadow-lg transition-all text-center group"
							>
								<h3 className="font-bold mb-1 group-hover:text-primary transition-colors text-sm md:text-base">
									{t.title}
								</h3>

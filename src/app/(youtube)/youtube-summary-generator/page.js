...
export const metadata = {
  ...
  description:
    "Generate intelligent AI summaries of YouTube videos. Extract key insights, topics, and takeaways from any video using advanced artificial intelligence.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Transform any YouTube video into comprehensive summaries with AI. Perfect for researchers, students, and content creators.",
    type: "website",
  },
  twitter: {
...
const jsonLd = {
  ...
  description:
    "Free youtube summary generator tool with professional results. No registration required, instant processing, secure & unlimited use.",

...
export const metadata = {
	...
	description:
		"Youtube Summary Generator - Coming Soon 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"youtube summary generator, free online tool, no signup, others, youtube summary generator online, 30tools",
	alternates: {

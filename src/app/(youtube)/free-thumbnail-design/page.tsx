...
export const metadata = {
	...
	description:
		"Free Free Thumbnail Design online. Free Thumbnail Design allows you to download YouTube content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"free thumbnail design, free online tool, no signup, youtube, free thumbnail design online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Free Thumbnail Design online. Free Thumbnail Design allows you to download YouTube content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/free-thumbnail-design",
		extraSlugs: ["free-thumbnail-design"],
		category: "youtube",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
	...
	description:
		"Youtube Shorts Creator - Coming Soon 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"youtube shorts creator, free online tool, no signup, others, youtube shorts creator online, 30tools",
	alternates: {

...
export const metadata = {
  ...
  description: "Youtube Shorts Creator - Coming Soon 100% free, no signup required, and privacy-focused processing in your browser.",
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Youtube Shorts Creator","description":"Youtube Shorts Creator - Coming Soon","url":"https://30tools.com/youtube-shorts-creator","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

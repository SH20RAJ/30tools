...
export const metadata = {
  ...
  description: "Free Business Logo Creator online. Business Logo Creator allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "business logo creator, free online tool, no signup, image, business logo creator online, 30tools",
  alternates: {
    canonical: "https://30tools.com/business-logo-creator",
  },
  openGraph: {
    title: "Free Business Logo Creator Online - No Signup | 30tools",
    description: "Free Business Logo Creator online. Business Logo Creator allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/business-logo-creator",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "business-logo-creator",
  "name": "Business Logo Creator",
  "description": "Free Business Logo Creator online. Business Logo Creator allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/business-logo-creator",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Business Logo Creator","description":"Free Business Logo Creator online. Business Logo Creator allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/business-logo-creator","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

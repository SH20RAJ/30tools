...
export const metadata = {
	...
	description:
		"Free Compress Javascript Code online. Compress Javascript Code allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"compress javascript code, free online tool, no signup, image, compress javascript code online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Compress Javascript Code online. Compress Javascript Code allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/compress-javascript-code",
		extraSlugs: ["compress-javascript-code"],
		category: "image",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
	...
	description:
		"Free Photo Resizer Free online. Photo Resizer Free allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"photo resizer free, free online tool, no signup, image, photo resizer free online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Photo Resizer Free online. Photo Resizer Free allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/photo-resizer-free",
		extraSlugs: ["photo-resizer-free"],
		category: "image",
	};
	const breadcrumbs = [
		{

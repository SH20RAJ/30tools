...
export const metadata = {
  ...
  description: "Free Instagram Profile Picture Viewer online. Instagram Profile Picture Viewer allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "instagram profile picture viewer, free online tool, no signup, image, instagram profile picture viewer online, 30tools",
  alternates: {
    canonical: "https://30tools.com/instagram-profile-picture-viewer",
  },
  openGraph: {
    title: "Free Instagram Profile Picture Viewer Online - No Signup | 30tools",
    description: "Free Instagram Profile Picture Viewer online. Instagram Profile Picture Viewer allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
...
export default async function ToolPage() {
  const tool = {
  "id": "instagram-profile-picture-viewer",
  "name": "Instagram Profile Picture Viewer",
  "description": "Free Instagram Profile Picture Viewer online. Instagram Profile Picture Viewer allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/instagram-profile-picture-viewer",
  "extraSlugs": [
  ...
  {
    "name": "Instagram Profile Picture Viewer",
    "url": "/instagram-profile-picture-viewer"
  }
];
  const relatedTools = [
  {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Instagram Profile Picture Viewer","description":"Free Instagram Profile Picture Viewer online. Instagram Profile Picture Viewer allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/instagram-profile-picture-viewer","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

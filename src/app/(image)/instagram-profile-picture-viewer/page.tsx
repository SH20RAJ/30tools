...
export const metadata = {
	...
	description:
		"Free Instagram Profile Picture Viewer online. Instagram Profile Picture Viewer allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"instagram profile picture viewer, free online tool, no signup, image, instagram profile picture viewer online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Instagram Profile Picture Viewer online. Instagram Profile Picture Viewer allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",

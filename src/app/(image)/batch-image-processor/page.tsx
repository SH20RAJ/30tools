...
export const metadata = {
	...
	description:
		"Batch Image Processor - Coming Soon 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"batch image processor, free online tool, no signup, others, batch image processor online, 30tools",
	alternates: {

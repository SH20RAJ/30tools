...
export const metadata = {
  ...
  description: "Free Ios App Icon Creator online. Ios App Icon Creator allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "ios app icon creator, free online tool, no signup, image, ios app icon creator online, 30tools",
  alternates: {
    canonical: "https://30tools.com/ios-app-icon-creator",
  },
  openGraph: {
    title: "Free Ios App Icon Creator Online - No Signup | 30tools",
    description: "Free Ios App Icon Creator online. Ios App Icon Creator allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/ios-app-icon-creator",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "ios-app-icon-creator",
  "name": "Ios App Icon Creator",
  "description": "Free Ios App Icon Creator online. Ios App Icon Creator allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/ios-app-icon-creator",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Ios App Icon Creator","description":"Free Ios App Icon Creator online. Ios App Icon Creator allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/ios-app-icon-creator","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

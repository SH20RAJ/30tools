...
export const metadata = {
	...
	description:
		"Free Make Gif From Video online. Make Gif From Video allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"make gif from video, free online tool, no signup, image, make gif from video online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Make Gif From Video online. Make Gif From Video allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/make-gif-from-video",
		extraSlugs: ["make-gif-from-video"],
		category: "image",
	};
	const breadcrumbs = [
		{

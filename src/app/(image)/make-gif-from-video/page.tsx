...
export const metadata = {
  ...
  description: "Free Make Gif From Video online. Make Gif From Video allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "make gif from video, free online tool, no signup, image, make gif from video online, 30tools",
  alternates: {
    canonical: "https://30tools.com/make-gif-from-video",
  },
  openGraph: {
    title: "Free Make Gif From Video Online - No Signup | 30tools",
    description: "Free Make Gif From Video online. Make Gif From Video allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/make-gif-from-video",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "make-gif-from-video",
  "name": "Make Gif From Video",
  "description": "Free Make Gif From Video online. Make Gif From Video allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/make-gif-from-video",
  "extraSlugs": [
    "make-gif-from-video"
  ],
  "category": "image"
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Make Gif From Video","description":"Free Make Gif From Video online. Make Gif From Video allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/make-gif-from-video","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

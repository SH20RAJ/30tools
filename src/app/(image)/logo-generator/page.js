...
export const metadata = {
	...
	description:
		"Create professional logos with text, fonts, and custom colors 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"logo generator, free online tool, no signup, image, logo generator online, 30tools",
	alternates: {
	...
	openGraph: {
		...
		siteName: "30tools",
		images: [{ url: "/api/og?title=Free%20Logo%20Generator%20Online%20-%20No%20Signup" }],
		type: "website",
	},
	twitter: {
		...
		description:
			"Create professional logos with text, fonts, and custom colors 100% free, no signup required, and privacy-focused processing in your browser.",
		images: ["/api/og?title=Free%20Logo%20Generator%20Online%20-%20No%20Signup"],
	},

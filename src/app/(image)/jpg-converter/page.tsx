...
export const metadata = {
  ...
  description: "Free jpg converter tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "jpg converter, free online tool, no signup, image, jpg converter online, 30tools",
  alternates: {
...
export default async function ToolPage() {
  ...
  "id": "jpg-converter",
  "name": "JPG Converter",
  "description": "Free jpg converter tool to process your data instantly with privacy-friendly browser-based workflows.",
  "route": "/jpg-converter",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"JPG Converter","description":"Free jpg converter tool to process your data instantly with privacy-friendly browser-based workflows.","url":"https://30tools.com/jpg-converter","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />
      ...
      >
        <ToolPlaceholderPage toolId="jpg-converter" />
      </ToolLayout>
    </>
  );
}

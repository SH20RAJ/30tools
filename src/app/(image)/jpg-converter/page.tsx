...
export const metadata = {
	...
	description:
		"Free jpg converter tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"jpg converter, free online tool, no signup, image, jpg converter online, 30tools",
	alternates: {
	...
	openGraph: {
		...
		siteName: "30tools",
		images: [{ url: "/api/og?title=Free%20JPG%20Converter%20Online%20-%20No%20Signup" }],
		type: "website",
	},
	twitter: {
		...
		description:
			"Free jpg converter tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
		images: ["/api/og?title=Free%20JPG%20Converter%20Online%20-%20No%20Signup"],
	},
...
export default async function ToolPage() {
	const tool = {
		...
		name: "JPG Converter",
		description:
			"Free jpg converter tool to process your data instantly with privacy-friendly browser-based workflows.",
		route: "/jpg-converter",
		extraSlugs: ["free-jpg-converter-online", "jpg-converter-tool"],
		popular: false,
		category: "image",
	};
	const breadcrumbs = [
	...
	return (
		<>
			...
			>
				<ToolImplementation toolId="jpg-converter" />
			</ToolLayout>
		</>
	);
}

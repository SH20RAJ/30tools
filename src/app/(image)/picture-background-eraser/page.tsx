...
export const metadata = {
	...
	description:
		"Free Picture Background Eraser online. Picture Background Eraser allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"picture background eraser, free online tool, no signup, image, picture background eraser online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Picture Background Eraser online. Picture Background Eraser allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/picture-background-eraser",
		extraSlugs: ["picture-background-eraser"],
		category: "image",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
  ...
  description: "Free Picture Background Eraser online. Picture Background Eraser allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "picture background eraser, free online tool, no signup, image, picture background eraser online, 30tools",
  alternates: {
    canonical: "https://30tools.com/picture-background-eraser",
  },
  openGraph: {
    title: "Free Picture Background Eraser Online - No Signup | 30tools",
    description: "Free Picture Background Eraser online. Picture Background Eraser allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/picture-background-eraser",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "picture-background-eraser",
  "name": "Picture Background Eraser",
  "description": "Free Picture Background Eraser online. Picture Background Eraser allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/picture-background-eraser",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Picture Background Eraser","description":"Free Picture Background Eraser online. Picture Background Eraser allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/picture-background-eraser","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

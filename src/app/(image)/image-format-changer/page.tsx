...
export const metadata = {
	...
	description:
		"Free Image Format Changer online. Image Format Changer allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"image format changer, free online tool, no signup, image, image format changer online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Image Format Changer online. Image Format Changer allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/image-format-changer",
		extraSlugs: ["color-format-changer", "image-format-changer"],
		category: "image",
	};
	const breadcrumbs = [
		{

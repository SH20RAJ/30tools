...
export const metadata = {
  ...
  description: "Free Image Format Changer online. Image Format Changer allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "image format changer, free online tool, no signup, image, image format changer online, 30tools",
  alternates: {
    canonical: "https://30tools.com/image-format-changer",
  },
  openGraph: {
    title: "Free Image Format Changer Online - No Signup | 30tools",
    description: "Free Image Format Changer online. Image Format Changer allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/image-format-changer",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "image-format-changer",
  "name": "Image Format Changer",
  "description": "Free Image Format Changer online. Image Format Changer allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/image-format-changer",
  "extraSlugs": [
    "color-format-changer",
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Image Format Changer","description":"Free Image Format Changer online. Image Format Changer allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/image-format-changer","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

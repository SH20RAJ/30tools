...
export const metadata = {
  ...
  description: "Free Edit Audio Online online. Edit Audio Online allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "edit audio online, free online tool, no signup, image, edit audio online online, 30tools",
  alternates: {
    canonical: "https://30tools.com/edit-audio-online",
  },
  openGraph: {
    title: "Free Edit Audio Online Online - No Signup | 30tools",
    description: "Free Edit Audio Online online. Edit Audio Online allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/edit-audio-online",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "edit-audio-online",
  "name": "Edit Audio Online",
  "description": "Free Edit Audio Online online. Edit Audio Online allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/edit-audio-online",
  "extraSlugs": [
    "audio-cutter-online",
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Edit Audio Online","description":"Free Edit Audio Online online. Edit Audio Online allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/edit-audio-online","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

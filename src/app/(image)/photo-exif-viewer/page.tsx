...
export const metadata = {
  ...
  description: "Free Photo Exif Viewer online. Photo Exif Viewer allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "photo exif viewer, free online tool, no signup, image, photo exif viewer online, 30tools",
  alternates: {
    canonical: "https://30tools.com/photo-exif-viewer",
  },
  openGraph: {
    title: "Free Photo Exif Viewer Online - No Signup | 30tools",
    description: "Free Photo Exif Viewer online. Photo Exif Viewer allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/photo-exif-viewer",
    siteName: "30tools",
...
export default async function ToolPage() {
  ...
  "name": "Photo Exif Viewer",
  "description": "Free Photo Exif Viewer online. Photo Exif Viewer allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/photo-exif-viewer",
  "extraSlugs": [
    "photo-exif-viewer"
  ],
  "category": "image"
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Photo Exif Viewer","description":"Free Photo Exif Viewer online. Photo Exif Viewer allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/photo-exif-viewer","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

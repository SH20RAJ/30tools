...
export const metadata = {
	...
	description:
		"Free Photo Exif Viewer online. Photo Exif Viewer allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"photo exif viewer, free online tool, no signup, image, photo exif viewer online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Photo Exif Viewer online. Photo Exif Viewer allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/photo-exif-viewer",
		extraSlugs: ["photo-exif-viewer"],
		category: "image",
	};
	const breadcrumbs = [
		{

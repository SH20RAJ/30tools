...
export const metadata = {
  ...
  description: "Free Delete Image Background online. Delete Image Background allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "delete image background, free online tool, no signup, image, delete image background online, 30tools",
  alternates: {
    canonical: "https://30tools.com/delete-image-background",
  },
  openGraph: {
    title: "Free Delete Image Background Online - No Signup | 30tools",
    description: "Free Delete Image Background online. Delete Image Background allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/delete-image-background",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "delete-image-background",
  "name": "Delete Image Background",
  "description": "Free Delete Image Background online. Delete Image Background allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/delete-image-background",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Delete Image Background","description":"Free Delete Image Background online. Delete Image Background allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/delete-image-background","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

...
export const metadata = {
  ...
  description: "Free Image Optimization Test online. Image Optimization Test allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "image optimization test, free online tool, no signup, image, image optimization test online, 30tools",
  alternates: {
    canonical: "https://30tools.com/image-optimization-test",
  },
  openGraph: {
    title: "Free Image Optimization Test Online - No Signup | 30tools",
    description: "Free Image Optimization Test online. Image Optimization Test allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/image-optimization-test",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "image-optimization-test",
  "name": "Image Optimization Test",
  "description": "Free Image Optimization Test online. Image Optimization Test allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/image-optimization-test",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Image Optimization Test","description":"Free Image Optimization Test online. Image Optimization Test allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/image-optimization-test","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

...
export const metadata = {
	...
	description:
		"Free Image Optimization Test online. Image Optimization Test allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"image optimization test, free online tool, no signup, image, image optimization test online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Image Optimization Test online. Image Optimization Test allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/image-optimization-test",
		extraSlugs: ["image-optimization-test"],
		category: "image",
	};
	const breadcrumbs = [
		{

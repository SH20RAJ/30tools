...
export const metadata = {
  ...
  description: "Free jpg to ico converter tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "jpg to ico converter, free online tool, no signup, image, jpg to ico converter online, 30tools",
  alternates: {
...
export default async function ToolPage() {
  ...
  "description": "Free jpg to ico converter tool to process your data instantly with privacy-friendly browser-based workflows.",
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"JPG to ICO Converter","description":"Free jpg to ico converter tool to process your data instantly with privacy-friendly browser-based workflows.","url":"https://30tools.com/jpg-to-ico-converter","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />
      ...
      >
        <ToolPlaceholderPage toolId="jpg-to-ico-converter" />
      </ToolLayout>
    </>
  );
}

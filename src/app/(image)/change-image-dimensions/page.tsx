...
export const metadata = {
  ...
  description: "Free Change Image Dimensions online. Change Image Dimensions allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "change image dimensions, free online tool, no signup, image, change image dimensions online, 30tools",
  alternates: {
    canonical: "https://30tools.com/change-image-dimensions",
  },
  openGraph: {
    title: "Free Change Image Dimensions Online - No Signup | 30tools",
    description: "Free Change Image Dimensions online. Change Image Dimensions allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/change-image-dimensions",
    siteName: "30tools",
...
export default async function ToolPage() {
  ...
  "description": "Free Change Image Dimensions online. Change Image Dimensions allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/change-image-dimensions",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Change Image Dimensions","description":"Free Change Image Dimensions online. Change Image Dimensions allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/change-image-dimensions","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

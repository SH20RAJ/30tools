...
export const metadata = {
	...
	description:
		"Free Change Image Dimensions online. Change Image Dimensions allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"change image dimensions, free online tool, no signup, image, change image dimensions online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Change Image Dimensions online. Change Image Dimensions allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/change-image-dimensions",
		extraSlugs: ["change-image-dimensions"],
		category: "image",
	};
	const breadcrumbs = [
		{

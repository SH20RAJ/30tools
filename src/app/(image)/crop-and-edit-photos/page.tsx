...
export const metadata = {
	...
	description:
		"Free Crop And Edit Photos online. Crop And Edit Photos allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"crop and edit photos, free online tool, no signup, image, crop and edit photos online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Crop And Edit Photos online. Crop And Edit Photos allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/crop-and-edit-photos",
		extraSlugs: ["crop-and-edit-photos"],
		category: "image",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
  ...
  description: "Free Crop And Edit Photos online. Crop And Edit Photos allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "crop and edit photos, free online tool, no signup, image, crop and edit photos online, 30tools",
  alternates: {
    canonical: "https://30tools.com/crop-and-edit-photos",
  },
  openGraph: {
    title: "Free Crop And Edit Photos Online - No Signup | 30tools",
    description: "Free Crop And Edit Photos online. Crop And Edit Photos allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/crop-and-edit-photos",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "crop-and-edit-photos",
  "name": "Crop And Edit Photos",
  "description": "Free Crop And Edit Photos online. Crop And Edit Photos allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/crop-and-edit-photos",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Crop And Edit Photos","description":"Free Crop And Edit Photos online. Crop And Edit Photos allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/crop-and-edit-photos","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

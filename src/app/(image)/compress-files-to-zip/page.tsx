...
export const metadata = {
  ...
  description: "Free Compress Files To Zip online. Compress Files To Zip allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "compress files to zip, free online tool, no signup, image, compress files to zip online, 30tools",
  alternates: {
    canonical: "https://30tools.com/compress-files-to-zip",
  },
  openGraph: {
    title: "Free Compress Files To Zip Online - No Signup | 30tools",
    description: "Free Compress Files To Zip online. Compress Files To Zip allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/compress-files-to-zip",
    siteName: "30tools",
...
export default async function ToolPage() {
  ...
  "description": "Free Compress Files To Zip online. Compress Files To Zip allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/compress-files-to-zip",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Compress Files To Zip","description":"Free Compress Files To Zip online. Compress Files To Zip allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/compress-files-to-zip","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

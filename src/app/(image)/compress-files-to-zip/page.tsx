...
export const metadata = {
	...
	description:
		"Free Compress Files To Zip online. Compress Files To Zip allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"compress files to zip, free online tool, no signup, image, compress files to zip online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Compress Files To Zip online. Compress Files To Zip allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/compress-files-to-zip",
		extraSlugs: ["compress-files-to-zip", "zip-files-free"],
		category: "image",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
	...
	description:
		"Free Android Icon Maker online. Android Icon Maker allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"android icon maker, free online tool, no signup, image, android icon maker online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Android Icon Maker online. Android Icon Maker allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/android-icon-maker",
		extraSlugs: ["android-icon-maker"],
		category: "image",
	};
	const breadcrumbs = [
		{

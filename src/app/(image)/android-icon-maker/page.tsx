...
export const metadata = {
  ...
  description: "Free Android Icon Maker online. Android Icon Maker allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "android icon maker, free online tool, no signup, image, android icon maker online, 30tools",
  alternates: {
    canonical: "https://30tools.com/android-icon-maker",
  },
  openGraph: {
    title: "Free Android Icon Maker Online - No Signup | 30tools",
    description: "Free Android Icon Maker online. Android Icon Maker allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/android-icon-maker",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "android-icon-maker",
  "name": "Android Icon Maker",
  "description": "Free Android Icon Maker online. Android Icon Maker allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/android-icon-maker",
  "extraSlugs": [
    "android-icon-maker"
  ],
  "category": "image"
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Android Icon Maker","description":"Free Android Icon Maker online. Android Icon Maker allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/android-icon-maker","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

...
export const metadata = {
	...
	description:
		"Free Convert Time Across Zones online. Convert Time Across Zones allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"convert time across zones, free online tool, no signup, image, convert time across zones online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Convert Time Across Zones online. Convert Time Across Zones allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/convert-time-across-zones",
		extraSlugs: ["convert-epoch-time", "convert-time-across-zones"],
		category: "image",
	};
	const breadcrumbs = [
		{

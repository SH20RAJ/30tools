...
export const metadata = {
  ...
  description: "Free Convert Time Across Zones online. Convert Time Across Zones allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "convert time across zones, free online tool, no signup, image, convert time across zones online, 30tools",
  alternates: {
    canonical: "https://30tools.com/convert-time-across-zones",
  },
  openGraph: {
    title: "Free Convert Time Across Zones Online - No Signup | 30tools",
    description: "Free Convert Time Across Zones online. Convert Time Across Zones allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/convert-time-across-zones",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "convert-time-across-zones",
  "name": "Convert Time Across Zones",
  "description": "Free Convert Time Across Zones online. Convert Time Across Zones allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/convert-time-across-zones",
  "extraSlugs": [
    "convert-epoch-time",
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Convert Time Across Zones","description":"Free Convert Time Across Zones online. Convert Time Across Zones allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/convert-time-across-zones","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

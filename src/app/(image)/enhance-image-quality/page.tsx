...
export const metadata = {
	...
	description:
		"Free Enhance Image Quality online. Enhance Image Quality allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"enhance image quality, free online tool, no signup, image, enhance image quality online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Enhance Image Quality online. Enhance Image Quality allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/enhance-image-quality",
		extraSlugs: ["enhance-image-quality"],
		category: "image",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
	...
	description:
		"Watermark Remover - Coming Soon 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"watermark remover, free online tool, no signup, others, watermark remover online, 30tools",
	alternates: {

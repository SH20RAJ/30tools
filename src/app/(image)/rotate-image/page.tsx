...
export const metadata = {
  ...
  description: "Free rotate image tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "rotate image, free online tool, no signup, image, rotate image online, 30tools",
  alternates: {
...
export default async function ToolPage() {
  ...
  "id": "rotate-image",
  "name": "Rotate Image",
  "description": "Free rotate image tool to process your data instantly with privacy-friendly browser-based workflows.",
  "route": "/rotate-image",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Rotate Image","description":"Free rotate image tool to process your data instantly with privacy-friendly browser-based workflows.","url":"https://30tools.com/rotate-image","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />
      ...
      >
        <ToolPlaceholderPage toolId="rotate-image" />
      </ToolLayout>
    </>
  );
}

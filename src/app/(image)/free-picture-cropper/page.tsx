...
export const metadata = {
	...
	description:
		"Free Free Picture Cropper online. Free Picture Cropper allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"free picture cropper, free online tool, no signup, image, free picture cropper online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Free Picture Cropper online. Free Picture Cropper allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/free-picture-cropper",
		extraSlugs: ["free-picture-cropper"],
		category: "image",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
  ...
  description: "Free Improve Picture Resolution online. Improve Picture Resolution allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "improve picture resolution, free online tool, no signup, image, improve picture resolution online, 30tools",
  alternates: {
    canonical: "https://30tools.com/improve-picture-resolution",
  },
  openGraph: {
    title: "Free Improve Picture Resolution Online - No Signup | 30tools",
    description: "Free Improve Picture Resolution online. Improve Picture Resolution allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/improve-picture-resolution",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "improve-picture-resolution",
  "name": "Improve Picture Resolution",
  "description": "Free Improve Picture Resolution online. Improve Picture Resolution allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/improve-picture-resolution",
  "extraSlugs": [
  ...
  {
    "name": "Improve Picture Resolution",
    "url": "/improve-picture-resolution"
  }
];
  const relatedTools = [
  {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Improve Picture Resolution","description":"Free Improve Picture Resolution online. Improve Picture Resolution allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/improve-picture-resolution","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

...
export const metadata = {
	...
	description:
		"Free Improve Picture Resolution online. Improve Picture Resolution allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"improve picture resolution, free online tool, no signup, image, improve picture resolution online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Improve Picture Resolution online. Improve Picture Resolution allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/improve-picture-resolution",
		extraSlugs: ["improve-picture-resolution"],
		category: "image",
	};
	const breadcrumbs = [
		{

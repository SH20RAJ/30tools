...
export const metadata = {
  ...
  description: "Free Circular Image Crop online. Circular Image Crop allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "circular image crop, free online tool, no signup, image, circular image crop online, 30tools",
  alternates: {
    canonical: "https://30tools.com/circular-image-crop",
  },
  openGraph: {
    title: "Free Circular Image Crop Online - No Signup | 30tools",
    description: "Free Circular Image Crop online. Circular Image Crop allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/circular-image-crop",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "circular-image-crop",
  "name": "Circular Image Crop",
  "description": "Free Circular Image Crop online. Circular Image Crop allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Circular Image Crop","description":"Free Circular Image Crop online. Circular Image Crop allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/circular-image-crop","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

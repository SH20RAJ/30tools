...
export const metadata = {
	...
	description:
		"Free Circular Image Crop online. Circular Image Crop allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"circular image crop, free online tool, no signup, image, circular image crop online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Circular Image Crop online. Circular Image Crop allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/circular-image-crop",
		extraSlugs: ["circular-image-crop"],
		category: "image",
	};
	const breadcrumbs = [
		{

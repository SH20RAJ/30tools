...
export const metadata = {
  ...
  description: "Create beautiful Open Graph images for your website for free. Customize templates, backgrounds, and text. 100% free, no signup required, and privacy-focused processing in your browser.",
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"OG Image Generator","description":"Create beautiful Open Graph images for your website for free. Customize templates, backgrounds, and text.","url":"https://30tools.com/og-image-generator","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

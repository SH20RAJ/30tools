...
export const metadata = {
  ...
  keywords:
    "free image compressor, compress image online free, reduce image size free, photo compressor free, jpg compressor free, png compressor free, webp compressor free, bulk image compressor free",
  alternates: {
    canonical: "https://30tools.com/free-image-compressor",
  },
  openGraph: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Free Image Compressor - 30tools",
      },
    ],
    locale: "en_US",
    type: "website",
...
export default function FreeImageCompressorPage() {
  // Tool-specific data
  const toolData = {
    id: "free-image-compressor",
    name: "Free Image Compressor",
    description: "Compress images without losing quality for free",
    category: "image",
    route: "/free-image-compressor",
  };

  // Breadcrumb navigation
  const breadcrumbs = [
    { name: "Image Tools", url: "/image-tools" },
    { name: "Free Image Compressor", url: "/free-image-compressor" },
  ];
  ...
  // FAQ data - reusing image-compressor FAQs as they are relevant
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <QuickActions
            ...
            toolUrl="https://30tools.com/free-image-compressor"
            showBookmark={true}
            showShare={true}
          />
        </div>
        ...
        <div className="mb-12">
          <FAQSection
            faqs={faqs}
            title="Free Image Compressor FAQ"
        ...
        <div className="mb-12">
          <RelatedTools
            currentTool="free-image-compressor"
            category="image"
            tools={relatedTools}
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([
            ...
            },
            {
              "@context": "https://schema.org",
              "@type": "HowTo",
              name: "How to Compress Images for Free",
              step: [
                {
                  "@type": "HowToStep",
                  name: "Upload",
                  text: "Drag & drop your images or click to select files.",
                  url: "https://30tools.com/free-image-compressor#step1",
                },
                {
                  "@type": "HowToStep",
                  name: "Adjust",
                  text: "Set your desired quality level to balance size and clarity.",
                  url: "https://30tools.com/free-image-compressor#step2",
                },
                {
                  "@type": "HowToStep",
                  name: "Download",
                  text: "Download your compressed images individually or as a ZIP.",
                  url: "https://30tools.com/free-image-compressor#step3",
                },
              ],
            },
          ]),

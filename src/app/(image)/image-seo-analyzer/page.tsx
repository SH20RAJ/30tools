...
export const metadata = {
  ...
  description: "Free Image Seo Analyzer online. Image Seo Analyzer allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "image seo analyzer, free online tool, no signup, image, image seo analyzer online, 30tools",
  alternates: {
...
export default async function ToolPage() {
  ...
  "description": "Free Image Seo Analyzer online. Image Seo Analyzer allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/image-seo-analyzer",
  "extraSlugs": [
    "image-seo-analyzer",
    "seo-text-analyzer",
    "seo-title-analyzer"
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Image Seo Analyzer","description":"Free Image Seo Analyzer online. Image Seo Analyzer allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/image-seo-analyzer","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

...
export const metadata = {
  ...
  description: "Free Online Logo Design online. Online Logo Design allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "online logo design, free online tool, no signup, image, online logo design online, 30tools",
  alternates: {
    canonical: "https://30tools.com/online-logo-design",
  },
  openGraph: {
    title: "Free Online Logo Design Online - No Signup | 30tools",
    description: "Free Online Logo Design online. Online Logo Design allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/online-logo-design",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "online-logo-design",
  "name": "Online Logo Design",
  "description": "Free Online Logo Design online. Online Logo Design allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/online-logo-design",
  "extraSlugs": [
    "online-logo-design"
  ],
  "category": "image"
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Online Logo Design","description":"Free Online Logo Design online. Online Logo Design allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/online-logo-design","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

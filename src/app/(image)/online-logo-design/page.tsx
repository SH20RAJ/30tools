...
export const metadata = {
	...
	description:
		"Free Online Logo Design online. Online Logo Design allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"online logo design, free online tool, no signup, image, online logo design online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Online Logo Design online. Online Logo Design allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/online-logo-design",
		extraSlugs: ["online-logo-design"],
		category: "image",
	};
	const breadcrumbs = [
		{

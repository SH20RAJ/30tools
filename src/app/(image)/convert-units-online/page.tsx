...
export const metadata = {
	...
	description:
		"Free Convert Units Online online. Convert Units Online allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"convert units online, free online tool, no signup, image, convert units online online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Convert Units Online online. Convert Units Online allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/convert-units-online",
		extraSlugs: ["convert-money-online", "convert-units-online"],
		category: "image",
	};
	const breadcrumbs = [
		{

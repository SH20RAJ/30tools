...
export const metadata = {
  ...
  description: "Free Convert Units Online online. Convert Units Online allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "convert units online, free online tool, no signup, image, convert units online online, 30tools",
  alternates: {
    canonical: "https://30tools.com/convert-units-online",
  },
  openGraph: {
    title: "Free Convert Units Online Online - No Signup | 30tools",
    description: "Free Convert Units Online online. Convert Units Online allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/convert-units-online",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "convert-units-online",
  "name": "Convert Units Online",
  "description": "Free Convert Units Online online. Convert Units Online allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/convert-units-online",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Convert Units Online","description":"Free Convert Units Online online. Convert Units Online allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/convert-units-online","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

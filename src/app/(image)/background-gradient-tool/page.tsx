...
export const metadata = {
  ...
  description: "Free Background Gradient Tool online. Background Gradient Tool allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "background gradient tool, free online tool, no signup, image, background gradient tool online, 30tools",
  alternates: {
    canonical: "https://30tools.com/background-gradient-tool",
  },
  openGraph: {
    title: "Free Background Gradient Tool Online - No Signup | 30tools",
    description: "Free Background Gradient Tool online. Background Gradient Tool allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/background-gradient-tool",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "background-gradient-tool",
  "name": "Background Gradient Tool",
  "description": "Free Background Gradient Tool online. Background Gradient Tool allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/background-gradient-tool",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Background Gradient Tool","description":"Free Background Gradient Tool online. Background Gradient Tool allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/background-gradient-tool","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

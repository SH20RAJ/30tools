...
export const metadata = {
	...
	description:
		"Free Background Gradient Tool online. Background Gradient Tool allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"background gradient tool, free online tool, no signup, image, background gradient tool online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Background Gradient Tool online. Background Gradient Tool allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/background-gradient-tool",
		extraSlugs: ["background-gradient-creator", "background-gradient-tool"],
		category: "image",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
	...
	description:
		"Instantly extract photo metadata in your browser. Free EXIF Reader reveals camera make/model, shutter speed, ISO, GPS, and timestamp without uploads or signup.",
	keywords: [
		"exif reader",
		"free exif reader",
		"online exif reader",
		...
		"browser exif reader",
		"view photo metadata free",
		"metadata reader online",
	],
	robots: {
		index: true,
		follow: true,
		...
		faqs: [
			{
				...
				answer:
					"Yes! Our EXIF Reader is completely free to use with no hidden costs, subscriptions, or premium features. You get full access to all functionality without any limitations.",
			},
			{
			...
			},
			{
				...
				answer:
					"No registration required. You can start using EXIF Reader immediately without creating an account or providing any personal information.",
			},
			{
			...
			},
			{
				...
				answer:
					"Yes, EXIF Reader is fully responsive and works perfectly on smartphones, tablets, and desktop computers with any modern browser.",
			},
			{
				question: "What file formats does EXIF Reader support?",
				answer:
					"EXIF Reader supports all major formats for its category. Upload common file types and get converted results in standard output formats compatible with any device or software.",
			},
		],
		howTo: {
			...
			<main className="container mx-auto px-4 py-8">
				...
				<div className="text-center mb-12 max-w-3xl mx-auto">
					...
					<p className="text-xl text-muted-foreground mb-8 leading-8">
						Instantly inspect hidden metadata in your photos. View camera
						settings, GPS location, timestamp, and file tags in your browser
						without uploads or signup.
					</p>
					<QuickActions
				...
				<div className="mb-12 max-w-5xl mx-auto rounded-3xl border border-border bg-card p-8 shadow-sm">
					...
					<p className="text-base leading-7 text-muted-foreground mb-6">
						This EXIF Reader extracts hidden metadata from your image files in a
						clean browser interface. See camera make/model, exposure settings,
						GPS coordinates, and capture timestamps instantly.
					</p>
				...
				<div className="mb-12 grid gap-8 lg:grid-cols-2">
					<div className="rounded-3xl border border-border bg-card p-8 shadow-sm">
						...
						<ul className="space-y-3 text-sm leading-6 text-muted-foreground list-disc list-inside">
							...
							<li>
								Keep your files private with browser-side processing only.
							</li>
						</ul>
					</div>
					<div className="rounded-3xl border border-border bg-card p-8 shadow-sm">
				...
				<div className="mb-12 max-w-5xl mx-auto">
					<h2 className="text-3xl font-bold mb-6">
						EXIF Reader vs alternatives
					</h2>
					<div className="grid gap-4 md:grid-cols-3">
						<div className="rounded-3xl border border-border bg-card p-6 shadow-sm">
							<h3 className="font-semibold mb-3">Browser EXIF tools</h3>
							<p className="text-sm text-muted-foreground leading-6">
								Most browser EXIF viewers require uploads. 30tools reads
								metadata locally for better privacy and faster results.
							</p>
						</div>
						<div className="rounded-3xl border border-border bg-card p-6 shadow-sm">
							<h3 className="font-semibold mb-3">Desktop apps</h3>
							<p className="text-sm text-muted-foreground leading-6">
								Desktop EXIF readers need downloads and installations. Our tool
						...
						<div className="rounded-3xl border border-border bg-card p-6 shadow-sm">
							...
							<p className="text-sm text-muted-foreground leading-6">
								Command-line EXIF readers are powerful but technical. 30tools is
								easy, visual, and mobile-friendly.
							</p>
						</div>
					</div>
				</div>

...
export const metadata = {
	...
	description:
		"Free Favicon Maker From Image online. Favicon Maker From Image allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"favicon maker from image, free online tool, no signup, image, favicon maker from image online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Favicon Maker From Image online. Favicon Maker From Image allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/favicon-maker-from-image",
		extraSlugs: ["favicon-maker-from-image"],
		category: "image",
	};
	const breadcrumbs = [
		{

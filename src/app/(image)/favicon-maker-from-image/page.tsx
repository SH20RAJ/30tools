...
export const metadata = {
  ...
  description: "Free Favicon Maker From Image online. Favicon Maker From Image allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "favicon maker from image, free online tool, no signup, image, favicon maker from image online, 30tools",
  alternates: {
    canonical: "https://30tools.com/favicon-maker-from-image",
  },
  openGraph: {
    title: "Free Favicon Maker From Image Online - No Signup | 30tools",
    description: "Free Favicon Maker From Image online. Favicon Maker From Image allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/favicon-maker-from-image",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "favicon-maker-from-image",
  "name": "Favicon Maker From Image",
  "description": "Free Favicon Maker From Image online. Favicon Maker From Image allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/favicon-maker-from-image",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Favicon Maker From Image","description":"Free Favicon Maker From Image online. Favicon Maker From Image allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/favicon-maker-from-image","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

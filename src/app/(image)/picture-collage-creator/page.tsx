...
export const metadata = {
  ...
  description: "Free Picture Collage Creator online. Picture Collage Creator allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "picture collage creator, free online tool, no signup, image, picture collage creator online, 30tools",
  alternates: {
    canonical: "https://30tools.com/picture-collage-creator",
  },
  openGraph: {
    title: "Free Picture Collage Creator Online - No Signup | 30tools",
    description: "Free Picture Collage Creator online. Picture Collage Creator allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/picture-collage-creator",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "picture-collage-creator",
  "name": "Picture Collage Creator",
  "description": "Free Picture Collage Creator online. Picture Collage Creator allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/picture-collage-creator",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Picture Collage Creator","description":"Free Picture Collage Creator online. Picture Collage Creator allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/picture-collage-creator","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

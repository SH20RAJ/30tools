...
export const metadata = {
	...
	description:
		"Free Picture Collage Creator online. Picture Collage Creator allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"picture collage creator, free online tool, no signup, image, picture collage creator online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Picture Collage Creator online. Picture Collage Creator allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/picture-collage-creator",
		extraSlugs: ["picture-collage-creator"],
		category: "image",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
  ...
  description: "Free Generate Qr Image online. Generate Qr Image allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "generate qr image, free online tool, no signup, image, generate qr image online, 30tools",
  alternates: {
    canonical: "https://30tools.com/generate-qr-image",
  },
  openGraph: {
    title: "Free Generate Qr Image Online - No Signup | 30tools",
    description: "Free Generate Qr Image online. Generate Qr Image allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/generate-qr-image",
    siteName: "30tools",
...
export default async function ToolPage() {
  ...
  "description": "Free Generate Qr Image online. Generate Qr Image allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/generate-qr-image",
  "extraSlugs": [
    "generate-qr-image"
  ],
  "category": "image"
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Generate Qr Image","description":"Free Generate Qr Image online. Generate Qr Image allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/generate-qr-image","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

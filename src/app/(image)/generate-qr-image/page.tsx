...
export const metadata = {
	...
	description:
		"Free Generate Qr Image online. Generate Qr Image allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"generate qr image, free online tool, no signup, image, generate qr image online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Generate Qr Image online. Generate Qr Image allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/generate-qr-image",
		extraSlugs: ["generate-qr-image"],
		category: "image",
	};
	const breadcrumbs = [
		{

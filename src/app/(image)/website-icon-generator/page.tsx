...
export const metadata = {
  ...
  description: "Free Website Icon Generator online. Website Icon Generator allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "website icon generator, free online tool, no signup, image, website icon generator online, 30tools",
  alternates: {
    canonical: "https://30tools.com/website-icon-generator",
  },
  openGraph: {
    title: "Free Website Icon Generator Online - No Signup | 30tools",
    description: "Free Website Icon Generator online. Website Icon Generator allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/website-icon-generator",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "website-icon-generator",
  "name": "Website Icon Generator",
  "description": "Free Website Icon Generator online. Website Icon Generator allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/website-icon-generator",
  "extraSlugs": [
    "app-icon-generator",
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Website Icon Generator","description":"Free Website Icon Generator online. Website Icon Generator allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/website-icon-generator","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

...
export const metadata = {
  ...
  description: "Compress images to reduce file size while maintaining quality 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "image compressor, free online tool, no signup, image, image compressor online, 30tools",
  alternates: {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Image Compressor","description":"Compress images to reduce file size while maintaining quality","url":"https://30tools.com/image-compressor","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

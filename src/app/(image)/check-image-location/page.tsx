...
export const metadata = {
  ...
  description: "Free Check Image Location online. Check Image Location allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "check image location, free online tool, no signup, image, check image location online, 30tools",
  alternates: {
    canonical: "https://30tools.com/check-image-location",
  },
  openGraph: {
    title: "Free Check Image Location Online - No Signup | 30tools",
    description: "Free Check Image Location online. Check Image Location allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/check-image-location",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "check-image-location",
  "name": "Check Image Location",
  "description": "Free Check Image Location online. Check Image Location allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/check-image-location",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Check Image Location","description":"Free Check Image Location online. Check Image Location allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/check-image-location","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

...
export const metadata = {
	...
	description:
		"Free Check Image Location online. Check Image Location allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"check image location, free online tool, no signup, image, check image location online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Check Image Location online. Check Image Location allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/check-image-location",
		extraSlugs: ["check-image-location", "check-image-seo"],
		category: "image",
	};
	const breadcrumbs = [
		{

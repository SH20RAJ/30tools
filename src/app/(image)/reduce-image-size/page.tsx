...
export const metadata = {
  ...
  description: "Free Reduce Image Size online. Reduce Image Size allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "reduce image size, free online tool, no signup, image, reduce image size online, 30tools",
  alternates: {
    canonical: "https://30tools.com/reduce-image-size",
  },
  openGraph: {
    title: "Free Reduce Image Size Online - No Signup | 30tools",
    description: "Free Reduce Image Size online. Reduce Image Size allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/reduce-image-size",
    siteName: "30tools",
...
export default async function ToolPage() {
  ...
  "description": "Free Reduce Image Size online. Reduce Image Size allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Reduce Image Size","description":"Free Reduce Image Size online. Reduce Image Size allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/reduce-image-size","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

...
export const metadata = {
	...
	description:
		"Free Reduce Image Size online. Reduce Image Size allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"reduce image size, free online tool, no signup, image, reduce image size online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Reduce Image Size online. Reduce Image Size allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",

...
export const metadata = {
	...
	description:
		"Free View Image Metadata online. View Image Metadata allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"view image metadata, free online tool, no signup, image, view image metadata online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free View Image Metadata online. View Image Metadata allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/view-image-metadata",
		extraSlugs: ["view-image-metadata"],
		category: "image",
	};
	const breadcrumbs = [
		{

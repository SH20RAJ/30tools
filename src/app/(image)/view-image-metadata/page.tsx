...
export const metadata = {
  title: "Free View Image Metadata Online - No Signup | 30tools",
  description: "Free View Image Metadata online. View Image Metadata allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "view image metadata, free online tool, no signup, image, view image metadata online, 30tools",
  alternates: {
    canonical: "https://30tools.com/view-image-metadata",
  },
  openGraph: {
    title: "Free View Image Metadata Online - No Signup | 30tools",
    description: "Free View Image Metadata online. View Image Metadata allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/view-image-metadata",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "view-image-metadata",
  "name": "View Image Metadata",
  "description": "Free View Image Metadata online. View Image Metadata allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/view-image-metadata",
  "extraSlugs": [
    "view-image-metadata"
  ],
  "category": "image"
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"View Image Metadata","description":"Free View Image Metadata online. View Image Metadata allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/view-image-metadata","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

...
export const metadata = {
  ...
  description: "Free Compress Jpeg Png online. Compress Jpeg Png allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "compress jpeg png, free online tool, no signup, image, compress jpeg png online, 30tools",
  alternates: {
    canonical: "https://30tools.com/compress-jpeg-png",
  },
  openGraph: {
    title: "Free Compress Jpeg Png Online - No Signup | 30tools",
    description: "Free Compress Jpeg Png online. Compress Jpeg Png allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/compress-jpeg-png",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "compress-jpeg-png",
  "name": "Compress Jpeg Png",
  "description": "Free Compress Jpeg Png online. Compress Jpeg Png allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/compress-jpeg-png",
  "extraSlugs": [
    "compress-jpeg-png"
  ],
  "category": "image"
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Compress Jpeg Png","description":"Free Compress Jpeg Png online. Compress Jpeg Png allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/compress-jpeg-png","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

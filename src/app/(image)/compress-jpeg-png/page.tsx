...
export const metadata = {
	...
	description:
		"Free Compress Jpeg Png online. Compress Jpeg Png allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"compress jpeg png, free online tool, no signup, image, compress jpeg png online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Compress Jpeg Png online. Compress Jpeg Png allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/compress-jpeg-png",
		extraSlugs: ["compress-jpeg-png"],
		category: "image",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
  ...
  description: "Free Square Photo Cropper online. Square Photo Cropper allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "square photo cropper, free online tool, no signup, image, square photo cropper online, 30tools",
  alternates: {
    canonical: "https://30tools.com/square-photo-cropper",
  },
  openGraph: {
    title: "Free Square Photo Cropper Online - No Signup | 30tools",
    description: "Free Square Photo Cropper online. Square Photo Cropper allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/square-photo-cropper",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "square-photo-cropper",
  "name": "Square Photo Cropper",
  "description": "Free Square Photo Cropper online. Square Photo Cropper allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/square-photo-cropper",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Square Photo Cropper","description":"Free Square Photo Cropper online. Square Photo Cropper allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/square-photo-cropper","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

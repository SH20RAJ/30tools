...
export const metadata = {
	...
	description:
		"Free Square Photo Cropper online. Square Photo Cropper allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"square photo cropper, free online tool, no signup, image, square photo cropper online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Square Photo Cropper online. Square Photo Cropper allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/square-photo-cropper",
		extraSlugs: ["square-photo-cropper"],
		category: "image",
	};
	const breadcrumbs = [
		{

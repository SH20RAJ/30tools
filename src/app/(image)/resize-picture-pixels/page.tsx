...
export const metadata = {
	...
	description:
		"Free Resize Picture Pixels online. Resize Picture Pixels allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"resize picture pixels, free online tool, no signup, image, resize picture pixels online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Resize Picture Pixels online. Resize Picture Pixels allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/resize-picture-pixels",
		extraSlugs: ["resize-picture-pixels"],
		category: "image",
	};
	const breadcrumbs = [
		{

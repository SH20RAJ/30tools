...
export const metadata = {
  ...
  description: "Free Resize Picture Pixels online. Resize Picture Pixels allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "resize picture pixels, free online tool, no signup, image, resize picture pixels online, 30tools",
  alternates: {
    canonical: "https://30tools.com/resize-picture-pixels",
  },
  openGraph: {
    title: "Free Resize Picture Pixels Online - No Signup | 30tools",
    description: "Free Resize Picture Pixels online. Resize Picture Pixels allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/resize-picture-pixels",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "resize-picture-pixels",
  "name": "Resize Picture Pixels",
  "description": "Free Resize Picture Pixels online. Resize Picture Pixels allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/resize-picture-pixels",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Resize Picture Pixels","description":"Free Resize Picture Pixels online. Resize Picture Pixels allows you to compress, convert, and edit images quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/resize-picture-pixels","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

...
export const metadata = {
	...
	description:
		"Audio Player - Coming Soon 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"audio player, free online tool, no signup, others, audio player online, 30tools",
	alternates: {

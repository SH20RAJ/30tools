...
export const metadata = {
	...
	description:
		"Audio Joiner - Coming Soon 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"audio joiner, free online tool, no signup, others, audio joiner online, 30tools",
	alternates: {

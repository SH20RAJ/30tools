...
export const metadata = {
	...
	description:
		"Audio Spectrum - Coming Soon 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"audio spectrum, free online tool, no signup, others, audio spectrum online, 30tools",
	alternates: {

...
export const metadata = {
  ...
  keywords: "text to speech, free online tool, no signup, audio, text to speech online, 30tools",
  alternates: {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Text to Speech","description":"Convert text to natural sounding speech audio","url":"https://30tools.com/text-to-speech","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

...
export const metadata = {
  ...
  description:
    "Professional audio trimmer with instant results. Free online tool for students, professionals, and businesses worldwide.",
  keywords:
    "audio trimmer, audio cutter, trim audio, cut audio, audio clips, mp3 trimmer",
  openGraph: {
    title: "Audio Trimmer - Trim and Cut Audio | 30tools",
  ...
  twitter: {
    ...
    description:
      "Professional audio trimmer tool. Free online processing with high-quality results. No registration required, instant results.",

...
export const metadata = {
	...
	description:
		"Free octal to binary converter tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"octal to binary converter, free online tool, no signup, developer, octal to binary converter online, 30tools",
	alternates: {
	...
	openGraph: {
		...
		siteName: "30tools",
		images: [{ url: "/api/og?title=Free%20Octal%20to%20Binary%20Converter%20Online%20-%20No%20Signup" }],
		type: "website",
	},
	twitter: {
		...
		description:
			"Free octal to binary converter tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
		images: ["/api/og?title=Free%20Octal%20to%20Binary%20Converter%20Online%20-%20No%20Signup"],
	},
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free octal to binary converter tool to process your data instantly with privacy-friendly browser-based workflows.",

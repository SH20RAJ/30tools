...
export const metadata = {
	...
	description:
		"Free Hash String Message online. Hash String Message allows you to format and convert code data quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"hash string message, free online tool, no signup, developer, hash string message online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Hash String Message online. Hash String Message allows you to format and convert code data quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/hash-string-message",
		extraSlugs: ["hash-string-message"],
		category: "developer",
	};
	const breadcrumbs = [
		{

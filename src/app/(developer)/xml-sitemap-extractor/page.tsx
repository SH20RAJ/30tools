...
export const metadata = {
	...
	description:
		"Free Xml Sitemap Extractor online. Xml Sitemap Extractor allows you to format and convert code data quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"xml sitemap extractor, free online tool, no signup, developer, xml sitemap extractor online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Xml Sitemap Extractor online. Xml Sitemap Extractor allows you to format and convert code data quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",

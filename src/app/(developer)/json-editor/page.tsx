...
export const metadata = {
	...
	description:
		"Free json editor tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"json editor, free online tool, no signup, developer, json editor online, 30tools",
	alternates: {
	...
	openGraph: {
		...
		siteName: "30tools",
		images: [{ url: "/api/og?title=Free%20JSON%20Editor%20Online%20-%20No%20Signup" }],
		type: "website",
	},
	twitter: {
		...
		description:
			"Free json editor tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
		images: ["/api/og?title=Free%20JSON%20Editor%20Online%20-%20No%20Signup"],
	},
...
export default async function ToolPage() {
	const tool = {
		...
		route: "/json-editor",
		extraSlugs: ["free-json-editor-online", "json-editor-tool"],
		popular: false,
		category: "developer",
	};
	const breadcrumbs = [
	...
	return (
		<>
			...
			>
				<ToolImplementation toolId="json-editor" />
			</ToolLayout>
		</>
	);
}

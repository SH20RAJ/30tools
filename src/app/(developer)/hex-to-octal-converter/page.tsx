...
export const metadata = {
	...
	description:
		"Free hex to octal converter tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"hex to octal converter, free online tool, no signup, developer, hex to octal converter online, 30tools",
	alternates: {
	...
	openGraph: {
		...
		siteName: "30tools",
		images: [{ url: "/api/og?title=Free%20HEX%20to%20Octal%20Converter%20Online%20-%20No%20Signup" }],
		type: "website",
	},
	twitter: {
		...
		description:
			"Free hex to octal converter tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
		images: ["/api/og?title=Free%20HEX%20to%20Octal%20Converter%20Online%20-%20No%20Signup"],
	},
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free hex to octal converter tool to process your data instantly with privacy-friendly browser-based workflows.",
	...
	return (
		<>
			...
			>
				<ToolImplementation toolId="hex-to-octal-converter" />
			</ToolLayout>
		</>
	);
}

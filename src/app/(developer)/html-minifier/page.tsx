...
export const metadata = {
	...
	description:
		"Free html minifier tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"html minifier, free online tool, no signup, developer, html minifier online, 30tools",
	alternates: {
	...
	openGraph: {
		...
		siteName: "30tools",
		images: [{ url: "/api/og?title=Free%20HTML%20Minifier%20Online%20-%20No%20Signup" }],
		type: "website",
	},
	twitter: {
		...
		description:
			"Free html minifier tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
		images: ["/api/og?title=Free%20HTML%20Minifier%20Online%20-%20No%20Signup"],
	},
...
export default async function ToolPage() {
	const tool = {
		...
		name: "HTML Minifier",
		description:
			"Free html minifier tool to process your data instantly with privacy-friendly browser-based workflows.",
		route: "/html-minifier",
		extraSlugs: ["free-html-minifier-online", "html-minifier-tool"],
		popular: false,
		category: "developer",
	};
	const breadcrumbs = [
	...
	return (
		<>
			...
			>
				<ToolImplementation toolId="html-minifier" />
			</ToolLayout>
		</>
	);
}

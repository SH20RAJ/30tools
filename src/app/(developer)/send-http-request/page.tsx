...
export const metadata = {
	...
	description:
		"Free Send Http Request online. Send Http Request allows you to format and convert code data quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"send http request, free online tool, no signup, developer, send http request online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Send Http Request online. Send Http Request allows you to format and convert code data quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/send-http-request",
		extraSlugs: ["send-http-request"],
		category: "developer",
	};
	const breadcrumbs = [
		{

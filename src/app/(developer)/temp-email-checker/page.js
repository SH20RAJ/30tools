...
export const metadata = {
  ...
  description:
    "Free temporary email checker to detect disposable and temporary email addresses. Validate emails against comprehensive blocklist and allowlist databases.",
  keywords:
    "temporary email checker, disposable email detector, temp mail checker, email validation, fake email detector, throwaway email checker",
  longTailKeywords: [
  ...
  openGraph: {
    title: "Temporary Email Checker - Detect Disposable Email Addresses",
    description:
      "Free temporary email checker to detect disposable and temporary email addresses. Validate emails against comprehensive databases.",
  ...
  twitter: {
    ...
    title: "Temporary Email Checker - Detect Disposable Email Addresses",
    description:
      "Free temporary email checker to detect disposable and temporary email addresses.",
...
const jsonLd = {
  ...
  description:
    "Professional temp email checker for developers. Process with advanced features. Free coding tool for programmers, students & professionals.",
  url: "https://30tools.com/temp-email-checker",

...
export const metadata = {
  ...
  description: "Free tsv to json converter tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "tsv to json converter, free online tool, no signup, developer, tsv to json converter online, 30tools",
  alternates: {
...
export default async function ToolPage() {
  ...
  "description": "Free tsv to json converter tool to process your data instantly with privacy-friendly browser-based workflows.",
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"TSV to JSON Converter","description":"Free tsv to json converter tool to process your data instantly with privacy-friendly browser-based workflows.","url":"https://30tools.com/tsv-to-json-converter","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />
      ...
      >
        <ToolPlaceholderPage toolId="tsv-to-json-converter" />
      </ToolLayout>
    </>
  );
}

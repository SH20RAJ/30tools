...
export const metadata = {
  ...
  description: "Free json minify tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "json minify, free online tool, no signup, developer, json minify online, 30tools",
  alternates: {
...
export default async function ToolPage() {
  ...
  "id": "json-minify",
  "name": "JSON Minify",
  "description": "Free json minify tool to process your data instantly with privacy-friendly browser-based workflows.",
  "route": "/json-minify",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"JSON Minify","description":"Free json minify tool to process your data instantly with privacy-friendly browser-based workflows.","url":"https://30tools.com/json-minify","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />
      ...
      >
        <ToolPlaceholderPage toolId="json-minify" />
      </ToolLayout>
    </>
  );
}

...
export const metadata = {
	...
	description:
		"Website Analyzer - Coming Soon 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"website analyzer, free online tool, no signup, others, website analyzer online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		extraSlugs: ["website-content-analyzer"],
		popular: false,
		category: "others",
	};
	const breadcrumbs = [

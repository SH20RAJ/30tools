...
export const metadata = {
	...
	description:
		"Free Regex Tester2 online. Regex Tester2 allows you to format and convert code data quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"regex tester2, free online tool, no signup, developer, regex tester2 online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		name: "Regex Tester2",
		description:
			"Free Regex Tester2 online. Regex Tester2 allows you to format and convert code data quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/regex-tester2",
		extraSlugs: ["regex-tester2"],
		category: "developer",
	};
	const breadcrumbs = [
		{

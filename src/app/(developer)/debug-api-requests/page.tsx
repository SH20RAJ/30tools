...
export const metadata = {
	...
	description:
		"Free Debug Api Requests online. Debug Api Requests allows you to format and convert code data quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"debug api requests, free online tool, no signup, developer, debug api requests online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Debug Api Requests online. Debug Api Requests allows you to format and convert code data quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/debug-api-requests",
		extraSlugs: ["debug-api-requests"],
		category: "developer",
	};
	const breadcrumbs = [
		{

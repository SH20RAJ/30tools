...
export const metadata = {
	...
	description:
		"Free binary to ascii converter tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"binary to ascii converter, free online tool, no signup, developer, binary to ascii converter online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free binary to ascii converter tool to process your data instantly with privacy-friendly browser-based workflows.",

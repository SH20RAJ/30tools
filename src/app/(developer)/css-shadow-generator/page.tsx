...
export const metadata = {
	...
	openGraph: { title: "Free CSS Shadow Generator Online - No Signup, Client-Side | 30tools", description: "Design perfect CSS box-shadows with our visual editor. Adjust offset, blur, spread, color, and opacity with live preview. Copy production-ready CSS code instantly.", url: "https://30tools.com/css-shadow-generator", siteName: "30tools", images: [{ url: "/og-image.jpg" }], type: "website" },
	twitter: { card: "summary_large_image", title: "Free CSS Shadow Generator Online - No Signup, Client-Side | 30tools", description: "Design perfect CSS box-shadows with our visual editor. Adjust offset, blur, spread, color, and opacity with live preview. Copy production-ready CSS code instantly.", images: ["/og-image.jpg"] },

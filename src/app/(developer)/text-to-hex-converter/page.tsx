...
export const metadata = {
  ...
  description: "Free text to hex converter tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "text to hex converter, free online tool, no signup, developer, text to hex converter online, 30tools",
  alternates: {
...
export default async function ToolPage() {
  ...
  "description": "Free text to hex converter tool to process your data instantly with privacy-friendly browser-based workflows.",
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Text to HEX Converter","description":"Free text to hex converter tool to process your data instantly with privacy-friendly browser-based workflows.","url":"https://30tools.com/text-to-hex-converter","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />
      ...
      >
        <PremiumToolPage toolId="text-to-hex-converter" />
      </ToolLayout>
    </>
  );
}

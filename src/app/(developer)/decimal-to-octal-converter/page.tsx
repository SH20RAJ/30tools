...
export const metadata = {
	...
	description:
		"Free decimal to octal converter tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"decimal to octal converter, free online tool, no signup, developer, decimal to octal converter online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free decimal to octal converter tool to process your data instantly with privacy-friendly browser-based workflows.",

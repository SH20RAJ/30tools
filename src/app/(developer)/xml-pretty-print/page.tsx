...
export const metadata = {
	...
	description:
		"Free Xml Pretty Print online. Xml Pretty Print allows you to format and convert code data quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"xml pretty print, free online tool, no signup, developer, xml pretty print online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Xml Pretty Print online. Xml Pretty Print allows you to format and convert code data quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/xml-pretty-print",
		extraSlugs: ["xml-pretty-print"],
		category: "developer",
	};
	const breadcrumbs = [
		{

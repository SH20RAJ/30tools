...
export const metadata = {
  title: 'MCP Server Generator - Model Context Protocol for Claude | 30tools',
  ...
  openGraph: {
    ...
    description: 'Generate production-ready Model Context Protocol servers for Claude AI. Perfect for #21stdev developers. Support for TypeScript, JavaScript, and Python.',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'MCP Server Generator - Build AI Tools for Claude',
    description: 'Generate production-ready Model Context Protocol servers for Claude AI. Perfect for #21stdev developers.',
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: 'Generate Model Context Protocol servers for Claude AI and other assistants',
            url: 'https://30tools.com/mcp-server',
            ...
            about: [
              {
                ...
                description: 'Open standard for connecting AI assistants to external data and tools'
              },
              {
                '@type': 'Thing',
                name: 'Claude AI',
                description: 'Anthropic AI assistant that supports MCP integration'
              },
              {
                '@type': 'Thing',
                name: '#21stdev',

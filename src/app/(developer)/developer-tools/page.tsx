...
export const metadata = {
	...
	description:
		"Developer Tools - Coming Soon 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"developer tools, free online tool, no signup, others, developer tools online, 30tools",
	alternates: {

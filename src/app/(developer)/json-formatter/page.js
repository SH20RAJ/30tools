...
export const metadata = {
	...
	description:
		"Developer tools: JSON Formatter. Format, validate, convert code/data. Fast, accurate, essential for programmers. All processing happens locally in your browser ",
	keywords: [
		"json formatter",
		"json formatter free",
		...
		faqs: [
			{
				...
				answer:
					"Yes! Our JSON Formatter is completely free to use with no hidden costs, subscriptions, or premium features. You get full access to all functionality without any limitations.",
			},
			{
			...
			},
			{
				...
				answer:
					"No registration required. You can start using JSON Formatter immediately without creating an account or providing any personal information.",
			},
			{
			...
			},
			{
				...
				answer:
					"Yes, JSON Formatter is fully responsive and works perfectly on smartphones, tablets, and desktop computers with any modern browser.",
			},
			{
				question: "What file formats does JSON Formatter support?",
				answer:
					"JSON Formatter supports all major formats for its category. Upload common file types and get converted results in standard output formats compatible with any device or software.",
			},
		],
		howTo: {
			...
			<main className="container mx-auto px-4 py-8">
				...
				<div className="text-center mb-12">
					...
					<p className="text-xl text-muted-foreground mb-6">
						The fastest way to format large JSON files online. Our free tool
						provides pretty print JSON with syntax highlighting and instant
						error detection. Secure and 100% private.
					</p>

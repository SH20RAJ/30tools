...
export const metadata = {
	...
	description:
		"Format, validate, and beautify JSON data 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"json formatter, free online tool, no signup, developer, json formatter online, 30tools",
	alternates: {
	...
	openGraph: {
		...
		siteName: "30tools",
		images: [{ url: "/api/og?title=Free%20JSON%20Formatter%20Online%20-%20No%20Signup" }],
		type: "website",
	},
	twitter: {
		...
		description:
			"Format, validate, and beautify JSON data 100% free, no signup required, and privacy-focused processing in your browser.",
		images: ["/api/og?title=Free%20JSON%20Formatter%20Online%20-%20No%20Signup"],
	},

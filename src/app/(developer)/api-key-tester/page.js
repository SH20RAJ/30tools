...
export const metadata = {
	...
	description:
		"Securely test API keys for OpenAI, Stripe, and 30+ other services directly in your browser or terminal. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"api key tester, free online tool, no signup, developer, api key tester online, 30tools",
	alternates: {

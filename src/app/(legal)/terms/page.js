...
export const metadata = {
  ...
  description:
    "Terms of Service for using 30tools.com free online tools. Learn about our usage policies, limitations, and user responsibilities.",
  keywords: [
    "terms",
    "terms online",
    "free terms",
  ...
  openGraph: {
    title: "Terms - Free Online Tool | Professional Results",
    description:
      "Professional terms tool. Free online processing with high-quality results. No registration required, instant results.",
        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <div className="prose prose-gray max-w-none space-y-6">
            <section>
              ...
              <p className="mb-4">
                By accessing and using 30tools.com, you accept and agree to be
            ...
            <section>
              ...
              <p className="mb-4">
                30tools.com provides free online tools for file processing
              ...
              <p className="mb-4">
                All processing is performed client-side in your browser for
            ...
            <section>
              ...
              <p className="mb-4">
                The 30tools.com website, including its design, code, and
                content, is protected by copyright and other intellectual
                property laws. Users retain full ownership of their uploaded
                files and processed results.
              </p>
              <ul className="list-disc pl-6 mb-4">
                <li>We do not claim ownership of your files</li>
                <li>You retain all rights to your processed content</li>
                <li>
                  Our tools and website design are our intellectual property
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="mb-4">
                30tools.com is provided on an &quot;as is&quot; and &quot;as
            ...
            <section>
              ...
              <p className="mb-4">
                In no event shall 30tools.com or its suppliers be liable for any

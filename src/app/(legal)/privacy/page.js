...
export const metadata = {
  ...
  description: "Learn how 30tools.com protects your privacy. We process all files locally in your browser and never store your data on our servers.",
  keywords: [
    "privacy",
    "privacy online",
    "free privacy",
  ...
  openGraph: {
    title: "Privacy - Free Online Tool | Professional Results",
    description: "Professional privacy tool. Free online processing with high-quality results. No registration required, instant results.",
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="prose prose-gray max-w-none space-y-6">
          ...
          <section>
            ...
            <p className="mb-4">You can disable cookies in your browser settings, but some features may not work properly.</p>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              30tools.com is operated from the United States. By using our services, you consent to the processing of your data in the United States in accordance with this Privacy Policy.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              We may update this Privacy Policy from time to time. We will notify users of any material changes by posting the updated policy on this page.
            </p>
          </section>

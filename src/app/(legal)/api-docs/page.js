...
export const metadata = {
  ...
  description:
    "Professional api docs with instant results. Free online tool for students, professionals, and businesses worldwide. Used by millions worldwide for reliable, fast results.",
  keywords:
    "API, documentation, developer, integration, search suggestions, REST API",
  robots: { index: true, follow: true },

  openGraph: {
    title: "Api Docs - Free Online Tool | Professional Results",
    description:
      "Professional api docs tool. Free online processing with high-quality results. No registration required, instant results.",
        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
          <div className="mb-6">
            ...
            <p className="text-muted-foreground">
              Integrate 30tools.com into your applications with our simple APIs.
            </p>
          </div>
    ...
    "image minimizer"
          ...
          <Card className="mb-8">
            <CardHeader>
              ...
              <CardDescription>Fair usage policies and limits</CardDescription>
            </CardHeader>
            <CardContent>
...
print_r($suggestions); // Array of suggestions`}
          ...
          <Card>
            ...
            <CardContent className="text-center">
              <p className="mb-4">
                Need higher rate limits, custom endpoints, or integration
                support?
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button variant="outline">View Examples on GitHub</Button>
              </div>
            </CardContent>
          </Card>
        </div>

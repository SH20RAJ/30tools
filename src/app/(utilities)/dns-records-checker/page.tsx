...
export const metadata = {
	...
	description:
		"Free dns records checker tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"dns records checker, free online tool, no signup, utilities, dns records checker online, 30tools",
	alternates: {
	...
	openGraph: {
		...
		siteName: "30tools",
		images: [{ url: "/api/og?title=Free%20DNS%20Records%20Checker%20Online%20-%20No%20Signup" }],
		type: "website",
	},
	twitter: {
		...
		description:
			"Free dns records checker tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
		images: ["/api/og?title=Free%20DNS%20Records%20Checker%20Online%20-%20No%20Signup"],
	},
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free dns records checker tool to process your data instantly with privacy-friendly browser-based workflows.",
		route: "/dns-records-checker",
		extraSlugs: ["free-dns-records-checker-online", "dns-records-checker-tool"],
		popular: false,
		category: "utilities",
	};
	const breadcrumbs = [
	...
	return (
		<>
			...
			>
				<ToolImplementation toolId="dns-records-checker" />
			</ToolLayout>
		</>
	);
}

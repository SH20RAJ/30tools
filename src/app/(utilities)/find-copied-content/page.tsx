...
export const metadata = {
	...
	description:
		"Free Find Copied Content online. Find Copied Content allows you to perform online tasks quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"find copied content, free online tool, no signup, others, find copied content online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		extraSlugs: ["find-copied-content"],
		category: "others",
	};
	const breadcrumbs = [
		{

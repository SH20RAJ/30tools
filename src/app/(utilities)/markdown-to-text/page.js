...
export const metadata = {
	...
	description:
		"Clean up AI-generated content from ChatGPT, Claude, and Grok. Convert Markdown into clean, readable plain text instantly. Perfect for emails and social sharing. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"ai-to-text converter (markdown stripper), free online tool, no signup, text, ai-to-text converter (markdown stripper) online, 30tools",
	alternates: {

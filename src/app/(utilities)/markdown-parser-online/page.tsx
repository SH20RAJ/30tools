...
export const metadata = {
	...
	description:
		"Free Markdown Parser Online online. Markdown Parser Online allows you to perform online tasks quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"markdown parser online, free online tool, no signup, others, markdown parser online online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		extraSlugs: ["markdown-parser-online"],
		category: "others",
	};
	const breadcrumbs = [
		{

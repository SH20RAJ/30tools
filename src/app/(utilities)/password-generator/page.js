...
export const metadata = {
  ...
  description: "Create strong, secure passwords instantly with customizable settings. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "password generator, free online tool, no signup, utilities, password generator online, 30tools",
  alternates: {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Password Generator","description":"Create strong, secure passwords instantly with customizable settings.","url":"https://30tools.com/password-generator","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

...
export const metadata = {
	...
	description:
		"Free utility tools: Password Generator. Convert units, compress files, shorten URLs. Fast, accurate, and easy to use. All processing happens locally in your bro",
	keywords: [
		"password generator",
...
export default async function PasswordGeneratorPage({ searchParams }) {
	...
	const toolData = {
		...
		description:
			"Create strong, secure passwords instantly with customizable settings.",
		category: "utilities",
		...
		faqs: [
			{
				...
				answer:
					"Yes! Our Password Generator is completely free to use with no hidden costs, subscriptions, or premium features. You get full access to all functionality without any limitations.",
			},
			{
			...
			},
			{
				...
				answer:
					"No registration required. You can start using Password Generator immediately without creating an account or providing any personal information.",
			},
			{
			...
			},
			{
				...
				answer:
					"Yes, Password Generator is fully responsive and works perfectly on smartphones, tablets, and desktop computers with any modern browser.",
			},
			{
				question: "What file formats does Password Generator support?",
				answer:
					"Password Generator supports all major formats for its category. Upload common file types and get converted results in standard output formats compatible with any device or software.",
			},
		],
		howTo: {

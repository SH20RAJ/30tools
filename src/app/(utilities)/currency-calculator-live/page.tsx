...
export const metadata = {
	...
	description:
		"Free Currency Calculator Live online. Currency Calculator Live allows you to perform helpful calculations quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"currency calculator live, free online tool, no signup, utilities, currency calculator live online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Currency Calculator Live online. Currency Calculator Live allows you to perform helpful calculations quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/currency-calculator-live",
		extraSlugs: ["currency-calculator-live"],
		category: "utilities",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
	...
	description:
		"Free convert vtt to srt tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"convert vtt to srt, free online tool, no signup, utilities, convert vtt to srt online, 30tools",
	alternates: {
	...
	openGraph: {
		...
		siteName: "30tools",
		images: [{ url: "/api/og?title=Free%20Convert%20VTT%20to%20SRT%20Online%20-%20No%20Signup" }],
		type: "website",
	},
	twitter: {
		...
		description:
			"Free convert vtt to srt tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
		images: ["/api/og?title=Free%20Convert%20VTT%20to%20SRT%20Online%20-%20No%20Signup"],
	},
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free convert vtt to srt tool to process your data instantly with privacy-friendly browser-based workflows.",
		route: "/convert-vtt-to-srt",
		extraSlugs: ["free-convert-vtt-to-srt-online", "convert-vtt-to-srt-tool"],
		popular: false,
		category: "utilities",
	};
	const breadcrumbs = [
	...
	return (
		<>
			...
			>
				<ToolImplementation toolId="convert-vtt-to-srt" />
			</ToolLayout>
		</>
	);
}

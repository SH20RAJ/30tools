...
export const metadata = {
	...
	description:
		"Free speed converter tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"speed converter, free online tool, no signup, utilities, speed converter online, 30tools",
	alternates: {
	...
	openGraph: {
		...
		siteName: "30tools",
		images: [{ url: "/api/og?title=Free%20Speed%20Converter%20Online%20-%20No%20Signup" }],
		type: "website",
	},
	twitter: {
		...
		description:
			"Free speed converter tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
		images: ["/api/og?title=Free%20Speed%20Converter%20Online%20-%20No%20Signup"],
	},
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free speed converter tool to process your data instantly with privacy-friendly browser-based workflows.",
		route: "/speed-converter",
		extraSlugs: ["free-speed-converter-online", "speed-converter-tool"],
		popular: false,
		category: "utilities",
	};
	const breadcrumbs = [
	...
	return (
		<>
			...
			>
				<ToolImplementation toolId="speed-converter" />
			</ToolLayout>
		</>
	);
}

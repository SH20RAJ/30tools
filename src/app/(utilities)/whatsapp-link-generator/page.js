...
export const metadata = {
  ...
  description:
    "Generate WhatsApp click-to-chat links with custom messages. Create direct WhatsApp links for easy customer contact and support.",
  keywords: [
...
const jsonLd = {
  ...
  description:
    "Free whatsapp link generator tool with professional results. No registration required, instant processing, secure & unlimited use.",
  url: "https://30tools.com/whatsapp-link-generator",

...
export const metadata = {
	...
	openGraph: {
		...
		siteName: "30tools",
		images: [{ url: "/api/og?title=Free%20QR%20Code%20Decoder%20Online%20-%20No%20Signup" }],
		type: "website",
	},
	twitter: {
		...
		description:
			"Free qr code decoder tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
		images: ["/api/og?title=Free%20QR%20Code%20Decoder%20Online%20-%20No%20Signup"],
	},
...
export default async function ToolPage() {
	...
	return (
		<>
			...
			>
				<ToolImplementation toolId="qr-code-decoder" />
			</ToolLayout>
		</>
	);
}

...
export const metadata = {
	...
	description:
		"Free length converter tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"length converter, free online tool, no signup, utilities, length converter online, 30tools",
	alternates: {
	...
	openGraph: {
		...
		siteName: "30tools",
		images: [{ url: "/api/og?title=Free%20Length%20Converter%20Online%20-%20No%20Signup" }],
		type: "website",
	},
	twitter: {
		...
		description:
			"Free length converter tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
		images: ["/api/og?title=Free%20Length%20Converter%20Online%20-%20No%20Signup"],
	},
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free length converter tool to process your data instantly with privacy-friendly browser-based workflows.",
	...
	return (
		<>
			...
			>
				<ToolImplementation toolId="length-converter" />
			</ToolLayout>
		</>
	);
}

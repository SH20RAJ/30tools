...
export const metadata = {
	...
	description:
		"Easily build campaign URLs with UTM parameters for Google Analytics tracking. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"utm builder, free online tool, no signup, utilities, utm builder online, 30tools",
	alternates: {
	...
	openGraph: {
		...
		siteName: "30tools",
		images: [{ url: "/api/og?title=Free%20UTM%20Builder%20Online%20-%20No%20Signup" }],
		type: "website",
	},
	twitter: {
		...
		description:
			"Easily build campaign URLs with UTM parameters for Google Analytics tracking. 100% free, no signup required, and privacy-focused processing in your browser.",
		images: ["/api/og?title=Free%20UTM%20Builder%20Online%20-%20No%20Signup"],
	},

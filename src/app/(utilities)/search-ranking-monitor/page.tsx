...
export const metadata = {
	...
	description:
		"Free Search Ranking Monitor online. Search Ranking Monitor allows you to perform online tasks quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"search ranking monitor, free online tool, no signup, others, search ranking monitor online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		extraSlugs: ["local-search-ranking", "search-ranking-monitor"],
		category: "others",
	};
	const breadcrumbs = [
		{

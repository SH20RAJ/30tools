...
export const metadata = {
  ...
  description: "Free Other Tools online tool. Fast and secure. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "other tools, free online tool, no signup, utilities, other tools online, 30tools",
  alternates: {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Other Tools","description":"Free Other Tools online tool. Fast and secure.","url":"https://30tools.com/other-tools","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

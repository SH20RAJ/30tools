...
export const metadata = {
	...
	description:
		"Free Check Html Syntax online. Check Html Syntax allows you to perform online tasks quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"check html syntax, free online tool, no signup, others, check html syntax online, 30tools",
	alternates: {

...
export const metadata = {
	...
	description:
		"Free Get Emails From String online. Get Emails From String allows you to perform online tasks quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"get emails from string, free online tool, no signup, others, get emails from string online, 30tools",
	alternates: {

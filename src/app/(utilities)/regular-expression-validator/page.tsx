...
export const metadata = {
	...
	description:
		"Free Regular Expression Validator online. Regular Expression Validator allows you to perform online tasks quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"regular expression validator, free online tool, no signup, others, regular expression validator online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		extraSlugs: ["regular-expression-validator"],
		category: "others",
	};
	const breadcrumbs = [
		{

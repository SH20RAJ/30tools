...
export const metadata = {
	...
	description:
		"Free facebook id finder tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"facebook id finder, free online tool, no signup, utilities, facebook id finder online, 30tools",
	alternates: {
	...
	openGraph: {
		...
		siteName: "30tools",
		images: [{ url: "/api/og?title=Free%20Facebook%20ID%20Finder%20Online%20-%20No%20Signup" }],
		type: "website",
	},
	twitter: {
		...
		description:
			"Free facebook id finder tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
		images: ["/api/og?title=Free%20Facebook%20ID%20Finder%20Online%20-%20No%20Signup"],
	},
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free facebook id finder tool to process your data instantly with privacy-friendly browser-based workflows.",
		route: "/facebook-id-finder",
		extraSlugs: ["free-facebook-id-finder-online", "facebook-id-finder-tool"],
		popular: false,
		category: "utilities",
	};
	const breadcrumbs = [
	...
	return (
		<>
			...
			>
				<ToolImplementation toolId="facebook-id-finder" />
			</ToolLayout>
		</>
	);
}

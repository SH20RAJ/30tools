...
export const metadata = {
	...
	description:
		"Free Test Structured Data online. Test Structured Data allows you to perform online tasks quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"test structured data, free online tool, no signup, others, test structured data online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		extraSlugs: ["google-structured-data-helper", "test-structured-data"],
		category: "others",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
	...
	description:
		"Free Human Readable Time online. Human Readable Time allows you to perform helpful calculations quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"human readable time, free online tool, no signup, utilities, human readable time online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Human Readable Time online. Human Readable Time allows you to perform helpful calculations quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/human-readable-time",
		extraSlugs: ["human-readable-time"],
		category: "utilities",
	};
	const breadcrumbs = [
		{

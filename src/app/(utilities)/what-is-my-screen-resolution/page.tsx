...
export const metadata = {
  ...
  description: "Free what is my screen resolution tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "what is my screen resolution, free online tool, no signup, utilities, what is my screen resolution online, 30tools",
  alternates: {
...
export default async function ToolPage() {
  ...
  {
    "name": "What Is My Screen Resolution",
    "url": "/what-is-my-screen-resolution"
  }
];
  const relatedTools = [
  {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"What Is My Screen Resolution","description":"Free what is my screen resolution tool to process your data instantly with privacy-friendly browser-based workflows.","url":"https://30tools.com/what-is-my-screen-resolution","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />
      ...
      >
        <ToolPlaceholderPage toolId="what-is-my-screen-resolution" />
      </ToolLayout>
    </>
  );
}

...
export const metadata = {
	...
	keywords:
		"what is my screen resolution, free online tool, no signup, utilities, what is my screen resolution online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free what is my screen resolution tool to process your data instantly with privacy-friendly browser-based workflows.",

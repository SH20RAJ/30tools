...
export default async function ToolPage() {
	const tool = {
		...
		name: "About",
		description:
			"Free About online. About allows you to perform online tasks quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/about",
		extraSlugs: ["about"],
		category: "others",
	};

...
export const metadata = {
  ...
  description:
    "Calculate text size in bytes, characters, words, and lines. Analyze text length, file size, and get detailed text statistics with our calculator.",
  keywords: [
...
const jsonLd = {
  ...
  description:
    "Free text size calculator tool with professional results. No registration required, instant processing, secure & unlimited use.",
  url: "https://30tools.com/text-size-calculator",

...
export const metadata = {
  ...
  description: "Essential utility tools for unit conversion, file compression, and URL shortening. Free online productivity utilities.",
  keywords: "utility tools, unit converter, zip creator, url shortener, free utility tools online",
  openGraph: {
    title: "Utility Tools - Free Online Utilities",
    description: "Essential utility tools for unit conversion, file compression, and URL shortening.",

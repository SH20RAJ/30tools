...
export const metadata = {
  ...
  description: "Shorten long URLs for easier sharing 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "url shortener, free online tool, no signup, utilities, url shortener online, 30tools",
  alternates: {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"URL Shortener","description":"Shorten long URLs for easier sharing","url":"https://30tools.com/url-shortener","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

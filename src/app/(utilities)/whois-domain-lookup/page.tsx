...
export const metadata = {
	...
	description:
		"Free whois domain lookup tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"whois domain lookup, free online tool, no signup, utilities, whois domain lookup online, 30tools",
	alternates: {
	...
	openGraph: {
		...
		siteName: "30tools",
		images: [{ url: "/api/og?title=Free%20Whois%20Domain%20Lookup%20Online%20-%20No%20Signup" }],
		type: "website",
	},
	twitter: {
		...
		description:
			"Free whois domain lookup tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
		images: ["/api/og?title=Free%20Whois%20Domain%20Lookup%20Online%20-%20No%20Signup"],
	},
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free whois domain lookup tool to process your data instantly with privacy-friendly browser-based workflows.",
		route: "/whois-domain-lookup",
		extraSlugs: ["free-whois-domain-lookup-online", "whois-domain-lookup-tool"],
		popular: false,
		category: "utilities",
	};
	const breadcrumbs = [
	...
	return (
		<>
			...
			>
				<ToolImplementation toolId="whois-domain-lookup" />
			</ToolLayout>
		</>
	);
}

...
export const metadata = {
  ...
  description:
    "Free calculator with instant accurate results. Process online calculator for students, professionals & everyone. Easy to use, mobile-friendly interface.",
  keywords:
    "calculator, scientific calculator, advanced calculator, math calculator, trigonometry, logarithm",
  openGraph: {
    title: "Advanced Calculator - Scientific Calculator | 30tools",

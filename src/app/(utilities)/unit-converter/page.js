...
export const metadata = {
    ...
    twitter: {
        ...
        title: "Free Unit Converter Online - All Units of Measurement",
        description: "Convert units of measurement instantly. Metric to Imperial conversions and more.",
...
export default function UnitConverterPage() {
    const jsonLd = {
        ...
        "description": "Professional unit converter supporting length, weight, temperature, volume, area, speed, and energy conversions. Essential for students, engineers, and professionals.",
        "url": "https://30tools.com/unit-converter",

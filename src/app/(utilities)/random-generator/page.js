...
export const metadata = {
  ...
  openGraph: {
    title: "Random Generator - Advanced Random Data Creator | 30tools",
    description: "Generate random numbers, passwords, strings, UUIDs, colors, and more. Advanced random data generator with customizable options for developers and testers.",
  ...
  twitter: {
    ...
    description: "Generate random numbers, passwords, strings, UUIDs, colors & more! Advanced random data generator for developers & testers. 🎲",
...
export default function RandomGeneratorPage() {
  const jsonLd = {
    ...
    "description": "Generate random numbers, passwords, strings, UUIDs, colors, and more. Advanced random data generator with customizable options for developers, testers, and general users with cryptographically secure algorithms.",
    "url": "https://30tools.com/random-generator",
    ...
    "keywords": "random generator, data generation, testing tools, developer utilities, secure random"
  };

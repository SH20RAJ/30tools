...
export const metadata = {
	...
	description:
		"Free parts per converter tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"parts per converter, free online tool, no signup, utilities, parts per converter online, 30tools",
	alternates: {
	...
	openGraph: {
		...
		siteName: "30tools",
		images: [{ url: "/api/og?title=Free%20Parts%20Per%20Converter%20Online%20-%20No%20Signup" }],
		type: "website",
	},
	twitter: {
		...
		description:
			"Free parts per converter tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
		images: ["/api/og?title=Free%20Parts%20Per%20Converter%20Online%20-%20No%20Signup"],
	},
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free parts per converter tool to process your data instantly with privacy-friendly browser-based workflows.",
		route: "/parts-per-converter",
		extraSlugs: ["free-parts-per-converter-online", "parts-per-converter-tool"],
		popular: false,
		category: "utilities",
	};
	const breadcrumbs = [
	...
	return (
		<>
			...
			>
				<ToolImplementation toolId="parts-per-converter" />
			</ToolLayout>
		</>
	);
}

...
export const metadata = {
	...
	description:
		"Free power converter tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"power converter, free online tool, no signup, utilities, power converter online, 30tools",
	alternates: {
	...
	openGraph: {
		...
		siteName: "30tools",
		images: [{ url: "/api/og?title=Free%20Power%20Converter%20Online%20-%20No%20Signup" }],
		type: "website",
	},
	twitter: {
		...
		description:
			"Free power converter tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
		images: ["/api/og?title=Free%20Power%20Converter%20Online%20-%20No%20Signup"],
	},
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free power converter tool to process your data instantly with privacy-friendly browser-based workflows.",
		route: "/power-converter",
		extraSlugs: ["free-power-converter-online", "power-converter-tool"],
		popular: false,
		category: "utilities",
	};
	const breadcrumbs = [
	...
	return (
		<>
			...
			>
				<ToolImplementation toolId="power-converter" />
			</ToolLayout>
		</>
	);
}

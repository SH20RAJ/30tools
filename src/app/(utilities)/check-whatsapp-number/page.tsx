...
export const metadata = {
	...
	description:
		"Free Check Whatsapp Number online. Check Whatsapp Number allows you to perform online tasks quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"check whatsapp number, free online tool, no signup, others, check whatsapp number online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		extraSlugs: ["check-whatsapp-number"],
		category: "others",
	};
	const breadcrumbs = [
		{

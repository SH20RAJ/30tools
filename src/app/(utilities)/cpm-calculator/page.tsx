...
export const metadata = {
	...
	openGraph: {
		...
		siteName: "30tools",
		images: [{ url: "/api/og?title=Free%20CPM%20Calculator%20Online%20-%20No%20Signup" }],
		type: "website",
	},
	twitter: {
		...
		description:
			"Free cpm calculator tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
		images: ["/api/og?title=Free%20CPM%20Calculator%20Online%20-%20No%20Signup"],
	},
...
export default async function ToolPage() {
	...
	return (
		<>
			...
			>
				<ToolImplementation toolId="cpm-calculator" />
			</ToolLayout>
		</>
	);
}

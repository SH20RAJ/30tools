...
export const metadata = {
	...
	description:
		"Free Serp Tracker Bulk online. Serp Tracker Bulk allows you to optimize your website quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"serp tracker bulk, free online tool, no signup, seo, serp tracker bulk online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Serp Tracker Bulk online. Serp Tracker Bulk allows you to optimize your website quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/serp-tracker-bulk",
		extraSlugs: ["serp-tracker-bulk", "serp-tracker-pro"],
		category: "seo",
	};
	const breadcrumbs = [
		{

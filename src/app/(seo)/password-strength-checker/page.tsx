...
export const metadata = {
	...
	description:
		"Free Password Strength Checker online. Password Strength Checker allows you to optimize your website quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"password strength checker, free online tool, no signup, seo, password strength checker online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Password Strength Checker online. Password Strength Checker allows you to optimize your website quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",

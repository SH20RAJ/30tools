...
export const metadata = {
	...
	description:
		"Free Html Error Checker online. Html Error Checker allows you to optimize your website quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"html error checker, free online tool, no signup, seo, html error checker online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Html Error Checker online. Html Error Checker allows you to optimize your website quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/html-error-checker",
		extraSlugs: ["html-error-checker"],
		category: "seo",
	};
	const breadcrumbs = [
		{

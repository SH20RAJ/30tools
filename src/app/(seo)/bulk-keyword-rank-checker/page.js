...
export const metadata = {
  ...
  keywords:
    "bulk keyword rank checker, keyword position tracker, google rank checker, serp checker, rank tracking tool, keyword ranking tool, google ranking checker, bulk rank tracker online free, check google rankings for multiple keywords, keyword position checker free",
  openGraph: {
  ...
  twitter: {
    ...
    title: "Free Bulk Keyword Rank Checker - Track 500+ Keywords at Once",
    description:
      "Check Google rankings for multiple keywords at once. Perfect for SEO professionals and agencies.",

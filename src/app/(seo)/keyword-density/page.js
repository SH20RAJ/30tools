...
export const metadata = {
  ...
  description:
    "Professional keyword density for Process. Free SEO analysis and optimization tool. Improve search rankings with data-driven insights.",
  keywords:
    "keyword density, keyword frequency, seo analysis, keyword checker, content analysis, text analysis",
  openGraph: {
    title: "Keyword Density Checker - Analyze Text Keywords | 30tools",

...
export const metadata = {
	...
	description:
		"Free Keyword Ideas Bing online. Keyword Ideas Bing allows you to optimize your website quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"keyword ideas bing, free online tool, no signup, seo, keyword ideas bing online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Keyword Ideas Bing online. Keyword Ideas Bing allows you to optimize your website quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/keyword-ideas-bing",
		extraSlugs: ["keyword-ideas-bing"],
		category: "seo",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
	...
	description:
		"Free Local Business Seo online. Local Business Seo allows you to optimize your website quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"local business seo, free online tool, no signup, seo, local business seo online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Local Business Seo online. Local Business Seo allows you to optimize your website quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/local-business-seo",
		extraSlugs: ["local-business-seo"],
		category: "seo",
	};
	const breadcrumbs = [
		{

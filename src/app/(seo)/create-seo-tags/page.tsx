...
export const metadata = {
	...
	description:
		"Free Create Seo Tags online. Create Seo Tags allows you to optimize your website quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"create seo tags, free online tool, no signup, seo, create seo tags online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Create Seo Tags online. Create Seo Tags allows you to optimize your website quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/create-seo-tags",
		extraSlugs: ["create-seo-tags"],
		category: "seo",
	};
	const breadcrumbs = [
		{

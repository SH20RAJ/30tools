...
export const metadata = {
	...
	description:
		"Free Mobile Seo Checker online. Mobile Seo Checker allows you to optimize your website quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"mobile seo checker, free online tool, no signup, seo, mobile seo checker online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Mobile Seo Checker online. Mobile Seo Checker allows you to optimize your website quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",

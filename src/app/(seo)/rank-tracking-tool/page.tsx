...
export const metadata = {
	...
	description:
		"Free Rank Tracking Tool online. Rank Tracking Tool allows you to optimize your website quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"rank tracking tool, free online tool, no signup, seo, rank tracking tool online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Rank Tracking Tool online. Rank Tracking Tool allows you to optimize your website quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/rank-tracking-tool",
		extraSlugs: ["rank-tracking-tool"],
		category: "seo",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
	...
	description:
		"Free Seo Keyword Generator online. Seo Keyword Generator allows you to optimize your website quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"seo keyword generator, free online tool, no signup, seo, seo keyword generator online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Seo Keyword Generator online. Seo Keyword Generator allows you to optimize your website quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/seo-keyword-generator",
		extraSlugs: ["seo-keyword-generator"],
		category: "seo",
	};
	const breadcrumbs = [
		{

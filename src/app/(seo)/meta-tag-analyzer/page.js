...
export const metadata = {
	...
	description:
		"Analyze and audit meta tags across your website. Check title tags, meta descriptions, Open Graph tags, and other SEO metadata. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"meta tag analyzer, free online tool, no signup, seo, meta tag analyzer online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Analyze and audit meta tags across your website. Check title tags, meta descriptions, Open Graph tags, and other SEO metadata.",
		route: "/meta-tag-analyzer",
		extraSlugs: ["complexity-analyzer"],
		popular: true,
		category: "seo",
	};
	const breadcrumbs = [

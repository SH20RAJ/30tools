...
export const metadata = {
  ...
  description:
    "Professional SEO tools for meta tag generation and QR code creation. Free online SEO optimization utilities.",
  keywords:
    "seo tools, meta tags generator, qr code generator, free seo tools online",
  openGraph: {
    title: "SEO Tools - Free Online SEO Utilities",
    description:
      "Professional SEO tools for meta tag generation and QR code creation.",

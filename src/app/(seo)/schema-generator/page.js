...
export const metadata = {
	...
	description:
		"Generate JSON-LD schema markup for rich snippets 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"schema markup generator, free online tool, no signup, seo, schema markup generator online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		extraSlugs: ["schema-markup-builder", "validate-schema-markup"],
		popular: true,
		category: "seo",
	};
	const breadcrumbs = [

...
export const metadata = {
	...
	description:
		"Free Serp Snippet Optimizer online. Serp Snippet Optimizer allows you to optimize your website quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"serp snippet optimizer, free online tool, no signup, seo, serp snippet optimizer online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Serp Snippet Optimizer online. Serp Snippet Optimizer allows you to optimize your website quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/serp-snippet-optimizer",
		extraSlugs: ["serp-snippet-optimizer"],
		category: "seo",
	};
	const breadcrumbs = [
		{

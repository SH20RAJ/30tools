...
export const metadata = {
	...
	description:
		"SEO tools: Broken Link Checker. Analyze, optimize, improve search rankings. Free, professional, instant results. All processing happens locally in your browser ",
	keywords: [
		"broken link checker",
				...
				<div className="max-w-6xl mx-auto">
					...
					<div className="text-center mb-12">
						...
						<p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
							Find and fix broken links on your website. Dead links hurt SEO and
							user experience - find them all with our free tool.
						</p>

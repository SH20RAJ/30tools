...
export const metadata = {
	...
	description:
		"Free Free Keyword Finder online. Free Keyword Finder allows you to optimize your website quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"free keyword finder, free online tool, no signup, seo, free keyword finder online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Free Keyword Finder online. Free Keyword Finder allows you to optimize your website quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/free-keyword-finder",
		extraSlugs: ["free-keyword-finder", "google-keyword-planner-free"],
		category: "seo",
	};
	const breadcrumbs = [
		{

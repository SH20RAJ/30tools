...
export const metadata = {
	...
	description:
		"Free Snippet Optimization online. Snippet Optimization allows you to optimize your website quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"snippet optimization, free online tool, no signup, seo, snippet optimization online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Snippet Optimization online. Snippet Optimization allows you to optimize your website quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/snippet-optimization",
		extraSlugs: ["snippet-optimization"],
		category: "seo",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
  ...
  description:
    "Professional xml sitemap extractor for Process. Free SEO analysis and optimization tool. Improve search rankings with data-driven insights.",
  keywords:
    "xml sitemap extractor, sitemap url extractor, sitemap parser, sitemap analyzer, xml parser tool, sitemap crawler, url list extractor, sitemap reader, extract urls from xml sitemap, sitemap url list generator",
  openGraph: {
    title: "Free XML Sitemap Extractor - Extract URLs to CSV, TXT, Excel",
    description:
      "Extract all URLs from XML sitemaps and export them in various formats. Perfect for SEO audits and competitor research.",
  ...
  twitter: {
    ...
    title: "Free XML Sitemap Extractor - Extract URLs to CSV, TXT, Excel",
    description:
      "Extract all URLs from XML sitemaps and export them in various formats. Perfect for SEO audits.",

...
export const metadata = {
  ...
  description:
    "Professional title rewrite checker for Process. Free SEO analysis and optimization tool. Improve search rankings with data-driven insights.",
  keywords:
    "title rewrite checker, google title rewrite, serp title checker, google title change, title tag rewrite, google title modification, serp snippet preview, title optimization tool, google title rewrite checker free",
  openGraph: {
    title: "Title Rewrite Checker - See How Google Changes Your Titles",
    description:
  ...
  twitter: {
    ...
    title: "Title Rewrite Checker - See How Google Changes Your Titles",
    description:
      "Check if Google rewrites your page titles in search results. Perfect for SEO optimization.",

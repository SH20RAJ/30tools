...
export const metadata = {
	...
	description:
		"Free Bing Seo Keywords online. Bing Seo Keywords allows you to optimize your website quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"bing seo keywords, free online tool, no signup, seo, bing seo keywords online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Bing Seo Keywords online. Bing Seo Keywords allows you to optimize your website quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/bing-seo-keywords",
		extraSlugs: ["bing-seo-keywords", "seo-keywords-google"],
		category: "seo",
	};
	const breadcrumbs = [
		{

...
export const metadata = generateToolMetadata("backlink-checker", "seo", {
	title: "Backlink Checker | Free Inbound Link Analysis & SEO Audit | 30Tools",
	description:
		"Analyze any website's backlink profile. Check referring domains, dofollow/nofollow links, anchor text distribution, and domain authority. Free, instant, no signup required.",
	keywords: [
		"backlink checker",
...
export default async function BacklinkCheckerPage({ searchParams }) {
	...
	const toolData = getToolData("backlink-checker", "seo");

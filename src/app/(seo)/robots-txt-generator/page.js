...
export const metadata = {
	...
	description:
		"Generate robots.txt files for website crawling control 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"robots.txt generator, free online tool, no signup, seo, robots.txt generator online, 30tools",
	alternates: {
			...
			<script
				...
				dangerouslySetInnerHTML={{
					__html: JSON.stringify({
						...
						name: "Robots.txt Generator",
						description:
							"Generate robots.txt files for website crawling control",
						url: "https://30tools.com/robots-txt-generator",

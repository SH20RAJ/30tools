...
export const metadata = {
  ...
  description: "Free Configurable Password Tool online. Configurable Password Tool allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "configurable password tool, free online tool, no signup, generators, configurable password tool online, 30tools",
  alternates: {
    canonical: "https://30tools.com/configurable-password-tool",
  },
  openGraph: {
    title: "Free Configurable Password Tool Online - No Signup | 30tools",
    description: "Free Configurable Password Tool online. Configurable Password Tool allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/configurable-password-tool",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "configurable-password-tool",
  "name": "Configurable Password Tool",
  "description": "Free Configurable Password Tool online. Configurable Password Tool allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/configurable-password-tool",
  "extraSlugs": [
  ...
  {
    "name": "Configurable Password Tool",
    "url": "/configurable-password-tool"
  }
];
  const relatedTools = [
  {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Configurable Password Tool","description":"Free Configurable Password Tool online. Configurable Password Tool allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/configurable-password-tool","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

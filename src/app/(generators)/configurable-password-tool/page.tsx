...
export const metadata = {
	...
	description:
		"Free Configurable Password Tool online. Configurable Password Tool allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"configurable password tool, free online tool, no signup, generators, configurable password tool online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Configurable Password Tool online. Configurable Password Tool allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/configurable-password-tool",
		extraSlugs: ["configurable-password-tool"],
		category: "generators",
	};
	const breadcrumbs = [
		{

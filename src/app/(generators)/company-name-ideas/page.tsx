...
export const metadata = {
  ...
  description: "Free Company Name Ideas online. Company Name Ideas allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "company name ideas, free online tool, no signup, generators, company name ideas online, 30tools",
  alternates: {
    canonical: "https://30tools.com/company-name-ideas",
  },
  openGraph: {
    title: "Free Company Name Ideas Online - No Signup | 30tools",
    description: "Free Company Name Ideas online. Company Name Ideas allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/company-name-ideas",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "company-name-ideas",
  "name": "Company Name Ideas",
  "description": "Free Company Name Ideas online. Company Name Ideas allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/company-name-ideas",
  "extraSlugs": [
    "company-name-ideas"
  ],
  "category": "generators"
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Company Name Ideas","description":"Free Company Name Ideas online. Company Name Ideas allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/company-name-ideas","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

...
export const metadata = {
	...
	description:
		"Free Company Name Ideas online. Company Name Ideas allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"company name ideas, free online tool, no signup, generators, company name ideas online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Company Name Ideas online. Company Name Ideas allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/company-name-ideas",
		extraSlugs: ["company-name-ideas"],
		category: "generators",
	};
	const breadcrumbs = [
		{

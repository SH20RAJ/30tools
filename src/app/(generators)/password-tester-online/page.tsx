...
export const metadata = {
	...
	description:
		"Free Password Tester Online online. Password Tester Online allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"password tester online, free online tool, no signup, generators, password tester online online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Password Tester Online online. Password Tester Online allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/password-tester-online",
		extraSlugs: ["password-tester-online"],
		category: "generators",
	};
	const breadcrumbs = [
		{

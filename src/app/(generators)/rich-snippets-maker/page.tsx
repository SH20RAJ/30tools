...
export const metadata = {
	...
	description:
		"Free Rich Snippets Maker online. Rich Snippets Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"rich snippets maker, free online tool, no signup, generators, rich snippets maker online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Rich Snippets Maker online. Rich Snippets Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/rich-snippets-maker",
		extraSlugs: ["rich-snippets-maker"],
		category: "generators",
	};
	const breadcrumbs = [
		{

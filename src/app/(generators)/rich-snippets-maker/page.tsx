...
export const metadata = {
  ...
  description: "Free Rich Snippets Maker online. Rich Snippets Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "rich snippets maker, free online tool, no signup, generators, rich snippets maker online, 30tools",
  alternates: {
    canonical: "https://30tools.com/rich-snippets-maker",
  },
  openGraph: {
    title: "Free Rich Snippets Maker Online - No Signup | 30tools",
    description: "Free Rich Snippets Maker online. Rich Snippets Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/rich-snippets-maker",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "rich-snippets-maker",
  "name": "Rich Snippets Maker",
  "description": "Free Rich Snippets Maker online. Rich Snippets Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/rich-snippets-maker",
  "extraSlugs": [
    "rich-snippets-maker"
  ],
  "category": "generators"
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Rich Snippets Maker","description":"Free Rich Snippets Maker online. Rich Snippets Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/rich-snippets-maker","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

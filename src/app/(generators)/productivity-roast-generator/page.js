...
export const metadata = {
  ...
  description:
    "Get hilariously roasted for your productivity habits with AI. Fun self-deprecating humor about work habits, procrastination, and daily routines.",
  keywords:
    "productivity roast, habit roast, procrastination humor, work habits, productivity memes, self deprecating humor, productivity jokes",
  canonical: "https://30tools.com/productivity-roast-generator",
  openGraph: {
    title: "Productivity Roast Generator - Get Roasted for Your Habits",
    description:
      "Get hilariously roasted for your productivity habits with AI. Fun self-deprecating humor about work and life.",
...
const jsonLd = {
  ...
  description:
    "Get hilariously roasted for your productivity habits with AI-generated humor and motivational twists.",
  url: "https://30tools.com/productivity-roast-generator",

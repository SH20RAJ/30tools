...
export const metadata = {
	...
	description:
		"Free Check Password Security online. Check Password Security allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"check password security, free online tool, no signup, generators, check password security online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Check Password Security online. Check Password Security allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",

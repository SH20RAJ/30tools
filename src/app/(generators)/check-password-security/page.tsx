...
export const metadata = {
  ...
  description: "Free Check Password Security online. Check Password Security allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "check password security, free online tool, no signup, generators, check password security online, 30tools",
  alternates: {
    canonical: "https://30tools.com/check-password-security",
  },
  openGraph: {
    title: "Free Check Password Security Online - No Signup | 30tools",
    description: "Free Check Password Security online. Check Password Security allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/check-password-security",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "check-password-security",
  "name": "Check Password Security",
  "description": "Free Check Password Security online. Check Password Security allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/check-password-security",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Check Password Security","description":"Free Check Password Security online. Check Password Security allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/check-password-security","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

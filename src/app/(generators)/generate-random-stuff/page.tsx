...
export const metadata = {
  ...
  description: "Free Generate Random Stuff online. Generate Random Stuff allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "generate random stuff, free online tool, no signup, generators, generate random stuff online, 30tools",
  alternates: {
    canonical: "https://30tools.com/generate-random-stuff",
  },
  openGraph: {
    title: "Free Generate Random Stuff Online - No Signup | 30tools",
    description: "Free Generate Random Stuff online. Generate Random Stuff allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/generate-random-stuff",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "generate-random-stuff",
  "name": "Generate Random Stuff",
  "description": "Free Generate Random Stuff online. Generate Random Stuff allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/generate-random-stuff",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Generate Random Stuff","description":"Free Generate Random Stuff online. Generate Random Stuff allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/generate-random-stuff","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

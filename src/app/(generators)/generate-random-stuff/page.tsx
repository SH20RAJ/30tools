...
export const metadata = {
	...
	description:
		"Free Generate Random Stuff online. Generate Random Stuff allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"generate random stuff, free online tool, no signup, generators, generate random stuff online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Generate Random Stuff online. Generate Random Stuff allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/generate-random-stuff",
		extraSlugs: ["generate-random-stuff"],
		category: "generators",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
	...
	description:
		"Free Html Head Tags Maker online. Html Head Tags Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"html head tags maker, free online tool, no signup, generators, html head tags maker online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Html Head Tags Maker online. Html Head Tags Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/html-head-tags-maker",
		extraSlugs: ["html-head-tags-maker"],
		category: "generators",
	};
	const breadcrumbs = [
		{

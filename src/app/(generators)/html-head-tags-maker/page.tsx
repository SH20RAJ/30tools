...
export const metadata = {
  ...
  description: "Free Html Head Tags Maker online. Html Head Tags Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "html head tags maker, free online tool, no signup, generators, html head tags maker online, 30tools",
  alternates: {
    canonical: "https://30tools.com/html-head-tags-maker",
  },
  openGraph: {
    title: "Free Html Head Tags Maker Online - No Signup | 30tools",
    description: "Free Html Head Tags Maker online. Html Head Tags Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/html-head-tags-maker",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "html-head-tags-maker",
  "name": "Html Head Tags Maker",
  "description": "Free Html Head Tags Maker online. Html Head Tags Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/html-head-tags-maker",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Html Head Tags Maker","description":"Free Html Head Tags Maker online. Html Head Tags Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/html-head-tags-maker","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

...
export const metadata = {
  ...
  description: "Free Lorem Ipsum Generator online tool. Fast and secure. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "lorem ipsum generator, free online tool, no signup, generators, lorem ipsum generator online, 30tools",
  alternates: {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Lorem Ipsum Generator","description":"Free Lorem Ipsum Generator online tool. Fast and secure.","url":"https://30tools.com/lorem-ipsum-generator","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

...
export const metadata = {
	...
	description:
		"Free Have I Been Pwned Password online. Have I Been Pwned Password allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"have i been pwned password, free online tool, no signup, generators, have i been pwned password online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Have I Been Pwned Password online. Have I Been Pwned Password allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/have-i-been-pwned-password",
		extraSlugs: ["have-i-been-pwned-check", "have-i-been-pwned-password"],
		category: "generators",
	};
	const breadcrumbs = [
		{

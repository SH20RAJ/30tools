...
export const metadata = {
  ...
  description: "Free Have I Been Pwned Password online. Have I Been Pwned Password allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "have i been pwned password, free online tool, no signup, generators, have i been pwned password online, 30tools",
  alternates: {
    canonical: "https://30tools.com/have-i-been-pwned-password",
  },
  openGraph: {
    title: "Free Have I Been Pwned Password Online - No Signup | 30tools",
    description: "Free Have I Been Pwned Password online. Have I Been Pwned Password allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/have-i-been-pwned-password",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "have-i-been-pwned-password",
  "name": "Have I Been Pwned Password",
  "description": "Free Have I Been Pwned Password online. Have I Been Pwned Password allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/have-i-been-pwned-password",
  "extraSlugs": [
  ...
  {
    "name": "Have I Been Pwned Password",
    "url": "/have-i-been-pwned-password"
  }
];
  const relatedTools = [
  {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Have I Been Pwned Password","description":"Free Have I Been Pwned Password online. Have I Been Pwned Password allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/have-i-been-pwned-password","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

...
export const metadata = {
	...
	description:
		"Free Random Password Maker online. Random Password Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"random password maker, free online tool, no signup, generators, random password maker online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Random Password Maker online. Random Password Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",

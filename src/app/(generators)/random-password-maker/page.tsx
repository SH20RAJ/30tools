...
export const metadata = {
  ...
  description: "Free Random Password Maker online. Random Password Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "random password maker, free online tool, no signup, generators, random password maker online, 30tools",
  alternates: {
    canonical: "https://30tools.com/random-password-maker",
  },
  openGraph: {
    title: "Free Random Password Maker Online - No Signup | 30tools",
    description: "Free Random Password Maker online. Random Password Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/random-password-maker",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "random-password-maker",
  "name": "Random Password Maker",
  "description": "Free Random Password Maker online. Random Password Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/random-password-maker",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Random Password Maker","description":"Free Random Password Maker online. Random Password Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/random-password-maker","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

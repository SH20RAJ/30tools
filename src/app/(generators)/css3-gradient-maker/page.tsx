...
export const metadata = {
	...
	description:
		"Free Css3 Gradient Maker online. Css3 Gradient Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"css3 gradient maker, free online tool, no signup, generators, css3 gradient maker online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Css3 Gradient Maker online. Css3 Gradient Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/css3-gradient-maker",
		extraSlugs: ["css3-gradient-maker", "css3-gradient-tool"],
		category: "generators",
	};
	const breadcrumbs = [
		{

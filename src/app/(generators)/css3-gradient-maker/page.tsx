...
export const metadata = {
  ...
  description: "Free Css3 Gradient Maker online. Css3 Gradient Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "css3 gradient maker, free online tool, no signup, generators, css3 gradient maker online, 30tools",
  alternates: {
    canonical: "https://30tools.com/css3-gradient-maker",
  },
  openGraph: {
    title: "Free Css3 Gradient Maker Online - No Signup | 30tools",
    description: "Free Css3 Gradient Maker online. Css3 Gradient Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/css3-gradient-maker",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "css3-gradient-maker",
  "name": "Css3 Gradient Maker",
  "description": "Free Css3 Gradient Maker online. Css3 Gradient Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/css3-gradient-maker",
  "extraSlugs": [
    "css3-gradient-maker",
    "css3-gradient-tool"
  ],
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Css3 Gradient Maker","description":"Free Css3 Gradient Maker online. Css3 Gradient Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/css3-gradient-maker","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

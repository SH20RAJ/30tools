...
export const metadata = {
	...
	description:
		"Free Data Breach Password Search online. Data Breach Password Search allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"data breach password search, free online tool, no signup, generators, data breach password search online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Data Breach Password Search online. Data Breach Password Search allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/data-breach-password-search",
		extraSlugs: ["data-breach-password-search"],
		category: "generators",
	};
	const breadcrumbs = [
		{

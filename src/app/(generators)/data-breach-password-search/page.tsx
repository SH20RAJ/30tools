...
export const metadata = {
  ...
  description: "Free Data Breach Password Search online. Data Breach Password Search allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "data breach password search, free online tool, no signup, generators, data breach password search online, 30tools",
  alternates: {
    canonical: "https://30tools.com/data-breach-password-search",
  },
  openGraph: {
    title: "Free Data Breach Password Search Online - No Signup | 30tools",
    description: "Free Data Breach Password Search online. Data Breach Password Search allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/data-breach-password-search",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "data-breach-password-search",
  "name": "Data Breach Password Search",
  "description": "Free Data Breach Password Search online. Data Breach Password Search allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/data-breach-password-search",
  "extraSlugs": [
  ...
  {
    "name": "Data Breach Password Search",
    "url": "/data-breach-password-search"
  }
];
  const relatedTools = [
  {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Data Breach Password Search","description":"Free Data Breach Password Search online. Data Breach Password Search allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/data-breach-password-search","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

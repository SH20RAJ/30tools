...
export const metadata = {
	...
	description:
		"Free Generate Payment Url online. Generate Payment Url allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"generate payment url, free online tool, no signup, generators, generate payment url online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Generate Payment Url online. Generate Payment Url allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/generate-payment-url",
		extraSlugs: ["generate-payment-url"],
		category: "generators",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
  ...
  description: "Free Generate Payment Url online. Generate Payment Url allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "generate payment url, free online tool, no signup, generators, generate payment url online, 30tools",
  alternates: {
    canonical: "https://30tools.com/generate-payment-url",
  },
  openGraph: {
    title: "Free Generate Payment Url Online - No Signup | 30tools",
    description: "Free Generate Payment Url online. Generate Payment Url allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/generate-payment-url",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "generate-payment-url",
  "name": "Generate Payment Url",
  "description": "Free Generate Payment Url online. Generate Payment Url allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/generate-payment-url",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Generate Payment Url","description":"Free Generate Payment Url online. Generate Payment Url allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/generate-payment-url","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

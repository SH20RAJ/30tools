...
export const metadata = {
	...
	description:
		"Free Generate Secure Password online. Generate Secure Password allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"generate secure password, free online tool, no signup, generators, generate secure password online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Generate Secure Password online. Generate Secure Password allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/generate-secure-password",
		extraSlugs: ["generate-secure-password", "secure-password-creator"],
		category: "generators",
	};
	const breadcrumbs = [
		{

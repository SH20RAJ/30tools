...
export const metadata = {
  ...
  description: "Free Generate Secure Password online. Generate Secure Password allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "generate secure password, free online tool, no signup, generators, generate secure password online, 30tools",
  alternates: {
    canonical: "https://30tools.com/generate-secure-password",
  },
  openGraph: {
    title: "Free Generate Secure Password Online - No Signup | 30tools",
    description: "Free Generate Secure Password online. Generate Secure Password allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/generate-secure-password",
    siteName: "30tools",
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Generate Secure Password","description":"Free Generate Secure Password online. Generate Secure Password allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/generate-secure-password","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

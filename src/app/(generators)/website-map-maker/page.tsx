...
export const metadata = {
	...
	description:
		"Free Website Map Maker online. Website Map Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"website map maker, free online tool, no signup, generators, website map maker online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Website Map Maker online. Website Map Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/website-map-maker",
		extraSlugs: ["website-map-maker"],
		category: "generators",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
  ...
  description: "Free Website Map Maker online. Website Map Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "website map maker, free online tool, no signup, generators, website map maker online, 30tools",
  alternates: {
    canonical: "https://30tools.com/website-map-maker",
  },
  openGraph: {
    title: "Free Website Map Maker Online - No Signup | 30tools",
    description: "Free Website Map Maker online. Website Map Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/website-map-maker",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "website-map-maker",
  "name": "Website Map Maker",
  "description": "Free Website Map Maker online. Website Map Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/website-map-maker",
  "extraSlugs": [
    "website-map-maker"
  ],
  "category": "generators"
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Website Map Maker","description":"Free Website Map Maker online. Website Map Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/website-map-maker","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

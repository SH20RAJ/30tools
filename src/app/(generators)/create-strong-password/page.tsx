...
export const metadata = {
	...
	description:
		"Free Create Strong Password online. Create Strong Password allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"create strong password, free online tool, no signup, generators, create strong password online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Create Strong Password online. Create Strong Password allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/create-strong-password",
		extraSlugs: ["create-strong-password"],
		category: "generators",
	};
	const breadcrumbs = [
		{

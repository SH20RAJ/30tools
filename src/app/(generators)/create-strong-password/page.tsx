...
export const metadata = {
  ...
  description: "Free Create Strong Password online. Create Strong Password allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "create strong password, free online tool, no signup, generators, create strong password online, 30tools",
  alternates: {
    canonical: "https://30tools.com/create-strong-password",
  },
  openGraph: {
    title: "Free Create Strong Password Online - No Signup | 30tools",
    description: "Free Create Strong Password online. Create Strong Password allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/create-strong-password",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "create-strong-password",
  "name": "Create Strong Password",
  "description": "Free Create Strong Password online. Create Strong Password allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/create-strong-password",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Create Strong Password","description":"Free Create Strong Password online. Create Strong Password allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/create-strong-password","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

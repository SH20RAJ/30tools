...
export const metadata = {
	...
	description:
		"Free Verify Password Safety online. Verify Password Safety allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"verify password safety, free online tool, no signup, generators, verify password safety online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Verify Password Safety online. Verify Password Safety allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/verify-password-safety",
		extraSlugs: ["verify-password-safety"],
		category: "generators",
	};
	const breadcrumbs = [
		{

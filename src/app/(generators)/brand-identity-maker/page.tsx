...
export const metadata = {
	...
	description:
		"Free Brand Identity Maker online. Brand Identity Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"brand identity maker, free online tool, no signup, generators, brand identity maker online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Brand Identity Maker online. Brand Identity Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/brand-identity-maker",
		extraSlugs: ["brand-identity-maker"],
		category: "generators",
	};
	const breadcrumbs = [
		{

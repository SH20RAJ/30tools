...
export const metadata = {
  ...
  description: "Free Brand Identity Maker online. Brand Identity Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "brand identity maker, free online tool, no signup, generators, brand identity maker online, 30tools",
  alternates: {
    canonical: "https://30tools.com/brand-identity-maker",
  },
  openGraph: {
    title: "Free Brand Identity Maker Online - No Signup | 30tools",
    description: "Free Brand Identity Maker online. Brand Identity Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/brand-identity-maker",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "brand-identity-maker",
  "name": "Brand Identity Maker",
  "description": "Free Brand Identity Maker online. Brand Identity Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/brand-identity-maker",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Brand Identity Maker","description":"Free Brand Identity Maker online. Brand Identity Maker allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/brand-identity-maker","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

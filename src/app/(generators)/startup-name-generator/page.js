...
export const metadata = {
  ...
  openGraph: {
    ...
    description: "Generate trendy startup names with AI. Perfect for indie hackers, entrepreneurs & YC applicants. Creative business names with domain suggestions.",
...
export default function StartupNameGeneratorPage() {
  ...
  // Related tools
  const relatedTools = [
    { id: 'aesthetic-bio-generator', name: 'Aesthetic Bio Generator', description: 'Create viral social media bios', route: '/aesthetic-bio-generator', category: 'generators' },
    ...
    { id: 'ai-image-generator', name: 'AI Image Generator', description: 'Generate images from text', route: '/ai-image-generator', category: 'generators' }
  ];
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground mb-6 max-w-4xl mx-auto">
            Generate trendy startup names with AI. Perfect for indie hackers, entrepreneurs & YC applicants.
            Creative business names with domain suggestions. Tech, SaaS & startup focused for the modern ecosystem.
          </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "AI Startup Name Generator",
            "description": "Generate trendy startup names with AI. Perfect for indie hackers and entrepreneurs",
            "url": "https://30tools.com/startup-name-generator",
            ...
            "screenshot": "https://30tools.com/screenshots/startup-name-generator.jpg",
            "aggregateRating": {

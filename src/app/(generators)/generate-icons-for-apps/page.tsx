...
export const metadata = {
  ...
  description: "Free Generate Icons For Apps online. Generate Icons For Apps allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "generate icons for apps, free online tool, no signup, generators, generate icons for apps online, 30tools",
  alternates: {
    canonical: "https://30tools.com/generate-icons-for-apps",
  },
  openGraph: {
    title: "Free Generate Icons For Apps Online - No Signup | 30tools",
    description: "Free Generate Icons For Apps online. Generate Icons For Apps allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/generate-icons-for-apps",
    siteName: "30tools",
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Generate Icons For Apps","description":"Free Generate Icons For Apps online. Generate Icons For Apps allows you to generate random content quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/generate-icons-for-apps","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

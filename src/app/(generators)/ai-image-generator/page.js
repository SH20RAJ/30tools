	...
	const examples = [
		{
			...
			input:
				"Cyberpunk city street at night, neon lights, rain, futuristic cars, highly detailed, 8k",
		...
		},
		{
			...
			input:
				"Majestic mountain landscape, sunset, lake reflection, photorealistic, 4k, cinematic lighting",
		...
		},
		{
			...
			input:
				"Elf warrior princess, silver armor, magical forest background, fantasy art style, detailed face",

...
export default function AIImageGeneratorPage() {
  const jsonLd = {
    ...
    description:
      "Generate stunning AI images from text prompts instantly using advanced artificial intelligence. Free AI art generator with multiple styles, high-quality output, and no signup required.",
    url: "https://30tools.com/ai-image-generator",
    ...
    keywords:
      "ai image generator, text to image, artificial intelligence, digital art, image creation",
  };

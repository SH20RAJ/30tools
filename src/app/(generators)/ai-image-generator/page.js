...
export const metadata = {
	...
	description:
		"Generate stunning AI images from text prompts instantly. Create photorealistic photos, digital art, anime, and illustrations for free. No signup required, unlimited generations, and privacy-focused browser processing. Try now and transform your ideas into beautiful artwork!",
	keywords: [
		"ai image generator",
		...
		faqs: [
			{
				...
				answer:
					"An AI image generator is a tool that uses artificial intelligence to create images from text descriptions (prompts). It analyzes millions of images to understand patterns and generate unique visuals based on your input.",
			},
			{
				question: "Is this AI Image Generator really free?",
				answer:
					"Yes, 30Tools provides a completely free AI image generator with no hidden costs or subscription models. Generate unlimited images from text prompts without creating an account. 100% free forever.",
			},
			{
				question: "How do I write the best AI prompts?",
				answer:
					"Be descriptive. Include the subject, environment, art style (e.g., 'Van Gogh style', 'cinematic lighting'), colors, mood, and resolution ('8k detailed'). The more detail you provide, the better the AI visualizes your idea.",
			},
			{
				question: "Can I use generated images for commercial projects?",
				answer:
					"Yes, all images generated are free for personal and commercial use. They're unique creations based on your prompts. However, avoid prompts referencing copyrighted characters or trademarks.",
			},
			{
				question: "What image quality can I download?",
				answer:
					"Our generator supports high-definition outputs up to 4K resolution (1024x1024, 1920x1080, etc.). Download images in PNG format with crystal-clear quality suitable for social media, blogs, print, and commercial projects.",
			},
			{
				question: "Is my data secure and private?",
				answer:
					"Absolutely. All image generation happens locally in your browser using client-side processing. We don't store, access, or transmit your prompts or generated images. Your creative process remains completely private.",
			},
			{
				question: "Do I need to create an account?",
				answer:
					"No registration required. Start generating AI images instantly without providing any personal information. Your generation history and favorites are stored locally in your browser for privacy.",
			},
			{
				question: "How can I reproduce the same image?",
				answer:
					"Use the same prompt, style, size, and seed number. The seed acts as a random generator starting point - keeping it identical produces reproducible results. Generate a random seed or set your own.",
			},
			{
				question: "What art styles are available?",
				answer:
					"Choose from 8 styles: Photorealistic (camera-like photos), Digital Art (modern illustrations), Oil Painting (classic technique), Watercolor (soft artistic), Cartoon (fun animation), Anime (Japanese style), Cyberpunk (futuristic neon), and Fantasy (magical themes).",
			},
			{
				question: "How fast does image generation take?",
				answer:
					"Most images generate in 2-5 seconds depending on complexity and size. Our AI optimizations ensure fast processing while maintaining high quality. No waiting in queues or processing delays.",
			},
			{
				question: "Can I save and reuse my favorite images?",
				answer:
					"Yes! Use the heart icon to save favorites and access your generation history. All favorites and history are stored locally in your browser, making it easy to revisit and download your best creations anytime.",
			},
			{
				question: "What aspect ratios are supported?",
				answer:
					"We support all common ratios: Square (1:1) for social media, Landscape (4:3, 16:9, 21:9) for banners and videos, Portrait (3:4) for stories and mobile displays. Choose based on your use case.",
			},
			{
				question: "How many images can I generate?",
				answer:
					"Unlimited! There's no daily or monthly limit. Generate as many images as you want, completely free. We believe in unrestricted creativity for everyone.",
			},
			{
				question: "What file format are downloads?",
				answer:
					"Images download in high-quality PNG format with transparent background support. This ensures maximum compatibility and quality for both digital and print use cases.",
			},
			{
				question: "Is this suitable for professional designers?",
				answer:
					"Yes! Professionals use our tool for concept art, mood boards, quick mockups, and creative exploration. The quality, speed, and customization options meet professional standards while being accessible to beginners.",
			},
		],
		howTo: {

...
export const metadata = {
  ...
  description: "Free Tool online tool. Fast and secure. 100% free, no signup required, and privacy-focused processing in your browser.",
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Tool","description":"Free Tool online tool. Fast and secure.","url":"https://30tools.com/blogs/[username]/[slug]","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

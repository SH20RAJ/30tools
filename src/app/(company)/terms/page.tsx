	...
	return (
		<div className="container mx-auto px-4 py-12 md:py-20 max-w-4xl prose dark:prose-invert">
			...
			<section className="space-y-6">
				...
				<p>
					By accessing and using 30Tools, you accept and agree to be bound by
				...
				<p>
					...
					materials (information or software) on 30Tools' website for personal,
					non-commercial transitory viewing only.
				</p>

				<h2>3. Disclaimer</h2>
				<p>
					The materials on 30Tools' website are provided on an 'as is' basis.
					30Tools makes no warranties, expressed or implied, and hereby
				...
				<p>
					...
					use the materials on 30Tools' website.
				</p>

				<h2>5. Revisions and Errata</h2>
				<p>
					The materials appearing on 30Tools' website could include technical,
					typographical, or photographic errors. 30Tools does not warrant that

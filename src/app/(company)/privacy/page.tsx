...
export const metadata = {
	...
	description:
		"Free Privacy online tool. Fast and secure. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"privacy, free online tool, no signup, others, privacy online, 30tools",
	alternates: {

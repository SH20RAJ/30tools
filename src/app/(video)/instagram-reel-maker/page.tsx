...
export const metadata = {
	...
	description:
		"Instagram Reel Maker - Coming Soon 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"instagram reel maker, free online tool, no signup, others, instagram reel maker online, 30tools",
	alternates: {

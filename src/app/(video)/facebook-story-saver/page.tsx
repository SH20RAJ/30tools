...
export const metadata = {
	...
	description:
		"Free Facebook Story Saver online. Facebook Story Saver allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"facebook story saver, free online tool, no signup, video, facebook story saver online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Facebook Story Saver online. Facebook Story Saver allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",

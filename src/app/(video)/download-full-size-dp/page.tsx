...
export const metadata = {
	...
	description:
		"Free Download Full Size Dp online. Download Full Size Dp allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"download full size dp, free online tool, no signup, video, download full size dp online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Download Full Size Dp online. Download Full Size Dp allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/download-full-size-dp",
		extraSlugs: ["download-full-size-dp", "view-full-size-ig-dp"],
		category: "video",
	};
	const breadcrumbs = [
		{

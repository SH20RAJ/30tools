...
export const metadata = {
	...
	description:
		"Free Embed Video Player online. Embed Video Player allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"embed video player, free online tool, no signup, video, embed video player online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Embed Video Player online. Embed Video Player allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/embed-video-player",
		extraSlugs: ["embed-video-player", "responsive-video-player"],
		category: "video",
	};
	const breadcrumbs = [
		{

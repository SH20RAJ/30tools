...
export const metadata = {
  ...
  description:
    "Professional video tools for compression, conversion, and GIF creation. Free online video processing with high quality output.",
  keywords:
    "video tools, video compressor, video converter, video to gif, free video tools online",
  openGraph: {
    title: "Video Tools - Free Online Video Processing",
    description:
      "Professional video tools for compression, conversion, and GIF creation.",

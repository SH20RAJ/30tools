...
export const metadata = {
	...
	description:
		"Free Download Terabox File online. Download Terabox File allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"download terabox file, free online tool, no signup, video, download terabox file online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Download Terabox File online. Download Terabox File allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/download-terabox-file",
		extraSlugs: ["download-terabox-file", "terabox-direct-download"],
		category: "video",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
	...
	description:
		"Free Download Insta Carousel online. Download Insta Carousel allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"download insta carousel, free online tool, no signup, video, download insta carousel online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Download Insta Carousel online. Download Insta Carousel allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/download-insta-carousel",
		extraSlugs: ["download-insta-carousel"],
		category: "video",
	};
	const breadcrumbs = [
		{

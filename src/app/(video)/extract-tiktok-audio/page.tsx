...
export const metadata = {
	...
	description:
		"Free Extract Tiktok Audio online. Extract Tiktok Audio allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"extract tiktok audio, free online tool, no signup, video, extract tiktok audio online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Extract Tiktok Audio online. Extract Tiktok Audio allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/extract-tiktok-audio",
		extraSlugs: ["extract-tiktok-audio"],
		category: "video",
	};
	const breadcrumbs = [
		{

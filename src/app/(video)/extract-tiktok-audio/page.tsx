...
export const metadata = {
  ...
  description: "Free Extract Tiktok Audio online. Extract Tiktok Audio allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "extract tiktok audio, free online tool, no signup, video, extract tiktok audio online, 30tools",
  alternates: {
    canonical: "https://30tools.com/extract-tiktok-audio",
  },
  openGraph: {
    title: "Free Extract Tiktok Audio Online - No Signup | 30tools",
    description: "Free Extract Tiktok Audio online. Extract Tiktok Audio allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/extract-tiktok-audio",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "extract-tiktok-audio",
  "name": "Extract Tiktok Audio",
  "description": "Free Extract Tiktok Audio online. Extract Tiktok Audio allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/extract-tiktok-audio",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Extract Tiktok Audio","description":"Free Extract Tiktok Audio online. Extract Tiktok Audio allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/extract-tiktok-audio","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

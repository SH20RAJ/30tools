...
export const metadata = {
	...
	description:
		"Free Shorten Video Clip online. Shorten Video Clip allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"shorten video clip, free online tool, no signup, video, shorten video clip online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Shorten Video Clip online. Shorten Video Clip allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/shorten-video-clip",
		extraSlugs: ["shorten-audio-clip", "shorten-video-clip"],
		category: "video",
	};
	const breadcrumbs = [
		{

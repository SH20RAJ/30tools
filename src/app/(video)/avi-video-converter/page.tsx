...
export const metadata = {
  ...
  description: "Free Avi Video Converter online. Avi Video Converter allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "avi video converter, free online tool, no signup, video, avi video converter online, 30tools",
  alternates: {
    canonical: "https://30tools.com/avi-video-converter",
  },
  openGraph: {
    title: "Free Avi Video Converter Online - No Signup | 30tools",
    description: "Free Avi Video Converter online. Avi Video Converter allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/avi-video-converter",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "avi-video-converter",
  "name": "Avi Video Converter",
  "description": "Free Avi Video Converter online. Avi Video Converter allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/avi-video-converter",
  "extraSlugs": [
    "avi-video-converter",
    "flv-video-converter",
    "mkv-video-converter",
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Avi Video Converter","description":"Free Avi Video Converter online. Avi Video Converter allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/avi-video-converter","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

...
export const metadata = {
  ...
  description: "Download Terabox videos with direct links and embed custom video players 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "terabox video downloader, free online tool, no signup, video, terabox video downloader online, 30tools",
  alternates: {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Terabox Video Downloader","description":"Download Terabox videos with direct links and embed custom video players","url":"https://30tools.com/terabox-downloader","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

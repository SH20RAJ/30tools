...
export const metadata = {
	...
	description:
		"Free Twitter Header Size Maker online. Twitter Header Size Maker allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"twitter header size maker, free online tool, no signup, video, twitter header size maker online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Twitter Header Size Maker online. Twitter Header Size Maker allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/twitter-header-size-maker",
		extraSlugs: ["twitter-bio-maker", "twitter-header-size-maker"],
		category: "video",
	};
	const breadcrumbs = [
		{

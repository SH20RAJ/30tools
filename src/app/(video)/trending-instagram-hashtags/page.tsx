...
export const metadata = {
	...
	description:
		"Free Trending Instagram Hashtags online. Trending Instagram Hashtags allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"trending instagram hashtags, free online tool, no signup, video, trending instagram hashtags online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Trending Instagram Hashtags online. Trending Instagram Hashtags allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/trending-instagram-hashtags",
		extraSlugs: ["trending-instagram-hashtags"],
		category: "video",
	};
	const breadcrumbs = [
		{

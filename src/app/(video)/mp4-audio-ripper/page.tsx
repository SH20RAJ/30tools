...
export const metadata = {
	...
	description:
		"Free Mp4 Audio Ripper online. Mp4 Audio Ripper allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"mp4 audio ripper, free online tool, no signup, video, mp4 audio ripper online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Mp4 Audio Ripper online. Mp4 Audio Ripper allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/mp4-audio-ripper",
		extraSlugs: ["mp4-audio-ripper"],
		category: "video",
	};
	const breadcrumbs = [
		{

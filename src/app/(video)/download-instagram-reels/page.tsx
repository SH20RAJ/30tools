...
export const metadata = {
	...
	description:
		"Free Download Instagram Reels online. Download Instagram Reels allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"download instagram reels, free online tool, no signup, video, download instagram reels online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Download Instagram Reels online. Download Instagram Reels allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/download-instagram-reels",
		extraSlugs: ["download-from-instagram", "download-instagram-reels"],
		category: "video",
	};
	const breadcrumbs = [
		{

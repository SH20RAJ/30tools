...
export const metadata = {
	...
	description:
		"Free Music From Mp4 online. Music From Mp4 allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"music from mp4, free online tool, no signup, video, music from mp4 online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		name: "Music From Mp4",
		description:
			"Free Music From Mp4 online. Music From Mp4 allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/music-from-mp4",
		extraSlugs: ["music-from-mp4"],
		category: "video",
	};
	const breadcrumbs = [
		{

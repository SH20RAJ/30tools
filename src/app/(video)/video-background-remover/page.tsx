...
export const metadata = {
	...
	description:
		"Video Background Remover - Coming Soon 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"video background remover, free online tool, no signup, others, video background remover online, 30tools",
	alternates: {

...
export const metadata = {
	...
	description:
		"Video Sales Letter - Coming Soon 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"video sales letter, free online tool, no signup, others, video sales letter online, 30tools",
	alternates: {

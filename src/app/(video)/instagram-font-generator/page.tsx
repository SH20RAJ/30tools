...
export const metadata = {
	...
	description:
		"Free Instagram Font Generator online. Instagram Font Generator allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"instagram font generator, free online tool, no signup, video, instagram font generator online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Instagram Font Generator online. Instagram Font Generator allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/instagram-font-generator",
		extraSlugs: ["instagram-font-generator"],
		category: "video",
	};
	const breadcrumbs = [
		{

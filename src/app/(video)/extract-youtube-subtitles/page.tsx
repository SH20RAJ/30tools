...
export const metadata = {
	...
	description:
		"Free Extract Youtube Subtitles online. Extract Youtube Subtitles allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"extract youtube subtitles, free online tool, no signup, video, extract youtube subtitles online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Extract Youtube Subtitles online. Extract Youtube Subtitles allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/extract-youtube-subtitles",
		extraSlugs: ["extract-youtube-subtitles"],
		category: "video",
	};
	const breadcrumbs = [
		{

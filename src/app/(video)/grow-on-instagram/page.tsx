...
export const metadata = {
	...
	description:
		"Free Grow On Instagram online. Grow On Instagram allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"grow on instagram, free online tool, no signup, video, grow on instagram online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Grow On Instagram online. Grow On Instagram allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/grow-on-instagram",
		extraSlugs: ["grow-on-instagram"],
		category: "video",
	};
	const breadcrumbs = [
		{

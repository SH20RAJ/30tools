...
export const metadata = {
  ...
  description: "Ai Video Summarizer - Coming Soon 100% free, no signup required, and privacy-focused processing in your browser.",
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Ai Video Summarizer","description":"Ai Video Summarizer - Coming Soon","url":"https://30tools.com/ai-video-summarizer","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

...
export const metadata = {
	...
	description:
		"Ai Video Summarizer - Coming Soon 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"ai video summarizer, free online tool, no signup, others, ai video summarizer online, 30tools",
	alternates: {

...
export const metadata = {
	...
	description:
		"Video Splitter - Coming Soon 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"video splitter, free online tool, no signup, others, video splitter online, 30tools",
	alternates: {

...
export const metadata = {
	...
	description:
		"Free Screen Capture Video online. Screen Capture Video allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"screen capture video, free online tool, no signup, video, screen capture video online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Screen Capture Video online. Screen Capture Video allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/screen-capture-video",
		extraSlugs: ["screen-capture-video"],
		category: "video",
	};
	const breadcrumbs = [
		{

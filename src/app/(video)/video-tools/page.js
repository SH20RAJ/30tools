...
export const metadata = {
  ...
  description: "Free Video Tools online tool. Fast and secure. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "video tools, free online tool, no signup, video, video tools online, 30tools",
  alternates: {
...
export default async function ToolPage() {
  ...
  "id": "video-tools",
  "name": "Video Tools",
  "description": "Free Video Tools online tool. Fast and secure.",
  "route": "/video-tools",
  "extraSlugs": [],
  "popular": false,
  "category": "video"
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Video Tools","description":"Free Video Tools online tool. Fast and secure.","url":"https://30tools.com/video-tools","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

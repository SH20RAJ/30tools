...
export const metadata = {
	...
	description:
		"Free Story Viewer Without Account online. Story Viewer Without Account allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"story viewer without account, free online tool, no signup, video, story viewer without account online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Story Viewer Without Account online. Story Viewer Without Account allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/story-viewer-without-account",
		extraSlugs: ["story-viewer-without-account"],
		category: "video",
	};
	const breadcrumbs = [
		{

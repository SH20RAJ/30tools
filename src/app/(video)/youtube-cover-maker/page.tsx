...
export const metadata = {
	...
	description:
		"Free Youtube Cover Maker online. Youtube Cover Maker allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"youtube cover maker, free online tool, no signup, video, youtube cover maker online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Youtube Cover Maker online. Youtube Cover Maker allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/youtube-cover-maker",
		extraSlugs: ["youtube-cover-maker", "youtube-gif-maker"],
		category: "video",
	};
	const breadcrumbs = [
		{

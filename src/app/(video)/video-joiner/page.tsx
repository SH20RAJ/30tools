...
export const metadata = {
	...
	description:
		"Video Joiner - Coming Soon 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"video joiner, free online tool, no signup, others, video joiner online, 30tools",
	alternates: {

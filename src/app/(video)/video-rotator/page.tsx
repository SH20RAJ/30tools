...
export const metadata = {
	...
	description:
		"Video Rotator - Coming Soon 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"video rotator, free online tool, no signup, others, video rotator online, 30tools",
	alternates: {

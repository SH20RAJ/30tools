...
export const metadata = {
	...
	description:
		"Free Download Twitter Clips online. Download Twitter Clips allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"download twitter clips, free online tool, no signup, video, download twitter clips online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Download Twitter Clips online. Download Twitter Clips allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/download-twitter-clips",
		extraSlugs: ["download-twitter-clips"],
		category: "video",
	};
	const breadcrumbs = [
		{

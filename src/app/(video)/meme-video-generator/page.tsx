...
export const metadata = {
	...
	description:
		"Meme Video Generator - Coming Soon 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"meme video generator, free online tool, no signup, others, meme video generator online, 30tools",
	alternates: {

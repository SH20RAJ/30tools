...
export const metadata = {
	...
	description:
		"Free Tiktok Aspect Ratio Converter online. Tiktok Aspect Ratio Converter allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"tiktok aspect ratio converter, free online tool, no signup, video, tiktok aspect ratio converter online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Tiktok Aspect Ratio Converter online. Tiktok Aspect Ratio Converter allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/tiktok-aspect-ratio-converter",
		extraSlugs: ["tiktok-aspect-ratio-converter", "tiktok-music-converter"],
		category: "video",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
	...
	description:
		"Free Aesthetic Fonts For Instagram online. Aesthetic Fonts For Instagram allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"aesthetic fonts for instagram, free online tool, no signup, video, aesthetic fonts for instagram online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Aesthetic Fonts For Instagram online. Aesthetic Fonts For Instagram allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/aesthetic-fonts-for-instagram",
		extraSlugs: ["aesthetic-fonts-for-instagram"],
		category: "video",
	};
	const breadcrumbs = [
		{

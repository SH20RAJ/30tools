...
export const metadata = {
  ...
  description:
    "Professional screen recorder tool. Process videos online for free with high quality output. No watermarks, no registration required. Fast & secure processing.",
  keywords:
    "screen recorder, screen capture, record screen, desktop recording, video recording",
  openGraph: {
    title: "Screen Recorder - Record Your Screen | 30tools",

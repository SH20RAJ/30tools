...
export const metadata = {
	...
	description:
		"Zoom Recorder - Coming Soon 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"zoom recorder, free online tool, no signup, others, zoom recorder online, 30tools",
	alternates: {

...
export const metadata = {
	...
	description:
		"Video To Audio - Coming Soon 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"video to audio, free online tool, no signup, others, video to audio online, 30tools",
	alternates: {

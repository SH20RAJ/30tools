...
export const metadata = {
	...
	description:
		"Free Download Tiktok Sound online. Download Tiktok Sound allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"download tiktok sound, free online tool, no signup, video, download tiktok sound online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Download Tiktok Sound online. Download Tiktok Sound allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/download-tiktok-sound",
		extraSlugs: ["download-tiktok-sound"],
		category: "video",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
	...
	description:
		"Free Convert Video Format online. Convert Video Format allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"convert video format, free online tool, no signup, video, convert video format online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Convert Video Format online. Convert Video Format allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/convert-video-format",
		extraSlugs: ["convert-audio-format", "convert-video-format"],
		category: "video",
	};
	const breadcrumbs = [
		{

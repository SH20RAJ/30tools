...
export const metadata = {
	...
	description:
		"Free Free Video Editor online. Free Video Editor allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"free video editor, free online tool, no signup, video, free video editor online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Free Video Editor online. Free Video Editor allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/free-video-editor",
		extraSlugs: ["free-audio-editor", "free-video-editor"],
		category: "video",
	};
	const breadcrumbs = [
		{

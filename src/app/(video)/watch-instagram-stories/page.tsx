...
export const metadata = {
	...
	description:
		"Free Watch Instagram Stories online. Watch Instagram Stories allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"watch instagram stories, free online tool, no signup, video, watch instagram stories online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Watch Instagram Stories online. Watch Instagram Stories allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/watch-instagram-stories",
		extraSlugs: ["watch-instagram-stories"],
		category: "video",
	};
	const breadcrumbs = [
		{

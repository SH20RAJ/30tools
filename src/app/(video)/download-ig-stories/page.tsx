...
export const metadata = {
	...
	description:
		"Free Download Ig Stories online. Download Ig Stories allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"download ig stories, free online tool, no signup, video, download ig stories online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Download Ig Stories online. Download Ig Stories allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",

...
export const metadata = {
	...
	description:
		"Free Save Youtube Captions online. Save Youtube Captions allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"save youtube captions, free online tool, no signup, video, save youtube captions online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Save Youtube Captions online. Save Youtube Captions allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/save-youtube-captions",
		extraSlugs: ["save-youtube-captions"],
		category: "video",
	};
	const breadcrumbs = [
		{

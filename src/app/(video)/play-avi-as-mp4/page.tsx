...
export const metadata = {
	...
	description:
		"Free Play Avi As Mp4 online. Play Avi As Mp4 allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"play avi as mp4, free online tool, no signup, video, play avi as mp4 online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Play Avi As Mp4 online. Play Avi As Mp4 allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",

...
export const metadata = {
	...
	description:
		"Free Terabox Player Online online. Terabox Player Online allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"terabox player online, free online tool, no signup, video, terabox player online online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Terabox Player Online online. Terabox Player Online allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/terabox-player-online",
		extraSlugs: ["terabox-player-online"],
		category: "video",
	};
	const breadcrumbs = [
		{

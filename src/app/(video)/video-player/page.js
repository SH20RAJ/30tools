...
export const metadata = {
  ...
  description:
    "Create professional video players with themes and embed codes. Supports multiple libraries. Free tool, no coding needed!",
  keywords: [
    // Primary keywords
  ...
  openGraph: {
    ...
    description:
      "Generate professional video players with custom themes, responsive design & embed codes. Supports Plyr, Video.js, Fluid Player & MediaElement.js. Free online tool, no coding required!",
    type: "website",
    images: [
      {
  ...
  twitter: {
    ...
    description:
      "Create professional video players with themes, responsive design & embed codes. Supports multiple libraries. Free tool, no coding needed!",
...
export default function VideoPlayerPage() {
  const jsonLd = {
    ...
    description:
      "Free online tool to create custom HTML5 video players with multiple libraries and themes",

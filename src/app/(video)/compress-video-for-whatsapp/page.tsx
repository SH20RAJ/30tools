...
export const metadata = {
	...
	description:
		"Free Compress Video For Whatsapp online. Compress Video For Whatsapp allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"compress video for whatsapp, free online tool, no signup, video, compress video for whatsapp online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Compress Video For Whatsapp online. Compress Video For Whatsapp allows you to process video files quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/compress-video-for-whatsapp",
		extraSlugs: ["compress-video-for-whatsapp"],
		category: "video",
	};
	const breadcrumbs = [
		{

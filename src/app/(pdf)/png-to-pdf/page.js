...
export const metadata = {
  ...
  description: "Convert PNG images to PDF documents quickly and easily. Free online tool. 100% free, no signup required, and privacy-focused processing in your browser.",
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"PNG to PDF","description":"Convert PNG images to PDF documents quickly and easily. Free online tool.","url":"https://30tools.com/png-to-pdf","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

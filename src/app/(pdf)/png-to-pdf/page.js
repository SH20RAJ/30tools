...
export const metadata = {
	...
	description:
		"Convert PNG images to PDF documents quickly and easily. Free online tool. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"png to pdf, free online tool, no signup, pdf, png to pdf online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		name: "PNG to PDF",
		description:
			"Convert PNG images to PDF documents quickly and easily. Free online tool.",
		route: "/png-to-pdf",
		extraSlugs: [
			"combine-png-to-pdf",
			"convert-png-to-pdf",

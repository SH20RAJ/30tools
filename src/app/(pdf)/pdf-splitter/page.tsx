...
export const metadata = {
	...
	description:
		"Split PDF files into separate pages or ranges 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"pdf splitter, free online tool, no signup, pdf, pdf splitter online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		route: "/pdf-splitter",
		extraSlugs: ["split-pdf-pages-online-free", "pdf-page-extractor"],
		popular: true,
		category: "pdf",
	};
	const breadcrumbs = [

...
export const metadata = {
  ...
  twitter: {
    ...
    title: "Free PDF Splitter Online - Split PDF into Separate Files",
    description:
      "Split PDF files by pages, ranges, or intervals. Perfect for organizing documents.",

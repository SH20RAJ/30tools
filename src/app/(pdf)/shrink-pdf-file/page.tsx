...
export const metadata = {
	...
	description:
		"Free Shrink Pdf File online. Shrink Pdf File allows you to manage PDF documents quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"shrink pdf file, free online tool, no signup, pdf, shrink pdf file online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Shrink Pdf File online. Shrink Pdf File allows you to manage PDF documents quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",

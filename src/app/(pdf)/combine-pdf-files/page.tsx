...
export const metadata = {
	...
	description:
		"Free Combine Pdf Files online. Combine Pdf Files allows you to manage PDF documents quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"combine pdf files, free online tool, no signup, pdf, combine pdf files online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Combine Pdf Files online. Combine Pdf Files allows you to manage PDF documents quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/combine-pdf-files",
		extraSlugs: ["combine-pdf-files", "separate-pdf-files"],
		category: "pdf",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
	...
	description:
		"Free Save Rotated Pdf online. Save Rotated Pdf allows you to manage PDF documents quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"save rotated pdf, free online tool, no signup, pdf, save rotated pdf online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Save Rotated Pdf online. Save Rotated Pdf allows you to manage PDF documents quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",

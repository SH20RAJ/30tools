...
export const metadata = {
	...
	description:
		"Convert PDF pages to high-quality JPG, PNG images 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"pdf to image, free online tool, no signup, pdf, pdf to image online, 30tools",
	alternates: {
	...
	openGraph: {
		...
		siteName: "30tools",
		images: [{ url: "/api/og?title=Free%20PDF%20to%20Image%20Online%20-%20No%20Signup" }],
		type: "website",
	},
	twitter: {
		...
		description:
			"Convert PDF pages to high-quality JPG, PNG images 100% free, no signup required, and privacy-focused processing in your browser.",
		images: ["/api/og?title=Free%20PDF%20to%20Image%20Online%20-%20No%20Signup"],
	},
...
export default async function ToolPage() {
	const tool = {
		...
		route: "/pdf-to-image",
		extraSlugs: ["convert-pdf-to-high-quality-jpg", "pdf-to-png-converter"],
		popular: true,
		category: "pdf",
	};
	const breadcrumbs = [

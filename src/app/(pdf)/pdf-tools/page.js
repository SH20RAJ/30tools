...
export const metadata = {
	...
	description:
		"Free Pdf Tools online tool. Fast and secure. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"pdf tools, free online tool, no signup, pdf, pdf tools online, 30tools",
	alternates: {

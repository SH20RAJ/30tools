...
export const metadata = {
  ...
  description: "Remove password protection from PDF files 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "pdf unlocker, free online tool, no signup, pdf, pdf unlocker online, 30tools",
  alternates: {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"PDF Unlocker","description":"Remove password protection from PDF files","url":"https://30tools.com/pdf-unlocker","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

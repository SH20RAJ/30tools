...
export const metadata = {
  ...
  twitter: {
    ...
    title: "Free PDF Password Protector - Secure Your PDF Files",
    description:
      "Add password protection with 256-bit encryption and custom permissions.",

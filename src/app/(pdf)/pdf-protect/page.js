...
export const metadata = {
  ...
  description: "Add password protection to PDF files 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "pdf password protect, free online tool, no signup, pdf, pdf password protect online, 30tools",
  alternates: {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"PDF Password Protect","description":"Add password protection to PDF files","url":"https://30tools.com/pdf-protect","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

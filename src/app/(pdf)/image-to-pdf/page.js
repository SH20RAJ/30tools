...
export const metadata = {
	...
	description:
		"Convert JPG, PNG, BMP, and GIF images to PDF online for free. No signup, no watermarks, instant processing. Combine multiple images into one secure PDF document.",
	keywords: [
		"image to pdf",
		"image to pdf free",
		"image to pdf online",
		...
		faqs: [
			{
				...
				answer:
					"Yes! Our Image to PDF is completely free to use with no hidden costs, subscriptions, or premium features. You get full access to all functionality without any limitations.",
			},
			{
			...
			},
			{
				...
				answer:
					"No registration required. You can start using Image to PDF immediately without creating an account or providing any personal information.",
			},
			{
			...
			},
			{
				...
				answer:
					"Yes, Image to PDF is fully responsive and works perfectly on smartphones, tablets, and desktop computers with any modern browser.",
			},
			{
				question: "What file formats does Image to PDF support?",
				answer:
					"Image to PDF supports all major formats for its category. Upload common file types and get converted results in standard output formats compatible with any device or software.",
			},
		],
		howTo: {
			...
			<main className="container mx-auto px-4 py-8">
				...
				<div className="text-center mb-12">
					...
					<p className="text-xl text-muted-foreground mb-6 max-w-4xl mx-auto leading-relaxed">
						...
						professional PDF document instantly. No signup, no watermarks, and
						100% secure.
					</p>

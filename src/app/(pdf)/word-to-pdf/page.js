...
export const metadata = {
  ...
  description: "Convert Word documents to PDF format 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "word to pdf, free online tool, no signup, pdf, word to pdf online, 30tools",
  alternates: {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Word to PDF","description":"Convert Word documents to PDF format","url":"https://30tools.com/word-to-pdf","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

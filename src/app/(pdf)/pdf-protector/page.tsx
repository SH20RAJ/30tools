...
export const metadata = {
	...
	description:
		"Pdf Protector - Coming Soon 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"pdf protector, free online tool, no signup, others, pdf protector online, 30tools",
	alternates: {

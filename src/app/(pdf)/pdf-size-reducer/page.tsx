...
export const metadata = {
	...
	description:
		"Free Pdf Size Reducer online. Pdf Size Reducer allows you to manage PDF documents quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"pdf size reducer, free online tool, no signup, pdf, pdf size reducer online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Pdf Size Reducer online. Pdf Size Reducer allows you to manage PDF documents quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",

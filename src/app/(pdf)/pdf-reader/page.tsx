...
export const metadata = {
	...
	description:
		"Pdf Reader - Coming Soon 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"pdf reader, free online tool, no signup, others, pdf reader online, 30tools",
	alternates: {

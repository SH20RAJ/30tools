...
export const metadata = {
  ...
  description: "Browse our complete directory of free online tools. From image editing and PDF management to SEO audit and developer utilities.",
};
      ...
      <main className="flex-1 container mx-auto px-4 py-16 max-w-7xl">
        <header className="mb-16 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            A comprehensive directory of all our processing tools, utilities, and search variants. 
            Quickly find the specific solution you need.
          </p>
        </header>
              ...
              <section key={key} id={key} className="scroll-mt-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {category.tools.map((tool: any) => (
                    <div key={tool.id} className="group p-6 bg-card rounded-2xl border border-border hover:shadow-xl transition-all duration-300">

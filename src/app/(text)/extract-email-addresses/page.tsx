...
export const metadata = {
	...
	description:
		"Free Extract Email Addresses online. Extract Email Addresses allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"extract email addresses, free online tool, no signup, text, extract email addresses online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Extract Email Addresses online. Extract Email Addresses allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/extract-email-addresses",
		extraSlugs: ["extract-email-addresses"],
		category: "text",
	};
	const breadcrumbs = [
		{

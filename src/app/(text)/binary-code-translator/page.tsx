...
export const metadata = {
	...
	description:
		"Free Binary Code Translator online. Binary Code Translator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"binary code translator, free online tool, no signup, text, binary code translator online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Binary Code Translator online. Binary Code Translator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/binary-code-translator",
		extraSlugs: ["binary-code-translator"],
		category: "text",
	};
	const breadcrumbs = [
		{

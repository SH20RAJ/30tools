...
export const metadata = {
	...
	description:
		"Free Duplicate Line Remover online. Duplicate Line Remover allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"duplicate line remover, free online tool, no signup, text, duplicate line remover online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Duplicate Line Remover online. Duplicate Line Remover allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/duplicate-line-remover",
		extraSlugs: ["duplicate-line-remover"],
		category: "text",
	};
	const breadcrumbs = [
		{

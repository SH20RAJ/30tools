...
export const metadata = {
  ...
  description:
    "Professional remove duplicates to Process text instantly. Free online text tool with advanced features. Perfect for writers, students & professionals.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Remove duplicate lines from text instantly. Clean up data and organize text lists.",
    type: "website",
...
const jsonLd = {
  ...
  description:
    "Free online tool to remove duplicate lines from text, clean data, and organize text lists",
  url: "https://30tools.com/remove-duplicates",
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-muted-foreground">
              Clean up your text by removing duplicate lines instantly with
              advanced options
            </p>
          </div>
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Enter or paste text with duplicate lines
                  </p>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-3">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Choose case sensitivity and whitespace settings
                  </p>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-3">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Copy the deduplicated text with unique lines only
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <div className="bg-muted p-3 rounded font-mono text-sm">
                    ...
                    <div>
                      <strong>After (Case Insensitive):</strong>
                    </div>
                    <div className="ml-4">
                      Laptop
                      <br />
            ...
            <div className="bg-card rounded-lg p-6 border">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground">
                    Sort text lines alphabetically or numerically in
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground">
                    Format and clean up your text with various formatting
                    options.
                  </p>
                  <span className="text-xs text-primary mt-2 inline-block">
                    Format Text →
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground">
                    Count words, characters, paragraphs with detailed
                    statistics.
                  </p>
                  <span className="text-xs text-primary mt-2 inline-block">
                    Count Words →

...
export const metadata = {
	...
	description:
		"Remove duplicate lines from text lists 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"remove duplicates, free online tool, no signup, text, remove duplicates online, 30tools",
	alternates: {

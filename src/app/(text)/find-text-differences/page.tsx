...
export const metadata = {
	...
	description:
		"Free Find Text Differences online. Find Text Differences allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"find text differences, free online tool, no signup, text, find text differences online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Find Text Differences online. Find Text Differences allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/find-text-differences",
		extraSlugs: ["find-emails-in-text", "find-text-differences"],
		category: "text",
	};
	const breadcrumbs = [
		{

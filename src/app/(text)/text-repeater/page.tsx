...
export const metadata = {
  ...
  description: "Free text repeater tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "text repeater, free online tool, no signup, text, text repeater online, 30tools",
  alternates: {
...
export default async function ToolPage() {
  ...
  "id": "text-repeater",
  "name": "Text Repeater",
  "description": "Free text repeater tool to process your data instantly with privacy-friendly browser-based workflows.",
  "route": "/text-repeater",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Text Repeater","description":"Free text repeater tool to process your data instantly with privacy-friendly browser-based workflows.","url":"https://30tools.com/text-repeater","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />
      ...
      >
        <ToolPlaceholderPage toolId="text-repeater" />
      </ToolLayout>
    </>
  );
}

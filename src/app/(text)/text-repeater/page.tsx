...
export const metadata = {
	...
	keywords:
		"text repeater, free online tool, no signup, text, text repeater online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		name: "Text Repeater",
		description:
			"Free text repeater tool to process your data instantly with privacy-friendly browser-based workflows.",
		route: "/text-repeater",
		extraSlugs: ["free-text-repeater-online", "text-repeater-tool"],
		popular: false,
		category: "text",
	};
	const breadcrumbs = [

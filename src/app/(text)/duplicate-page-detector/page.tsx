...
export const metadata = {
	...
	description:
		"Free Duplicate Page Detector online. Duplicate Page Detector allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"duplicate page detector, free online tool, no signup, text, duplicate page detector online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Duplicate Page Detector online. Duplicate Page Detector allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/duplicate-page-detector",
		extraSlugs: ["duplicate-page-detector"],
		category: "text",
	};
	const breadcrumbs = [
		{

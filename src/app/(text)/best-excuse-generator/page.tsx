...
export const metadata = {
	...
	description:
		"Free Best Excuse Generator online. Best Excuse Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"best excuse generator, free online tool, no signup, text, best excuse generator online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Best Excuse Generator online. Best Excuse Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/best-excuse-generator",
		extraSlugs: ["best-excuse-generator"],
		category: "text",
	};
	const breadcrumbs = [
		{

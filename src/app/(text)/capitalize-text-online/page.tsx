...
export const metadata = {
	...
	description:
		"Free Capitalize Text Online online. Capitalize Text Online allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"capitalize text online, free online tool, no signup, text, capitalize text online online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Capitalize Text Online online. Capitalize Text Online allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",

...
export const metadata = {
	...
	description:
		"Free Filler Text Maker online. Filler Text Maker allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"filler text maker, free online tool, no signup, text, filler text maker online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Filler Text Maker online. Filler Text Maker allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/filler-text-maker",
		extraSlugs: ["fake-text-message-maker", "filler-text-maker"],
		category: "text",
	};
	const breadcrumbs = [
		{

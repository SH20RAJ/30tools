...
export const metadata = {
  ...
  description: "Free Brand Colors Generator online. Brand Colors Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "brand colors generator, free online tool, no signup, text, brand colors generator online, 30tools",
  alternates: {
    canonical: "https://30tools.com/brand-colors-generator",
  },
  openGraph: {
    title: "Free Brand Colors Generator Online - No Signup | 30tools",
    description: "Free Brand Colors Generator online. Brand Colors Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/brand-colors-generator",
    siteName: "30tools",
...
export default async function ToolPage() {
  const tool = {
  "id": "brand-colors-generator",
  "name": "Brand Colors Generator",
  "description": "Free Brand Colors Generator online. Brand Colors Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/brand-colors-generator",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Brand Colors Generator","description":"Free Brand Colors Generator online. Brand Colors Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/brand-colors-generator","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

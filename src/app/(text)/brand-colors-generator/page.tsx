...
export const metadata = {
	...
	description:
		"Free Brand Colors Generator online. Brand Colors Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"brand colors generator, free online tool, no signup, text, brand colors generator online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Brand Colors Generator online. Brand Colors Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/brand-colors-generator",
		extraSlugs: ["brand-colors-generator", "brand-name-generator"],
		category: "text",
	};
	const breadcrumbs = [
		{

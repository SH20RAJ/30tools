...
export const metadata = {
	...
	description:
		"Free Random Number Picker online. Random Number Picker allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"random number picker, free online tool, no signup, text, random number picker online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Random Number Picker online. Random Number Picker allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/random-number-picker",
		extraSlugs: ["random-number-picker"],
		category: "text",
	};
	const breadcrumbs = [
		{

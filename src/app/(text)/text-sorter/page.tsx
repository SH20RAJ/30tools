...
export const metadata = {
  ...
  description: "Free text sorter tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "text sorter, free online tool, no signup, text, text sorter online, 30tools",
  alternates: {
...
export default async function ToolPage() {
  ...
  "id": "text-sorter",
  "name": "Text Sorter",
  "description": "Free text sorter tool to process your data instantly with privacy-friendly browser-based workflows.",
  "route": "/text-sorter",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Text Sorter","description":"Free text sorter tool to process your data instantly with privacy-friendly browser-based workflows.","url":"https://30tools.com/text-sorter","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />
      ...
      >
        <ToolPlaceholderPage toolId="text-sorter" />
      </ToolLayout>
    </>
  );
}

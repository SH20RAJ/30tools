...
export const metadata = {
	...
	description:
		"Free Hex Color Finder online. Hex Color Finder allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"hex color finder, free online tool, no signup, text, hex color finder online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Hex Color Finder online. Hex Color Finder allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/hex-color-finder",
		extraSlugs: ["hex-color-finder"],
		category: "text",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
  ...
  description: "Encode and decode text (URL, Base64) 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "text encoder, free online tool, no signup, text, text encoder online, 30tools",
  alternates: {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Text Encoder","description":"Encode and decode text (URL, Base64)","url":"https://30tools.com/text-encoder","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

...
export const metadata = {
  ...
  description:
    "Encode and decode text using URL encoding, Base64, HTML entities, and more. Free online text encoder decoder tool with multiple encoding formats.",
  keywords: [
...
const jsonLd = {
  ...
  description:
    "Free online tool to encode and decode text using URL encoding, Base64, HTML entities, and other encoding formats",
  url: "https://30tools.com/text-encoder",
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-muted-foreground">
              Encode and decode text using URL encoding, Base64, HTML entities,
              and more
            </p>
          </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="border rounded-lg p-4">
                    ...
                    <div className="bg-muted p-3 rounded font-mono text-sm">
                      <div>
                        <strong>Original:</strong> user@example.com
                      </div>
                      <div>
                        <strong>Encoded:</strong> user%40example.com
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-card rounded-lg p-6 border">
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-border pl-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    When passing data through URL query strings, special
                    characters like spaces, ampersands, and symbols need to be
                    URL-encoded to ensure proper transmission.
                  </p>
                </div>
                ...
                <div className="border-l-4 border-border pl-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Base64 encoding is commonly used for email attachments and
                    embedded images, ensuring binary data can be transmitted
                    safely through text-based protocols.
                  </p>
                </div>
                ...
                <div className="border-l-4 border-border pl-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    HTML entity encoding prevents XSS attacks by converting
                    dangerous characters like &lt;, &gt;, and &amp; into safe
                    HTML entities.
                  </p>
                </div>
                ...
                <div className="border-l-4 border-border pl-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    APIs and web services often require specific text encoding
                    formats to ensure data integrity during transmission between
                    different systems.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-card rounded-lg p-6 border">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground">
                    Test and validate regular expressions with real-time
                    matching.
                  </p>

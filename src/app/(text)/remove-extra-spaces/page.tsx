...
export const metadata = {
	...
	description:
		"Free Remove Extra Spaces online. Remove Extra Spaces allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"remove extra spaces, free online tool, no signup, text, remove extra spaces online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Remove Extra Spaces online. Remove Extra Spaces allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/remove-extra-spaces",
		extraSlugs: ["remove-extra-spaces"],
		category: "text",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
	...
	description:
		"Free Md Html Converter online. Md Html Converter allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"md html converter, free online tool, no signup, text, md html converter online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Md Html Converter online. Md Html Converter allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/md-html-converter",
		extraSlugs: ["md-html-converter"],
		category: "text",
	};
	const breadcrumbs = [
		{

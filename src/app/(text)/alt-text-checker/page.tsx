...
export const metadata = {
	...
	description:
		"Free Alt Text Checker online. Alt Text Checker allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"alt text checker, free online tool, no signup, text, alt text checker online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Alt Text Checker online. Alt Text Checker allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/alt-text-checker",
		extraSlugs: ["alt-text-checker"],
		category: "text",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
  ...
  description: "Free Alt Text Checker online. Alt Text Checker allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "alt text checker, free online tool, no signup, text, alt text checker online, 30tools",
  alternates: {
    canonical: "https://30tools.com/alt-text-checker",
  },
  openGraph: {
    title: "Free Alt Text Checker Online - No Signup | 30tools",
    description: "Free Alt Text Checker online. Alt Text Checker allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/alt-text-checker",
    siteName: "30tools",
...
export default async function ToolPage() {
  ...
  "description": "Free Alt Text Checker online. Alt Text Checker allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/alt-text-checker",
  "extraSlugs": [
    "alt-text-checker"
  ],
  "category": "text"
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Alt Text Checker","description":"Free Alt Text Checker online. Alt Text Checker allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/alt-text-checker","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

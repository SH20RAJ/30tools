...
export const metadata = {
	...
	description:
		"Free Startup Name Generator online. Startup Name Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"startup name generator, free online tool, no signup, text, startup name generator online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Startup Name Generator online. Startup Name Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/startup-name-generator",
		extraSlugs: ["business-name-generator", "startup-name-generator"],
		category: "text",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
	...
	description:
		"Free Love Poem Generator online. Love Poem Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"love poem generator, free online tool, no signup, text, love poem generator online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Love Poem Generator online. Love Poem Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/love-poem-generator",
		extraSlugs: ["love-poem-generator"],
		category: "text",
	};
	const breadcrumbs = [
		{

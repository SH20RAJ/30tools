...
export const metadata = {
  ...
  description:
    "Professional text diff to Process text instantly. Free online text tool with advanced features. Perfect for writers, students & professionals.",
  keywords: [
...
const jsonLd = {
  ...
  description:
    "Free online tool to compare two texts and highlight differences, additions, and deletions",
            ...
            <div className="bg-card rounded-lg p-6 border">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    See highlighted additions, deletions, and changes
                  </p>
                </div>
              </div>
            </div>

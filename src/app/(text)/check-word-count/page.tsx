...
export const metadata = {
	...
	description:
		"Free Check Word Count online. Check Word Count allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"check word count, free online tool, no signup, text, check word count online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Check Word Count online. Check Word Count allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/check-word-count",
		extraSlugs: ["check-word-count"],
		category: "text",
	};
	const breadcrumbs = [
		{

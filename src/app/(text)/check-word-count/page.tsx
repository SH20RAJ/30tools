...
export const metadata = {
  ...
  description: "Free Check Word Count online. Check Word Count allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "check word count, free online tool, no signup, text, check word count online, 30tools",
  alternates: {
    canonical: "https://30tools.com/check-word-count",
  },
  openGraph: {
    title: "Free Check Word Count Online - No Signup | 30tools",
    description: "Free Check Word Count online. Check Word Count allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/check-word-count",
    siteName: "30tools",
...
export default async function ToolPage() {
  ...
  "description": "Free Check Word Count online. Check Word Count allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/check-word-count",
  "extraSlugs": [
    "check-word-count"
  ],
  "category": "text"
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Check Word Count","description":"Free Check Word Count online. Check Word Count allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/check-word-count","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

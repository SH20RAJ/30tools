...
export const metadata = {
	...
	description:
		"Free Sentence Case Tool online. Sentence Case Tool allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"sentence case tool, free online tool, no signup, text, sentence case tool online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Sentence Case Tool online. Sentence Case Tool allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/sentence-case-tool",
		extraSlugs: ["sentence-case-tool"],
		category: "text",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
	...
	description:
		"Free Generate Placeholder Text online. Generate Placeholder Text allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"generate placeholder text, free online tool, no signup, text, generate placeholder text online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Generate Placeholder Text online. Generate Placeholder Text allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/generate-placeholder-text",
		extraSlugs: ["generate-placeholder-text"],
		category: "text",
	};
	const breadcrumbs = [
		{

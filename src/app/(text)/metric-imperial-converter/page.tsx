...
export const metadata = {
	...
	description:
		"Free Metric Imperial Converter online. Metric Imperial Converter allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"metric imperial converter, free online tool, no signup, text, metric imperial converter online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Metric Imperial Converter online. Metric Imperial Converter allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/metric-imperial-converter",
		extraSlugs: ["metric-imperial-converter"],
		category: "text",
	};
	const breadcrumbs = [
		{

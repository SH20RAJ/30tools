...
export const metadata = {
	...
	description:
		"Free Random Color Schemes online. Random Color Schemes allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"random color schemes, free online tool, no signup, text, random color schemes online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Random Color Schemes online. Random Color Schemes allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/random-color-schemes",
		extraSlugs: ["random-color-schemes"],
		category: "text",
	};
	const breadcrumbs = [
		{

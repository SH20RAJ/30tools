...
export const metadata = {
	...
	description:
		"Free Ico File Generator online. Ico File Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"ico file generator, free online tool, no signup, text, ico file generator online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Ico File Generator online. Ico File Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/ico-file-generator",
		extraSlugs: ["ico-file-generator"],
		category: "text",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
	...
	description:
		"Free Base64 Encoder Decoder online. Base64 Encoder Decoder allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"base64 encoder decoder, free online tool, no signup, text, base64 encoder decoder online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Base64 Encoder Decoder online. Base64 Encoder Decoder allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/base64-encoder-decoder",
		extraSlugs: ["base64-encoder-decoder"],
		category: "text",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
  ...
  description: "Free Aesthetic Bio Generator online. Aesthetic Bio Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "aesthetic bio generator, free online tool, no signup, text, aesthetic bio generator online, 30tools",
  alternates: {
...
export default async function ToolPage() {
  ...
  "description": "Free Aesthetic Bio Generator online. Aesthetic Bio Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/aesthetic-bio-generator",
  "extraSlugs": [
    "aesthetic-bio-generator",
    "aesthetic-instagram-bio",
    "copy-paste-aesthetic-bio",
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Aesthetic Bio Generator","description":"Free Aesthetic Bio Generator online. Aesthetic Bio Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/aesthetic-bio-generator","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

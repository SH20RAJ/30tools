...
export const metadata = {
	...
	description:
		"Free Aesthetic Bio Generator online. Aesthetic Bio Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"aesthetic bio generator, free online tool, no signup, text, aesthetic bio generator online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Aesthetic Bio Generator online. Aesthetic Bio Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",

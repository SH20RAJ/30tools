...
export const metadata = {
  ...
  description: "Free text compare tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "text compare, free online tool, no signup, text, text compare online, 30tools",
  alternates: {
...
export default async function ToolPage() {
  ...
  "id": "text-compare",
  "name": "Text Compare",
  "description": "Free text compare tool to process your data instantly with privacy-friendly browser-based workflows.",
  "route": "/text-compare",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Text Compare","description":"Free text compare tool to process your data instantly with privacy-friendly browser-based workflows.","url":"https://30tools.com/text-compare","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />
      ...
      >
        <ToolPlaceholderPage toolId="text-compare" />
      </ToolLayout>
    </>
  );
}

...
export const metadata = {
  ...
  description: "Free Text Fo Base64 online. Text Fo Base64 allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "text fo base64, free online tool, no signup, text, text fo base64 online, 30tools",
  alternates: {
    canonical: "https://30tools.com/text-fo-base64",
  },
  openGraph: {
    title: "Free Text Fo Base64 Online - No Signup | 30tools",
    description: "Free Text Fo Base64 online. Text Fo Base64 allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/text-fo-base64",
    siteName: "30tools",
...
export default async function ToolPage() {
  ...
  "id": "text-fo-base64",
  "name": "Text Fo Base64",
  "description": "Free Text Fo Base64 online. Text Fo Base64 allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/text-fo-base64",
  "extraSlugs": [
    "text-fo-base64"
  ],
  "category": "text"
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Text Fo Base64","description":"Free Text Fo Base64 online. Text Fo Base64 allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/text-fo-base64","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

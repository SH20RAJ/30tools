...
export const metadata = {
	...
	description:
		"Free Text Fo Base64 online. Text Fo Base64 allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"text fo base64, free online tool, no signup, text, text fo base64 online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		name: "Text Fo Base64",
		description:
			"Free Text Fo Base64 online. Text Fo Base64 allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/text-fo-base64",
		extraSlugs: ["text-fo-base64"],
		category: "text",
	};
	const breadcrumbs = [
		{

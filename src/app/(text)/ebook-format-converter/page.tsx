...
export const metadata = {
	...
	description:
		"Free Ebook Format Converter online. Ebook Format Converter allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"ebook format converter, free online tool, no signup, text, ebook format converter online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Ebook Format Converter online. Ebook Format Converter allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/ebook-format-converter",
		extraSlugs: ["ebook-format-converter"],
		category: "text",
	};
	const breadcrumbs = [
		{

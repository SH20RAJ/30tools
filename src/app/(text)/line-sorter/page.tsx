...
export const metadata = {
	...
	description:
		"Sort lists alphabetically or by length 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"line sorter, free online tool, no signup, text, line sorter online, 30tools",
	alternates: {
	...
	openGraph: {
		...
		siteName: "30tools",
		images: [{ url: "/api/og?title=Free%20Line%20Sorter%20Online%20-%20No%20Signup" }],
		type: "website",
	},
	twitter: {
		...
		description:
			"Sort lists alphabetically or by length 100% free, no signup required, and privacy-focused processing in your browser.",
		images: ["/api/og?title=Free%20Line%20Sorter%20Online%20-%20No%20Signup"],
	},
...
export default async function ToolPage() {
	const tool = {
		...
		route: "/line-sorter",
		extraSlugs: ["alphabetize-list-online-free", "sort-lines-alphabetically"],
		popular: false,
		category: "text",
	};
	const breadcrumbs = [

...
export const metadata = {
  ...
  description: "Sort lists alphabetically or by length 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "line sorter, free online tool, no signup, text, line sorter online, 30tools",
  alternates: {
...
export default async function ToolPage() {
  ...
  "id": "line-sorter",
  "name": "Line Sorter",
  "description": "Sort lists alphabetically or by length",
  "route": "/line-sorter",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Line Sorter","description":"Sort lists alphabetically or by length","url":"https://30tools.com/line-sorter","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

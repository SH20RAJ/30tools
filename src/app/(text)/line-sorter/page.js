...
export const metadata = {
  ...
  openGraph: {
    title: 'Line Sorter - Sort Text Lines Alphabetically & Numerically | 30tools',
    description: 'Sort text lines alphabetically, numerically, or by length with advanced options.',
    type: 'website',
...
const jsonLd = {
  ...
  "@type": "WebApplication",
  "name": "Line Sorter",
  "description": "Free online tool to sort text lines alphabetically, numerically, or by length with advanced sorting options",
  "url": "https://30tools.com/line-sorter",
          ...
          <div className="mt-12 space-y-8">
            <div className="bg-card rounded-lg p-6 border">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">Paste or type your text with multiple lines</p>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-3">
                  ...
                  <p className="text-sm text-muted-foreground">Select sorting method and order preferences</p>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-3">
                  ...
                  <p className="text-sm text-muted-foreground">Copy the organized lines in your desired order</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-card rounded-lg p-6 border">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div>
                  <h3 className="font-medium mb-2 text-primary">🔤 Alphabetical Sorting</h3>
                ...
                <div>
                  <h3 className="font-medium mb-2 text-primary">🔢 Numerical Sorting</h3>
                  <ul className="text-sm text-muted-foreground space-y-1 mb-4">
                ...
                <div>
                  <h3 className="font-medium mb-2 text-primary">📏 Length Sorting</h3>
                  <ul className="text-sm text-muted-foreground space-y-1 mb-4">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div className="border rounded-lg p-4">
                    <h3 className="font-medium mb-2">Alphabetical Sort (A-Z):</h3>
                  ...
                  <div className="border rounded-lg p-4">
                    <h3 className="font-medium mb-2">Numerical Sort (1-100):</h3>
                    <div className="bg-muted p-3 rounded font-mono text-sm">
                      <div><strong>Before:</strong></div>
                      <div className="ml-4 mb-2">
                        100<br/>
                ...
                <div className="space-y-4">
                  <div className="border rounded-lg p-4">
                    <h3 className="font-medium mb-2">Length Sort (Short to Long):</h3>
                    <div className="bg-muted p-3 rounded font-mono text-sm">
                      <div><strong>Before:</strong></div>
                      <div className="ml-4 mb-2">
                        Very long sentence here<br/>
                        Hi<br/>
                        Medium length<br/>
                        Short
                      </div>
                  ...
                  <div className="border rounded-lg p-4">
                    <h3 className="font-medium mb-2">Reverse Alphabetical (Z-A):</h3>
                    <div className="bg-muted p-3 rounded font-mono text-sm">
                      <div><strong>Before:</strong></div>
                      <div className="ml-4 mb-2">
                        Apple<br/>
            ...
            <div className="bg-card rounded-lg p-6 border">
              <h2 className="text-2xl font-semibold mb-4">More Text Organization Tools</h2>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                >
                  <h3 className="font-semibold mb-2 group-hover:text-primary">🗑️ Remove Duplicates</h3>
                  <p className="text-sm text-muted-foreground">
                    Remove duplicate lines from text lists and data.
                  </p>
                  <span className="text-xs text-primary mt-2 inline-block">Remove Duplicates →</span>
                </a>

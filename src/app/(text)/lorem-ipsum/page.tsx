...
export const metadata = {
	...
	description:
		"Generate custom Lorem Ipsum text for your designs. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"lorem ipsum generator, free online tool, no signup, text, lorem ipsum generator online, 30tools",
	alternates: {

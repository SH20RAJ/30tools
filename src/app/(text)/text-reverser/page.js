...
export const metadata = {
  ...
  description:
    "Professional text reverser to Process text instantly. Free online text tool with advanced features. Perfect for writers, students & professionals.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Reverse text characters, flip words, or reverse word order instantly.",
    type: "website",
...
const jsonLd = {
  ...
  name: "Text Reverser",
  description:
    "Free online tool to reverse text characters, flip words, and manipulate text order instantly",
  url: "https://30tools.com/text-reverser",
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-muted-foreground">
              Reverse text characters, flip words, or change text order
              instantly
            </p>
          </div>
            ...
            <div className="bg-card rounded-lg p-6 border">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Select character reversal or word order reversal
                  </p>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-3">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Get your reversed text and copy it instantly
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="border rounded-lg p-4">
                  ...
                  <div className="bg-muted p-3 rounded font-mono text-sm">
                    ...
                    <div>
                      <strong>Reversed:</strong> !dlroW olleH
                    </div>
                  </div>
                </div>
                <div className="border rounded-lg p-4">
                  ...
                  <div className="bg-muted p-3 rounded font-mono text-sm">
                    <div>
                      <strong>Original:</strong> The quick brown fox
                    </div>
                    <div>
                      <strong>Reversed:</strong> fox brown quick The
                    </div>
                  </div>
                </div>
              </div>

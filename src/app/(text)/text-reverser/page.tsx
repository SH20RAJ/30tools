...
export const metadata = {
	...
	description:
		"Reverse text, words, or lines instantly 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"text reverser, free online tool, no signup, text, text reverser online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		route: "/text-reverser",
		extraSlugs: ["reverse-text-in-excel", "backwards-text-generator"],
		popular: false,
		category: "text",
	};
	const breadcrumbs = [

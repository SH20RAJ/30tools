...
export const metadata = {
	...
	description:
		"Free remove line breaks tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"remove line breaks, free online tool, no signup, text, remove line breaks online, 30tools",
	alternates: {
	...
	openGraph: {
		...
		siteName: "30tools",
		images: [{ url: "/api/og?title=Free%20Remove%20Line%20Breaks%20Online%20-%20No%20Signup" }],
		type: "website",
	},
	twitter: {
		...
		description:
			"Free remove line breaks tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
		images: ["/api/og?title=Free%20Remove%20Line%20Breaks%20Online%20-%20No%20Signup"],
	},
...
export default async function ToolPage() {
	const tool = {
		...
		extraSlugs: ["free-remove-line-breaks-online", "remove-line-breaks-tool"],
		popular: false,
		category: "text",
	};
	const breadcrumbs = [
	...
	return (
		<>
			...
			>
				<ToolImplementation toolId="remove-line-breaks" />
			</ToolLayout>
		</>
	);
}

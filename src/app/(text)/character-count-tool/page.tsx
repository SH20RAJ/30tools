...
export const metadata = {
	...
	description:
		"Free Character Count Tool online. Character Count Tool allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"character count tool, free online tool, no signup, text, character count tool online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Character Count Tool online. Character Count Tool allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/character-count-tool",
		extraSlugs: ["character-count-tool", "tweet-character-count"],
		category: "text",
	};
	const breadcrumbs = [
		{

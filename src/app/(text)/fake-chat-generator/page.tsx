...
export const metadata = {
	...
	description:
		"Free Fake Chat Generator online. Fake Chat Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"fake chat generator, free online tool, no signup, text, fake chat generator online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Fake Chat Generator online. Fake Chat Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",

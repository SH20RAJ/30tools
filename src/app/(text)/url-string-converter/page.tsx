...
export const metadata = {
	...
	description:
		"Free Url String Converter online. Url String Converter allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"url string converter, free online tool, no signup, text, url string converter online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Url String Converter online. Url String Converter allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/url-string-converter",
		extraSlugs: ["url-string-converter"],
		category: "text",
	};
	const breadcrumbs = [
		{

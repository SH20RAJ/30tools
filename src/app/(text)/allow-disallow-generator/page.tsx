...
export const metadata = {
	...
	description:
		"Free Allow Disallow Generator online. Allow Disallow Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"allow disallow generator, free online tool, no signup, text, allow disallow generator online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Allow Disallow Generator online. Allow Disallow Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/allow-disallow-generator",
		extraSlugs: ["allow-disallow-generator"],
		category: "text",
	};
	const breadcrumbs = [
		{

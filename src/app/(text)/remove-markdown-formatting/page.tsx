...
export const metadata = {
	...
	description:
		"Free Remove Markdown Formatting online. Remove Markdown Formatting allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"remove markdown formatting, free online tool, no signup, text, remove markdown formatting online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Remove Markdown Formatting online. Remove Markdown Formatting allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/remove-markdown-formatting",
		extraSlugs: ["remove-markdown-formatting"],
		category: "text",
	};
	const breadcrumbs = [
		{

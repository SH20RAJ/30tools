...
export const metadata = {
	...
	keywords:
		"word to number converter, free online tool, no signup, text, word to number converter online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free word to number converter tool to process your data instantly with privacy-friendly browser-based workflows.",

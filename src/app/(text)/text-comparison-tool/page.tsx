...
export const metadata = {
	...
	description:
		"Free Text Comparison Tool online. Text Comparison Tool allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"text comparison tool, free online tool, no signup, text, text comparison tool online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Text Comparison Tool online. Text Comparison Tool allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",

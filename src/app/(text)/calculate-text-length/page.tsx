...
export const metadata = {
	...
	description:
		"Free Calculate Text Length online. Calculate Text Length allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"calculate text length, free online tool, no signup, text, calculate text length online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Calculate Text Length online. Calculate Text Length allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/calculate-text-length",
		extraSlugs: ["calculate-text-complexity", "calculate-text-length"],
		category: "text",
	};
	const breadcrumbs = [
		{

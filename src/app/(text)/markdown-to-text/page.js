...
export const metadata = {
  ...
  description:
    "Convert Markdown to plain text instantly. Remove all markdown formatting and get clean, readable text. Perfect for content creators and developers.",
  keywords:
    "markdown to text, md to text converter, markdown converter, remove markdown formatting, plain text converter, markdown parser, text converter, md converter",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Convert Markdown to plain text instantly. Remove all markdown formatting and get clean, readable text.",

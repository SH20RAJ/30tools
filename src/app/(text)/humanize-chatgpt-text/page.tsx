...
export const metadata = {
	...
	description:
		"Free Humanize Chatgpt Text online. Humanize Chatgpt Text allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"humanize chatgpt text, free online tool, no signup, text, humanize chatgpt text online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Humanize Chatgpt Text online. Humanize Chatgpt Text allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/humanize-chatgpt-text",
		extraSlugs: ["humanize-chatgpt-text"],
		category: "text",
	};
	const breadcrumbs = [
		{

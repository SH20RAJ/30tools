...
export const metadata = {
	...
	description:
		"Free Lucky Number Generator online. Lucky Number Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"lucky number generator, free online tool, no signup, text, lucky number generator online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Lucky Number Generator online. Lucky Number Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/lucky-number-generator",
		extraSlugs: ["lucky-number-generator"],
		category: "text",
	};
	const breadcrumbs = [
		{

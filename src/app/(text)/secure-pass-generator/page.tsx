...
export const metadata = {
	...
	description:
		"Free Secure Pass Generator online. Secure Pass Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"secure pass generator, free online tool, no signup, text, secure pass generator online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Secure Pass Generator online. Secure Pass Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/secure-pass-generator",
		extraSlugs: ["secure-hash-generator", "secure-pass-generator"],
		category: "text",
	};
	const breadcrumbs = [
		{

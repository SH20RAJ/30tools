...
export const metadata = {
	...
	description:
		"Free Fix Text Spacing online. Fix Text Spacing allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"fix text spacing, free online tool, no signup, text, fix text spacing online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Fix Text Spacing online. Fix Text Spacing allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/fix-text-spacing",
		extraSlugs: ["fix-text-spacing"],
		category: "text",
	};
	const breadcrumbs = [
		{

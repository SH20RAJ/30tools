...
export const metadata = {
  ...
  description: "Free Extract Hyperlinks online. Extract Hyperlinks allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "extract hyperlinks, free online tool, no signup, text, extract hyperlinks online, 30tools",
  alternates: {
    canonical: "https://30tools.com/extract-hyperlinks",
  },
  openGraph: {
    title: "Free Extract Hyperlinks Online - No Signup | 30tools",
    description: "Free Extract Hyperlinks online. Extract Hyperlinks allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/extract-hyperlinks",
    siteName: "30tools",
...
export default async function ToolPage() {
  ...
  "description": "Free Extract Hyperlinks online. Extract Hyperlinks allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/extract-hyperlinks",
  "extraSlugs": [
    "extract-hyperlinks"
  ],
  "category": "text"
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Extract Hyperlinks","description":"Free Extract Hyperlinks online. Extract Hyperlinks allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/extract-hyperlinks","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

...
export const metadata = {
	...
	description:
		"Free Read Text Aloud online. Read Text Aloud allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"read text aloud, free online tool, no signup, text, read text aloud online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Read Text Aloud online. Read Text Aloud allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/read-text-aloud",
		extraSlugs: ["read-text-aloud"],
		category: "text",
	};
	const breadcrumbs = [
		{

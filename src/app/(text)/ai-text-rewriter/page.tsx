...
export const metadata = {
	...
	description:
		"Free Ai Text Rewriter online. Ai Text Rewriter allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"ai text rewriter, free online tool, no signup, text, ai text rewriter online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Ai Text Rewriter online. Ai Text Rewriter allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/ai-text-rewriter",
		extraSlugs: ["ai-text-rewriter", "make-ai-text-human"],
		category: "text",
	};
	const breadcrumbs = [
		{

...
export const metadata = {
	...
	description:
		"Free All In One Unit Converter online. All In One Unit Converter allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"all in one unit converter, free online tool, no signup, text, all in one unit converter online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free All In One Unit Converter online. All In One Unit Converter allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/all-in-one-unit-converter",
		extraSlugs: ["all-in-one-unit-converter"],
		category: "text",
	};
	const breadcrumbs = [
		{

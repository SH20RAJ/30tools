...
export const metadata = {
	...
	description:
		"Free Remove Bg Online online. Remove Bg Online allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"remove bg online, free online tool, no signup, text, remove bg online online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Remove Bg Online online. Remove Bg Online allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/remove-bg-online",
		extraSlugs: ["remove-bg-online"],
		category: "text",
	};
	const breadcrumbs = [
		{

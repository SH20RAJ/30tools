...
export const metadata = {
	...
	description:
		"Free Convert Text Case online. Convert Text Case allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"convert text case, free online tool, no signup, text, convert text case online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Convert Text Case online. Convert Text Case allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/convert-text-case",
		extraSlugs: ["convert-text-case"],
		category: "text",
	};
	const breadcrumbs = [
		{

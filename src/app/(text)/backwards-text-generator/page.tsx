...
export const metadata = {
	...
	description:
		"Generate backwards text instantly. Our free reverse text tool flips characters, words, or entire paragraphs. Perfect for Instagram, Discord, and creative writing. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"backwards text generator, free online tool, no signup, text, backwards text generator online, 30tools",
	alternates: {

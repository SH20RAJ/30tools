...
export const metadata = {
	...
	description:
		"Free Remove Duplicate Lines online. Remove Duplicate Lines allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"remove duplicate lines, free online tool, no signup, text, remove duplicate lines online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Remove Duplicate Lines online. Remove Duplicate Lines allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/remove-duplicate-lines",
		extraSlugs: ["remove-duplicate-lines"],
		category: "text",
	};
	const breadcrumbs = [
		{

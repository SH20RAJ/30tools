...
export const metadata = {
	...
	description:
		"Free Json Ld Generator online. Json Ld Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"json ld generator, free online tool, no signup, text, json ld generator online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Json Ld Generator online. Json Ld Generator allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/json-ld-generator",
		extraSlugs: ["json-ld-generator"],
		category: "text",
	};
	const breadcrumbs = [
		{

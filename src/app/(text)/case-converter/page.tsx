...
export const metadata = {
  ...
  description: "Use our free Case Converter tool to instantly change text between upper case, lower case, title case, sentence case, and more. Copy-paste ready for any project.",
  keywords: ["case converter","online case converter","upper case to lower case","title case generator","sentence case converter"],
  robots: {
    index: true,
    follow: true,
    googleBot: {

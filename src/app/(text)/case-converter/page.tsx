...
export const metadata = {
  ...
  description: "Convert text between upper case, lower case, title case, sentence case, and more instantly. Perfect for writers, developers, and social media managers. 100% free, no signup required, and privacy-focused processing in your browser.",
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Case Converter","description":"Convert text between upper case, lower case, title case, sentence case, and more instantly. Perfect for writers, developers, and social media managers.","url":"https://30tools.com/case-converter","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

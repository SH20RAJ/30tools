...
export const metadata = {
	...
	description:
		"Convert text between upper case, lower case, title case, sentence case, and more instantly. Perfect for writers, developers, and social media managers. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"case converter, free online tool, no signup, text, case converter online, 30tools",
	alternates: {

...
export const metadata = {
  ...
  description: "Free word counter tool to process your data instantly with privacy-friendly browser-based workflows. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "word counter, free online tool, no signup, text, word counter online, 30tools",
  alternates: {
...
export default async function ToolPage() {
  ...
  "id": "word-counter",
  "name": "Word Counter",
  "description": "Free word counter tool to process your data instantly with privacy-friendly browser-based workflows.",
  "route": "/word-counter",
  "extraSlugs": [
    "character-counter",
    "essay-word-counter",
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Word Counter","description":"Free word counter tool to process your data instantly with privacy-friendly browser-based workflows.","url":"https://30tools.com/word-counter","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />
      ...
      >
        <ToolPlaceholderPage toolId="word-counter" />
      </ToolLayout>
    </>
  );
}

...
export const metadata = {
  ...
  description: "Free Duplicate Content Finder online. Duplicate Content Finder allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "duplicate content finder, free online tool, no signup, text, duplicate content finder online, 30tools",
  alternates: {
...
export default async function ToolPage() {
  ...
  "description": "Free Duplicate Content Finder online. Duplicate Content Finder allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/duplicate-content-finder",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"Duplicate Content Finder","description":"Free Duplicate Content Finder online. Duplicate Content Finder allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/duplicate-content-finder","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

...
export const metadata = {
	...
	description:
		"Free Duplicate Content Finder online. Duplicate Content Finder allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"duplicate content finder, free online tool, no signup, text, duplicate content finder online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free Duplicate Content Finder online. Duplicate Content Finder allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/duplicate-content-finder",
		extraSlugs: ["duplicate-content-finder"],
		category: "text",
	};
	const breadcrumbs = [
		{

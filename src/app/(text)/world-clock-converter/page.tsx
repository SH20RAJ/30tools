...
export const metadata = {
	...
	description:
		"Free World Clock Converter online. World Clock Converter allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
	keywords:
		"world clock converter, free online tool, no signup, text, world clock converter online, 30tools",
	alternates: {
...
export default async function ToolPage() {
	const tool = {
		...
		description:
			"Free World Clock Converter online. World Clock Converter allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
		route: "/world-clock-converter",
		extraSlugs: ["world-clock-converter"],
		category: "text",
	};
	const breadcrumbs = [
		{

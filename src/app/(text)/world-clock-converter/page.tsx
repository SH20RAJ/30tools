...
export const metadata = {
  ...
  description: "Free World Clock Converter online. World Clock Converter allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
  keywords: "world clock converter, free online tool, no signup, text, world clock converter online, 30tools",
  alternates: {
    canonical: "https://30tools.com/world-clock-converter",
  },
  openGraph: {
    title: "Free World Clock Converter Online - No Signup | 30tools",
    description: "Free World Clock Converter online. World Clock Converter allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser. 100% free, no signup required, and privacy-focused processing in your browser.",
    url: "https://30tools.com/world-clock-converter",
    siteName: "30tools",
...
export default async function ToolPage() {
  ...
  "name": "World Clock Converter",
  "description": "Free World Clock Converter online. World Clock Converter allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.",
  "route": "/world-clock-converter",
  "extraSlugs": [
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"SoftwareApplication","name":"World Clock Converter","description":"Free World Clock Converter online. World Clock Converter allows you to transform and analyze text quickly and easily. 100% free, no signup required, and privacy-focused processing in your browser.","url":"https://30tools.com/world-clock-converter","applicationCategory":"UtilitiesApplication","operatingSystem":"Any","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"}}) }}
      />

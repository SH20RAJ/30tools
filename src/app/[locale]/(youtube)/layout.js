...
export const metadata = {
  ...
  description:
    "Professional YouTube tools for video download, thumbnail extraction, tag generation, and content optimization. Free YouTube utilities for creators and marketers.",
  keywords:
    "youtube tools, youtube downloader, youtube thumbnail downloader, youtube tag generator, free youtube tools online",
  openGraph: {
    title: "YouTube Tools - Free Online YouTube Utilities",
    description:
      "Professional YouTube tools for video download, thumbnail extraction, and content optimization.",

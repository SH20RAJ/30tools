...
export const metadata = {
  ...
  description:
    "Essential developer tools for JSON formatting, hash generation, and more. Free online developer utilities.",
  keywords:
    "developer tools, json formatter, hash generator, free developer tools online",
  openGraph: {

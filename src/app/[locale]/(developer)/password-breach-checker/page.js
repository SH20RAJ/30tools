...
export const metadata = {
  ...
  description:
    "Free password breach checker to see if your email or password has been compromised in data breaches. Check against billions of breached accounts instantly.",
  keywords:
    "password breach checker, email breach check, data breach checker, password security, compromised password, haveibeenpwned, security check",
  openGraph: {
    title: "Password Breach Checker - 30tools",
    description:
      "Free tool to check if your email or password has been compromised in data breaches. Protect your online security.",
  ...
  twitter: {
    ...
    description:
      "Professional password breach checker for developers. Process with advanced features. Free coding tool for programmers, students & professionals.",

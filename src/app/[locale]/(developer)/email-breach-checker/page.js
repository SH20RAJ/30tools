...
export const metadata = {
  ...
  description:
    "Free email breach checker to see if your email has been compromised in data breaches. Check against billions of breached accounts using HaveIBeenPwned database.",
  keywords:
    "email breach checker, data breach checker, email security, compromised email, haveibeenpwned, email breach check",
  openGraph: {
    title: "Email Breach Checker - Check if Your Email is Compromised",
    description:
      "Free tool to check if your email has been compromised in data breaches. Protect your online security.",
  ...
  twitter: {
    ...
    description:
      "Professional email breach checker for developers. Process with advanced features. Free coding tool for programmers, students & professionals.",

...
export const metadata = {
  ...
  description:
    "Convert Process instantly with our free chatgpt text converter. High-quality conversion with privacy protection. No registration required, unlimited use.",
  keywords:
    "chatgpt text converter, markdown to text, remove markdown formatting, clean ai text, chatgpt markdown converter, text formatter, ai text cleaner, remove bold italic, convert markdown",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Convert ChatGPT markdown text to clean, normal text. Remove formatting like bold, italic, headers, and lists instantly.",
  ...
  twitter: {
    ...
    title: "ChatGPT Text to Normal Text Converter - Remove Markdown",
    description:
      "Convert ChatGPT markdown text to clean, normal text. Remove formatting instantly.",
